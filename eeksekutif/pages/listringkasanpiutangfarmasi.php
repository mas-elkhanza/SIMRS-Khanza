                    ...
                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                        ...
                        <?php
                            ...
                            while($rsqueryRingkasanPiutang = mysqli_fetch_array($queryRingkasanPiutang)) {
                                ...
                                if(!isset($totalPerGolongan[$rsqueryRingkasanPiutang["namagolongan"]])) {
                                    $totalPerGolongan[$rsqueryRingkasanPiutang["namagolongan"]] = 0;
                                }
                                $totalPerGolongan[$rsqueryRingkasanPiutang["namagolongan"]] += $rsqueryRingkasanPiutang["total"];
                                if(!isset($totalPerJenis[$rsqueryRingkasanPiutang["namajenis"]])) {
                                    $totalPerJenis[$rsqueryRingkasanPiutang["namajenis"]] = 0;
                                }
                                $totalPerJenis[$rsqueryRingkasanPiutang["namajenis"]] += $rsqueryRingkasanPiutang["total"];
                                if(!isset($totalPerKategori[$rsqueryRingkasanPiutang["namakategori"]])) {
                                    $totalPerKategori[$rsqueryRingkasanPiutang["namakategori"]] = 0;
                                }
                                $totalPerKategori[$rsqueryRingkasanPiutang["namakategori"]] += $rsqueryRingkasanPiutang["total"];
                            }
                        ?>
                        </tbody>
                        <tfoot>
