...
<div class="block-header">
    <h2><center>RINGKASAN RETUR OBAT, ALKES & BHP MEDIS DARI PASIEN</center></h2>
</div>
                    ...
                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                        ...
                        <?php
                            ...
                            $queryRingkasanRetur    = bukaquery(
                                "select detreturjual.kode_brng,databarang.nama_brng,kodesatuan.satuan,jenis.nama as namajenis,golongan_barang.nama as namagolongan,".
                                "kategori_barang.nama as namakategori,sum(detreturjual.jml_retur) as jumlah,sum(detreturjual.subtotal) as total from returjual ".
                                ...
                                "where returjual.tgl_retur between '$thncariretur-$blncariretur-$tglcariretur' and '$thncariretur2-$blncariretur2-$tglcariretur2' ".
                                "group by detreturjual.kode_brng order by databarang.nama_brng asc"
                            );
                            while($rsqueryRingkasanRetur = mysqli_fetch_array($queryRingkasanRetur)) {
                                ...
                                if(!isset($totalPerGolongan[$rsqueryRingkasanRetur["namagolongan"]])) {
                                    $totalPerGolongan[$rsqueryRingkasanRetur["namagolongan"]] = 0;
                                }
                                $totalPerGolongan[$rsqueryRingkasanRetur["namagolongan"]] += $rsqueryRingkasanRetur["total"];
                                if(!isset($totalPerJenis[$rsqueryRingkasanRetur["namajenis"]])) {
                                    $totalPerJenis[$rsqueryRingkasanRetur["namajenis"]] = 0;
                                }
                                $totalPerJenis[$rsqueryRingkasanRetur["namajenis"]] += $rsqueryRingkasanRetur["total"];
                                if(!isset($totalPerKategori[$rsqueryRingkasanRetur["namakategori"]])) {
                                    $totalPerKategori[$rsqueryRingkasanRetur["namakategori"]] = 0;
                                }
                                $totalPerKategori[$rsqueryRingkasanRetur["namakategori"]] += $rsqueryRingkasanRetur["total"];
                            }
                        ?>
                        </tbody>
                        <tfoot>
                            ...
                            <table class="table table-bordered table-striped table-hover">
                                ...
                                <?php
                                    ...
                                    $queryterbanyakretur  = bukaquery(
                                        "select databarang.nama_brng,sum(detreturjual.jml_retur) as jumlah from returjual inner join detreturjual on returjual.no_retur_jual=detreturjual.no_retur_jual inner join databarang on detreturjual.kode_brng=databarang.kode_brng ".
                                        "where returjual.tgl_retur between '$thncariretur-$blncariretur-$tglcariretur' and '$thncariretur2-$blncariretur2-$tglcariretur2' group by detreturjual.kode_brng order by jumlah desc limit 10"
                                    );
                            ...
                            <table class="table table-bordered table-striped table-hover">
                                ...
                                <?php
                                    ...
                                    $querynilairetur = bukaquery(
                                        "select databarang.nama_brng,sum(detreturjual.subtotal) as total from returjual inner join detreturjual on returjual.no_retur_jual=detreturjual.no_retur_jual inner join databarang on detreturjual.kode_brng=databarang.kode_brng ".
                                        "where returjual.tgl_retur between '$thncariretur-$blncariretur-$tglcariretur' and '$thncariretur2-$blncariretur2-$tglcariretur2' group by detreturjual.kode_brng order by total desc limit 10"
                                    );
