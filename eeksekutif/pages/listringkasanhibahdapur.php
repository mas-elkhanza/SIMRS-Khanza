...
<div class="block-header">
    <h2><center>RINGKASAN HIBAH DAPUR</center></h2>
</div>
                    ...
                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                        ...
                        <?php
                            ...
                            $queryHibah = bukaquery(
                                "select dapur_detail_hibah.kode_brng,dapurbarang.nama_brng,dapurbarang.jenis,kodesatuan.satuan,sum(dapur_detail_hibah.jumlah) as jumlah,sum(dapur_detail_hibah.subtotalhibah) as total from dapur_hibah ".
                                "inner join dapur_detail_hibah on dapur_hibah.no_hibah=dapur_detail_hibah.no_hibah inner join dapurbarang on dapur_detail_hibah.kode_brng=dapurbarang.kode_brng inner join kodesatuan on dapur_detail_hibah.kode_sat=kodesatuan.kode_sat ".
                                "where dapur_hibah.tgl_hibah between '$thncarihibah-$blncarihibah-$tglcarihibah' and '$thncarihibah2-$blncarihibah2-$tglcarihibah2' group by dapur_detail_hibah.kode_brng order by dapurbarang.nama_brng asc"
                            );
                            while($rshibah = mysqli_fetch_array($queryHibah)) {
                                ...
                                echo "<tr>
                                        ...
                                        <td align='left' style='white-space:nowrap;'>".$rshibah["jenis"]."</td>
