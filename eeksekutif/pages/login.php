...
<head>
    ...
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, e_eksekutif-scalable=no" name="viewport">
...
<body class="login-page">
    ...
    <div id="content">
        <div class="login-box">
            <div class="logo">
                <a href="javascript:void(0);">E-Eksekutif <?=$_SESSION["nama_instansi"];?> </a>
            </div>
            <div class="card">
                <div class="body">
                    ...
                    <?php 
                        ...
                        if (isset($BtnLogin)) {
                            if(@$_SESSION["Capcay"]==getOne2("select aes_encrypt(".validTeks4($_POST["inputcaptcha"],10).",'windi')")){
                                ...
                                if(getOne2("select count(*) from e_eksekutif where e_eksekutif.usere=AES_ENCRYPT('$username','nur') and e_eksekutif.passworde=AES_ENCRYPT('$password','windi')")>0){
                                    if(getOne2("select AES_DECRYPT(e_eksekutif.usere,'nur') from e_eksekutif where AES_DECRYPT(e_eksekutif.passworde,'windi')='$password'")>0){
                                       $_SESSION["ses_eksekutif"]= encrypt_decrypt($username,"e");
