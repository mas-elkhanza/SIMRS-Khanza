...
<div class="block-header">
    <h2><center>NILAI PENERIMAAN VENDOR DAPUR PER BULAN</center></h2>
</div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                        ...
                        <?php
                            ...
                            $totalTagihanAll = 0;
                            $dataPerVendor   = [];
                            $querySuplier = bukaquery("select dapursuplier.kode_suplier,dapursuplier.nama_suplier from dapursuplier order by dapursuplier.nama_suplier asc");
                            while($rssuplier = mysqli_fetch_array($querySuplier)) {
                                ...
                                for($b=1;$b<=12;$b++) {
                                    ...
                                    $nilai = (float) getOne(
                                        "select sum(dapurdetailpesan.total) from dapurpemesanan inner join dapurdetailpesan on dapurpemesanan.no_faktur=dapurdetailpesan.no_faktur ".
                                        "inner join dapurbarang on dapurdetailpesan.kode_brng=dapurbarang.kode_brng where dapurpemesanan.kode_suplier='".$rssuplier["kode_suplier"]."' ".
                                        "and left(dapurpemesanan.tgl_pesan,7)='".$tahuncari."-".$bulanStr."'"
                                    );
                                    $nilaiBulan[]           = $nilai;
