                    ...
                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                        ...
                        <?php
                            ...
                            while($rsqueryRingkasanKeluar = mysqli_fetch_array($queryRingkasanKeluar)) {
                                ...
                                if(!isset($totalPerGolongan[$rsqueryRingkasanKeluar["namagolongan"]])) {
                                    $totalPerGolongan[$rsqueryRingkasanKeluar["namagolongan"]] = 0;
                                }
                                $totalPerGolongan[$rsqueryRingkasanKeluar["namagolongan"]] += $rsqueryRingkasanKeluar["total"];
                                if(!isset($totalPerJenis[$rsqueryRingkasanKeluar["namajenis"]])) {
                                    $totalPerJenis[$rsqueryRingkasanKeluar["namajenis"]] = 0;
                                }
                                $totalPerJenis[$rsqueryRingkasanKeluar["namajenis"]] += $rsqueryRingkasanKeluar["total"];
                                if(!isset($totalPerKategori[$rsqueryRingkasanKeluar["namakategori"]])) {
                                    $totalPerKategori[$rsqueryRingkasanKeluar["namakategori"]] = 0;
                                }
                                $totalPerKategori[$rsqueryRingkasanKeluar["namakategori"]] += $rsqueryRingkasanKeluar["total"];
                            }
                        ?>
                        </tbody>
                        <tfoot>
