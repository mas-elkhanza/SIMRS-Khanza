...
<div class="block-header">
    <h2><center>RINGKASAN PENERIMAAN NON MEDIS</center></h2>
</div>
                    ...
                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                        ...
                        <?php
                            ...
                            $queryPenerimaan = bukaquery(
                                "select ipsrsdetailpesan.kode_brng,ipsrsbarang.nama_brng,ipsrsjenisbarang.nm_jenis,kodesatuan.satuan, sum(ipsrsdetailpesan.jumlah) as jumlah,sum(ipsrsdetailpesan.total) as total from ipsrspemesanan ".
                                "inner join ipsrsdetailpesan on ipsrspemesanan.no_faktur=ipsrsdetailpesan.no_faktur inner join ipsrsbarang on ipsrsdetailpesan.kode_brng=ipsrsbarang.kode_brng ".
                                "inner join ipsrsjenisbarang on ipsrsbarang.jenis=ipsrsjenisbarang.kd_jenis inner join kodesatuan on ipsrsdetailpesan.kode_sat=kodesatuan.kode_sat ".
                                "where ipsrspemesanan.tgl_pesan between '$thncaripenerimaan-$blncaripenerimaan-$tglcaripenerimaan' and '$thncaripenerimaan2-$blncaripenerimaan2-$tglcaripenerimaan2' ".
                                "group by ipsrsdetailpesan.kode_brng order by ipsrsbarang.nama_brng asc"
                            );
                            while($rspenerimaan = mysqli_fetch_array($queryPenerimaan)) {
                                ...
                                echo "<tr>
                                        ...
                                        <td align='left' style='white-space:nowrap;'>".$rspenerimaan["nm_jenis"]."</td>
