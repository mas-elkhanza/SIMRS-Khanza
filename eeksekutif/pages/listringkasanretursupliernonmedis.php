...
<div class="block-header">
    <h2><center>RINGKASAN RETUR NON MEDIS</center></h2>
</div>
                    ...
                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                        ...
                        <?php
                            ...
                            $queryRetur = bukaquery(
                                "select ipsrs_detail_returbeli.kode_brng,ipsrsbarang.nama_brng,ipsrsjenisbarang.nm_jenis,kodesatuan.satuan, ".
                                "sum(ipsrs_detail_returbeli.jml_retur) as jumlah,sum(ipsrs_detail_returbeli.total) as total ".
                                "from ipsrsreturbeli ".
                                "inner join ipsrs_detail_returbeli on ipsrsreturbeli.no_retur_beli=ipsrs_detail_returbeli.no_retur_beli ".
                                "inner join ipsrsbarang on ipsrs_detail_returbeli.kode_brng=ipsrsbarang.kode_brng ".
                                "inner join ipsrsjenisbarang on ipsrsbarang.jenis=ipsrsjenisbarang.kd_jenis ".
                                "inner join kodesatuan on ipsrs_detail_returbeli.kode_sat=kodesatuan.kode_sat ".
                                "where ipsrsreturbeli.tgl_retur between '$thncariretur-$blncariretur-$tglcariretur' and '$thncariretur2-$blncariretur2-$tglcariretur2' ".
                                "group by ipsrs_detail_returbeli.kode_brng order by ipsrsbarang.nama_brng asc"
                            );
                            while($rsretur = mysqli_fetch_array($queryRetur)) {
                                ...
                                echo "<tr>
                                        ...
                                        <td align='left' style='white-space:nowrap;'>".$rsretur["nm_jenis"]."</td>
