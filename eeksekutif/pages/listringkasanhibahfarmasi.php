                    ...
                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                        ...
                        <?php
                            ...
                            while($rsqueryRingkasanHibah = mysqli_fetch_array($queryRingkasanHibah)) {
                                ...
                                if(!isset($totalPerGolongan[$rsqueryRingkasanHibah["namagolongan"]])) {
                                    $totalPerGolongan[$rsqueryRingkasanHibah["namagolongan"]] = 0;
                                }
                                $totalPerGolongan[$rsqueryRingkasanHibah["namagolongan"]] += $rsqueryRingkasanHibah["total"];
                                if(!isset($totalPerJenis[$rsqueryRingkasanHibah["namajenis"]])) {
                                    $totalPerJenis[$rsqueryRingkasanHibah["namajenis"]] = 0;
                                }
                                $totalPerJenis[$rsqueryRingkasanHibah["namajenis"]] += $rsqueryRingkasanHibah["total"];
                                if(!isset($totalPerKategori[$rsqueryRingkasanHibah["namakategori"]])) {
                                    $totalPerKategori[$rsqueryRingkasanHibah["namakategori"]] = 0;
                                }
                                $totalPerKategori[$rsqueryRingkasanHibah["namakategori"]] += $rsqueryRingkasanHibah["total"];
                            }
                        ?>
                        </tbody>
                        <tfoot>
...
$(function() {
    ...
    ['golongan','jenis','kategori'].forEach(function(kunciGrup) {
