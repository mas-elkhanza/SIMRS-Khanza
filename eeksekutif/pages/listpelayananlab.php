...
<div class="block-header">
    <h2><center>DATA PELAYANAN LABORATORIUM</center></h2>
</div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <?php
                                    ...
                                    $querytindakanralan  = bukaquery("select jns_perawatan_lab.nm_perawatan,count(periksa_lab.no_rawat) as jumlah from periksa_lab inner join jns_perawatan_lab on periksa_lab.kd_jenis_prw=jns_perawatan_lab.kd_jenis_prw where periksa_lab.status='Ralan' and periksa_lab.tgl_periksa between '$thncaripelayanan-$blncaripelayanan-$tglcaripelayanan' and '$thncaripelayanan2-$blncaripelayanan2-$tglcaripelayanan2' group by jns_perawatan_lab.nm_perawatan order by jumlah desc");
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <?php
                                    ...
                                    $querytindakanranap  = bukaquery("select jns_perawatan_lab.nm_perawatan,count(periksa_lab.no_rawat) as jumlah from periksa_lab inner join jns_perawatan_lab on periksa_lab.kd_jenis_prw=jns_perawatan_lab.kd_jenis_prw where periksa_lab.status='Ranap' and periksa_lab.tgl_periksa between '$thncaripelayanan-$blncaripelayanan-$tglcaripelayanan' and '$thncaripelayanan2-$blncaripelayanan2-$tglcaripelayanan2' group by jns_perawatan_lab.nm_perawatan order by jumlah desc");
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <?php
                                    ...
                                    $dataDokterPerujuk    = [];
                                    $querydokterperujuk   = bukaquery("select dokter.nm_dokter,count(periksa_lab.no_rawat) as jumlah from periksa_lab inner join dokter on periksa_lab.dokter_perujuk=dokter.kd_dokter where periksa_lab.tgl_periksa between '$thncaripelayanan-$blncaripelayanan-$tglcaripelayanan' and '$thncaripelayanan2-$blncaripelayanan2-$tglcaripelayanan2' group by dokter.kd_dokter order by jumlah desc");
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <?php
                                    ...
                                    $querydokterperujukranap   = bukaquery("select dokter.nm_dokter,count(periksa_lab.no_rawat) as jumlah from periksa_lab inner join dokter on periksa_lab.dokter_perujuk=dokter.kd_dokter where periksa_lab.status='Ranap' and periksa_lab.tgl_periksa between '$thncaripelayanan-$blncaripelayanan-$tglcaripelayanan' and '$thncaripelayanan2-$blncaripelayanan2-$tglcaripelayanan2' group by dokter.kd_dokter order by jumlah desc");
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <?php
                                    ...
                                    $querydokterperujukralan   = bukaquery("select dokter.nm_dokter,count(periksa_lab.no_rawat) as jumlah from periksa_lab inner join dokter on periksa_lab.dokter_perujuk=dokter.kd_dokter where periksa_lab.status='Ralan' and periksa_lab.tgl_periksa between '$thncaripelayanan-$blncaripelayanan-$tglcaripelayanan' and '$thncaripelayanan2-$blncaripelayanan2-$tglcaripelayanan2' group by dokter.kd_dokter order by jumlah desc");
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <?php
                                    ...
                                    $totalCaraBayar  = 0;
                                    $dataCaraBayar   = [];
                                    $querycarabayar  = bukaquery("select penjab.png_jawab,count(periksa_lab.no_rawat) as jumlah from periksa_lab inner join reg_periksa on periksa_lab.no_rawat=reg_periksa.no_rawat inner join penjab on reg_periksa.kd_pj=penjab.kd_pj where periksa_lab.tgl_periksa between '$thncaripelayanan-$blncaripelayanan-$tglcaripelayanan' and '$thncaripelayanan2-$blncaripelayanan2-$tglcaripelayanan2' group by penjab.kd_pj order by jumlah desc");
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <?php
                                    ...
                                    $dataCaraBayarRanap   = [];
                                    $querycarabayarranap  = bukaquery("select penjab.png_jawab,count(periksa_lab.no_rawat) as jumlah from periksa_lab inner join reg_periksa on periksa_lab.no_rawat=reg_periksa.no_rawat inner join penjab on reg_periksa.kd_pj=penjab.kd_pj where periksa_lab.status='Ranap' and periksa_lab.tgl_periksa between '$thncaripelayanan-$blncaripelayanan-$tglcaripelayanan' and '$thncaripelayanan2-$blncaripelayanan2-$tglcaripelayanan2' group by penjab.kd_pj order by jumlah desc");
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <?php
                                    ...
                                    $dataCaraBayarRalan   = [];
                                    $querycarabayarralan  = bukaquery("select penjab.png_jawab,count(periksa_lab.no_rawat) as jumlah from periksa_lab inner join reg_periksa on periksa_lab.no_rawat=reg_periksa.no_rawat inner join penjab on reg_periksa.kd_pj=penjab.kd_pj where periksa_lab.status='Ralan' and periksa_lab.tgl_periksa between '$thncaripelayanan-$blncaripelayanan-$tglcaripelayanan' and '$thncaripelayanan2-$blncaripelayanan2-$tglcaripelayanan2' group by penjab.kd_pj order by jumlah desc");
