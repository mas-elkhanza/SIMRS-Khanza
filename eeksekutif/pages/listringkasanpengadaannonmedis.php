...
<div class="block-header">
    <h2><center>RINGKASAN PENGADAAN NON MEDIS</center></h2>
</div>
                    ...
                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                        ...
                        <?php
                            ...
                            $queryPengadaan = bukaquery(
                                "select ipsrsdetailbeli.kode_brng,ipsrsbarang.nama_brng,ipsrsjenisbarang.nm_jenis,kodesatuan.satuan, sum(ipsrsdetailbeli.jumlah) as jumlah,sum(ipsrsdetailbeli.total) as total ".
                                "from ipsrspembelian inner join ipsrsdetailbeli on ipsrspembelian.no_faktur=ipsrsdetailbeli.no_faktur inner join ipsrsbarang on ipsrsdetailbeli.kode_brng=ipsrsbarang.kode_brng ".
                                ...
                                "where ipsrspembelian.tgl_beli between '$thncaripengadaan-$blncaripengadaan-$tglcaripengadaan' and '$thncaripengadaan2-$blncaripengadaan2-$tglcaripengadaan2' ".
                                "group by ipsrsdetailbeli.kode_brng order by ipsrsbarang.nama_brng asc"
                            );
                            while($rspengadaan = mysqli_fetch_array($queryPengadaan)) {
                                ...
                                echo "<tr>
                                        ...
                                        <td align='left' style='white-space:nowrap;'>".$rspengadaan["nm_jenis"]."</td>
