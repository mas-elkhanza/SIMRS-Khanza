<div class="block-header">
    <h2><center>SISA STOK & NILAI ASET NON MEDIS</center></h2>
</div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                        ...
                        <?php
                            ...
                            $jenisAset = [];
                            $queryStok = bukaquery(
                                "select ipsrsbarang.kode_brng,ipsrsbarang.nama_brng,ipsrsbarang.kode_sat,ipsrsbarang.stok,ipsrsbarang.harga,ipsrsjenisbarang.nm_jenis ".
                                "from ipsrsbarang inner join ipsrsjenisbarang on ipsrsbarang.jenis=ipsrsjenisbarang.kd_jenis where ipsrsbarang.status='1' ".
                                "order by ipsrsbarang.kode_brng asc"
                            );
                            while($rsqueryStok = mysqli_fetch_array($queryStok)) {
                                ...
                                if(!isset($jenisAset[$rsqueryStok["nm_jenis"]])) {
                                    $jenisAset[$rsqueryStok["nm_jenis"]] = 0;
                                }
                                $jenisAset[$rsqueryStok["nm_jenis"]] += $nilaiAsetBarang;
                                echo "<tr>
                                        ...
                                        <td align='left' style='white-space:nowrap;'>".$rsqueryStok["nm_jenis"]."</td>
