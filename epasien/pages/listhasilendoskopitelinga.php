    ...
    if (isset($iyem["norawat"])) {
        ...
        if($rsqueryendoskopi= mysqli_fetch_array($queryendoskopi)){
            ...
            if($rsquerygambarendoskopi= mysqli_fetch_array($querygambarendoskopi)){
                $src = 'data: image/jpeg;base64,'.base64_encode(file_get_contents("http://".$_SERVER['HTTP_HOST']."/webapps/hasilpemeriksaanendoskopitelinga/".$rsquerygambarendoskopi["photo"]));
                echo "              <tr>
