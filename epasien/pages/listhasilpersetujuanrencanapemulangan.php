<?php
    ...
    if (isset($iyem["norawat"])) {
        ...
        $querypersetujuan = bukaquery(
            ...
            "perencanaan_pemulangan.nama_pasien_keluarga,reg_periksa.tgl_registrasi,reg_periksa.jam_reg,bukti_perencanaan_pemulangan_saksikeluarga.photo from perencanaan_pemulangan ".
            "inner join reg_periksa on reg_periksa.no_rawat=perencanaan_pemulangan.no_rawat ".
            "inner join bukti_perencanaan_pemulangan_saksikeluarga on bukti_perencanaan_pemulangan_saksikeluarga.no_rawat=perencanaan_pemulangan.no_rawat ".
            "where perencanaan_pemulangan.no_rawat='".$norawat."'"
        );
        if($rsquerypersetujuan= mysqli_fetch_array($querypersetujuan)){
            $src = 'data: '.mime_content_type("http://".host()."/webapps/perencanaanpemulangan/".$rsquerypersetujuan["photo"]).';base64,'.base64_encode(file_get_contents("http://".host()."/webapps/perencanaanpemulangan/".$rsquerypersetujuan["photo"]));
