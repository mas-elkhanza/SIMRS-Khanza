                                    ...
                                    if($_SESSION["Capcay"]!= @getOne2("select aes_encrypt(".cleankar($_POST["inputcaptcha"]).",'windi')")){
                                        echo "<form id=\"appointment-form\" role=\"form\" onsubmit=\"return validasiIsi();\" method=\"post\" action=\"\" enctype=multipart/form-data>
                                                <div class=\"col-md-12 col-sm-12\">
                                                   ...
                                                   <input type=\"password\" class=\"form-control\" name=\"norme\" placeholder=\"Masukkan Nomor Rekam Medis\" onkeydown=\"setDefault(this, document.getElementById('MsgIsi1'));\" id=\"TxtIsi1\" autocomplete=\"off\" autofocus/>
                                                   <span id=\"MsgIsi1\" style=\"color:#CC0000; font-size:10px;\"></span>
                                                </div>
                                                <div class=\"col-md-12 col-sm-12\">
                                                   <label for=\"passworde\">Password</label>
                                                   <input type=\"password\" class=\"form-control\" name=\"passworde\" placeholder=\"Masukkan Password\" onkeydown=\"setDefault(this, document.getElementById('MsgIsi2'));\" id=\"TxtIsi2\" autocomplete=\"off\" />
                                                ...
                                                <div class=\"col-md-12 col-sm-12\">
                                                   ...
                                                   <table width=\"100%\" border=\"0\">
                                                    <tr>
                                                     ...
                                                     <td width=\"50%\">
                                                        <input type=\"text\" class=\"form-control\" onkeydown=\"setDefault(this, document.getElementById('MsgIsi3'));\" id=\"TxtIsi3\" name=\"inputcaptcha\" placeholder=\"Masukkan Captcha\" autocomplete=\"off\" />
                                                     </td>
                                                    </tr>
                                                   </table>
