    ...
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <div class="info-box bg-pink hover-expand-effect">
            ...
            <div class="content">
                ...
                <div class="number count-to" data-from="0" data-to="<?=@getOne2("SELECT count(no_rkm_medis) FROM reg_periksa WHERE no_rkm_medis = '".encrypt_decrypt($_SESSION["ses_pasien"],"d")."'");?>" data-speed="3000" data-fresh-interval="20"></div>
            </div>
        </div>
    </div>
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <div class="info-box bg-cyan hover-expand-effect">
            ...
            <div class="content">
                ...
                <div class="number count-to" data-from="0" data-to="<?=@getOne2("SELECT count(no_rkm_medis) FROM reg_periksa WHERE no_rkm_medis = '".encrypt_decrypt($_SESSION["ses_pasien"],"d")."' AND status_lanjut = 'Ralan'");?>" data-speed="2000" data-fresh-interval="20"></div>
            </div>
        </div>
    </div>
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <div class="info-box bg-light-green hover-expand-effect">
            ...
            <div class="content">
                ...
                <div class="number count-to" data-from="0" data-to="<?=@getOne2("SELECT count(no_rkm_medis) FROM reg_periksa WHERE no_rkm_medis = '".encrypt_decrypt($_SESSION["ses_pasien"],"d")."' AND status_lanjut = 'Ranap'");?>" data-speed="1000" data-fresh-interval="20"></div>
            </div>
        </div>
    </div>
    <!-- <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
