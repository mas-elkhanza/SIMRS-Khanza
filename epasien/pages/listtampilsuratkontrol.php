<?php
    ...
    $token      = json_decode(encrypt_decrypt($nosurat,"d"),true); 
    ...
    if (isset($noantrian)) {
        ...
        if($rsquerysuratrujuk = mysqli_fetch_array($querysuratrujuk)) {
            ...
            echo "<div class='row clearfix'>
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class='card'>
                            <div class='header'>
                                <h2><center>SURAT KONTROL/SKDPAN<br>Nomor : ".$rsquerysuratrujuk["no_rujuk"]."</center></h2>
                            </div>
            ...
            JSRedirect2("index.php?act=SuratKontrol",7);
        }*/
    }else{
        echo "<div class='block-header'>
                    <h2><center>SURAT KONTROL/SKDP</center></h2>
        ...
        JSRedirect2("index.php?act=SuratKontrol",4);
    }
?>
