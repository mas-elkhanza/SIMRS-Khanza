    ...
    if (isset($iyem["nopernyataan"])) {
        ...
        if($rsquerypernyataan= mysqli_fetch_array($querypernyataan)){
            ...
            if (isset($BtnSimpan)) {
                ...
                if(file_exists("../webapps/pernyataanmenerimabarang/pages/upload/".$nopernyataan.".jpeg")){
                    @unlink("../webapps/pernyataanmenerimabarang/pages/upload/".$nopernyataan.".jpeg");
                }
                $img               = $_POST["image"];
                $folderPath        = "../webapps/pernyataanmenerimabarang/pages/upload/";
                ...
                if(file_put_contents($file, $image_base64)){
                    if(file_exists("../webapps/pernyataanmenerimabarang/pages/upload/".$nopernyataan.".jpeg")){
                        try{
                            if(Tambah3("surat_serah_terima_barang_anggota_tubuh_bukti","'".$nopernyataan."','pages/upload/$fileName'")){
                                JSRedirect("index.php?act=PernyataanMenerimaBarang&hal=Persetujuan");
                            }
