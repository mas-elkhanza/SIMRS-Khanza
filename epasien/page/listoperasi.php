                         ...
                         <form id="cariKamar" name="frmCariOperasi" method="post" action="" enctype=multipart/form-data>
                           <table width="100%" border='0' align="center">
                               <tr class="head">
                                  ...
                                  <td width="69%"><input name="operasi" id="operasi" class="form-control" value="" size="65" maxlength="250" /></td>
                            ...
                            <?php 
                               ...
                               while($rsqueryoperasi = mysqli_fetch_array($queryoperasi)) {
                                   echo "<tr>
                                           ...
                                           <td align='center'>".$rsqueryoperasi["total"]."</td>
                                         </tr>";
                               }
                           ?>
                        </table>
