                                      ...
                                      <div class='col-md-12 col-sm-12'>
                                        ...
                                        <div class='news-thumb wow fadeInUp' data-wow-delay='0.2s'>
                                            ...
                                            <table width='95%' border='0' align='center'>
                                                ...
                                                <tr><td colspan='2' align='center'><a href='../CetakBooking.php?&nobooking=$no_urut' target=_blank class='btn btn-success'> Cetak </a></td></tr>
                                            </table>
                                            <br>
                                        </div>
                                        <br>
                                        <center>No.Booking bukan merupakan nomor pendaftaran registrasi, kami akan melakukan pengecekan terhadap jadwal & kuota dokter yang tersedia berdasarkan booking Anda. Konfirmasi booking periksa akan Kami sampaikan melalui E-Mail atau No.HP/Telp Anda. Atau <a href='index.php?act=CekBooking' class='btn btn-danger'>Cek Booking</a> untuk melihat status booking Anda</center>
                                      </div>
                                 </div>
                            </div>
                      </section>";
