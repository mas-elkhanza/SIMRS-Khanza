...
public class DlgUbahTagihanOperasi extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal*/
    public DlgUbahTagihanOperasi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgUbahTagihanOperasi dialog = new DlgUbahTagihanOperasi(new javax.swing.JFrame(), true);
