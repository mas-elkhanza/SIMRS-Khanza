...
public final class DlgPeriksaRadiologi extends javax.swing.JDialog {
    ...
    private String aktifkanparsial = "no", noorder = "", kelas_radiologi = "Yes", kelas = "",
            cara_bayar_radiologi = "Yes", pilihan = "", pemeriksaan = "", kamar, namakamar, status = "";
    ...
    private String Suspen_Piutang_Radiologi_Ranap = "", Radiologi_Ranap = "",
            ...
            Persediaan_BHP_Radiologi_Rawat_Inap = "", norawatibu = "", proyeksi = "", kV = "", mAS = "", FFD = "",
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(
                ...
                "::[ Input Data Hasil Periksa Radiologi ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(
                javax.swing.BorderFactory.createLineBorder(new java.awt.Color(241, 246, 236)), " Pemeriksaan ",
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(
                javax.swing.BorderFactory.createLineBorder(new java.awt.Color(241, 246, 236)), " BHP Radiologi ",
                javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION,
                new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        Scroll3.setBorder(javax.swing.BorderFactory.createTitledBorder(
                javax.swing.BorderFactory.createLineBorder(new java.awt.Color(241, 246, 236)), " Hasil Pemeriksaan ",
                javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION,
                new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            for (i = 0; i < tbPemeriksaan.getRowCount(); i++) {
                ...
                if (tbPemeriksaan.getValueAt(i, 0).toString().equals("true")) {
                    ...
                    ttl = ttl + item;
                    Sequel.menyimpan("temporary_radiologi", "'0','" + tbPemeriksaan.getValueAt(i, 2).toString() + "','"
                            + item
                            + "','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','',''",
            ...
            Sequel.menyimpan("temporary_radiologi", "'0','Total Biaya Pemeriksaan Radiologi','" + ttl
                    + "','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','',''",
                    "Transaksi Biaya Radiologi");
            Valid.panggilUrl("billing/LaporanBiayaRadiologi.php?norm=" + TNoRM.getText() + "&pasien="
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (TNoRw.getText().equals("") || TNoRM.getText().equals("") || TPasien.getText().equals("")) {
            ...
            for (i = 0; i < tbPemeriksaan.getRowCount(); i++) {
                if (tbPemeriksaan.getValueAt(i, 0).toString().equals("true")) {
                    pemeriksaan = tbPemeriksaan.getValueAt(i, 2).toString() + " dengan Proyeksi : "
                            + tbPemeriksaan.getValueAt(i, 11).toString() + ", kV : "
                            + tbPemeriksaan.getValueAt(i, 12).toString() + ", mAS : "
                            + tbPemeriksaan.getValueAt(i, 13).toString() + ", FFD : "
                            + tbPemeriksaan.getValueAt(i, 14).toString() + ", BSF : "
                            + tbPemeriksaan.getValueAt(i, 15).toString() + ", Inak : "
                            + tbPemeriksaan.getValueAt(i, 16).toString() + ", Jml Penyinaran : "
                            + tbPemeriksaan.getValueAt(i, 17).toString() + ", Dosis Radiasi : "
                            + tbPemeriksaan.getValueAt(i, 18).toString() + ", " + pemeriksaan;
                }
            }
            ...
            pilihan = (String) JOptionPane.showInputDialog(null, "Silahkan pilih hasil pemeriksaan..!",
                    ...
                    new Object[] { "Model 1", "Model 2", "Model 3" }, "Model 1");
            switch (pilihan) {
                case "Model 1":
        ...
        try {
            ...
            try {
                ...
                while (rssetpj.next()) {
                    ...
                    NmDokterPj.setText(
                            Sequel.cariIsi("select nm_dokter from dokter where kd_dokter=?", rssetpj.getString(2)));
                }
            } catch (Exception e) {
                System.out.println(e);
            } finally {
                        ...
                        while (rs2.next()) {
                            ...
                            koneksiradiologi
                                    .prepareStatement("update order_out set statusupdate='1' where kode_tindakan='"
                                            + rs.getString("kd_jenis_prw") + "' and no_rontgen='" + order + "'")
                                    .executeUpdate();
                        }
                    } catch (Exception e) {
            ...
            for (i = 0; i < tbPemeriksaan.getRowCount(); i++) {
                if (tbPemeriksaan.getValueAt(i, 0).toString().equals("true")) {
                    ...
                    if (Sequel.menyimpantf2("periksa_radiologi", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",
                        ...
                        ttljmdokter = ttljmdokter + Double.parseDouble(tbPemeriksaan.getValueAt(i, 6).toString())
            ...
            for (i = 0; i < tbObat.getRowCount(); i++) {
                if (Valid.SetAngka(tbObat.getValueAt(i, 0).toString()) > 0) {
                    if (Sequel.menyimpantf2("beri_bhp_radiologi", "?,?,?,?,?,?,?,?", "BHP", 8,
                        ...
                        ttlbhp = ttlbhp + (Double.parseDouble(tbObat.getValueAt(i, 4).toString())
                                * Double.parseDouble(tbObat.getValueAt(i, 0).toString()));
                    }
                }
            }
            if (!HasilPeriksa.getText().equals("")) {
                Sequel.menyimpan("hasil_radiologi", "?,?,?,?", "Hasil Radiologi", 4,
                        new String[] {
                                TNoRw.getText(), Valid.SetTgl(Tanggal.getSelectedItem() + ""), CmbJam.getSelectedItem()
            ...
            if (status.equals("Ranap")) {
                ...
                if (ttlpendapatan > 0) {
                    Sequel.menyimpan("tampjurnal", "'" + Suspen_Piutang_Radiologi_Ranap
                            + "','Suspen Piutang Radiologi Ranap','" + ttlpendapatan + "','0'", "Rekening");
                ...
                if (ttlbhp > 0) {
                    Sequel.menyimpan("tampjurnal", "'" + HPP_Persediaan_Radiologi_Rawat_Inap
                            + "','HPP Persediaan Radiologi Rawat Inap','" + ttlbhp + "','0'", "Rekening");
                    Sequel.menyimpan("tampjurnal", "'" + Persediaan_BHP_Radiologi_Rawat_Inap
                            + "','Persediaan BHP Radiologi Rawat Inap','0','" + ttlbhp + "'", "Rekening");
                }
                if (ttlkso > 0) {
                    Sequel.menyimpan("tampjurnal",
                ...
                jur.simpanJurnal(TNoRw.getText(), Valid.SetTgl(Tanggal.getSelectedItem() + ""), "U",
                        "PEMERIKSAAN RADIOLOGI RAWAT INAP PASIEN " + TPasien.getText() + " DIPOSTING OLEH "
                                + akses.getkode());
            }
