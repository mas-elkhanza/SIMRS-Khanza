...
public final class DlgUbahPeriksaLab extends javax.swing.JDialog {
    ...
    private PreparedStatement pstindakan,pstindakan2,pstampil,pstampil2,pstampil3,pstampil4,pssimpanperiksa,
            psdetailpriksa,pscariperawatan,psset_tarif,pscariperiksa,pscaridetailperiksa,psrekening;
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Ubah Data Hasil Periksa Laboratorium ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(70, 70, 70))); // NOI18N
            ...
            if (reply == JOptionPane.YES_OPTION) {
                try {                    
                    ...
                    if(Sequel.queryutf("delete from periksa_lab where no_rawat='"+TNoRw.getText() +
                        ...
                        if(Sequel.queryutf("delete from detail_periksa_lab where no_rawat='"+TNoRw.getText() +
                            ...
                            if(status.equals("Ranap")){
                                ...
                                jur.simpanJurnal(TNoRw.getText().toString(),Sequel.cariIsi("select current_date()"),"U","PEMBATALAN PEMERIKSAAN LABORAT RAWAT INAP PASIEN OLEH "+akses.getkode());  
                            }                     
                        }
                    }
                    ...
                    if(status.equals("Ranap")){
                        ...
                        jur.simpanJurnal(TNoRw.getText(),Sequel.cariIsi("select current_date()"),"U","PEMERIKSAAN LABORAT RAWAT INAP PASIEN "+TPasien.getText()+" DIPOSTING OLEH "+akses.getkode());  
                    }
