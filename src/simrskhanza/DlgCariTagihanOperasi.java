...
private void MnHapusObatOperasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnHapusObatOperasiActionPerformed
    ...
    private void MnUBahTagihanOperasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnUBahTagihanOperasiActionPerformed
        if(tbDokter.getSelectedRow()>-1){
            if(!tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString().equals("")){
               /* DlgUbahTagihanOperasi dlgro=new DlgUbahTagihanOperasi(null,false);
                dlgro.setSize(internalFrame1.getWidth()-40,internalFrame1.getHeight()-40);
                dlgro.setLocationRelativeTo(internalFrame1);
                dlgro.setNoRm(tbDokter.getValueAt(tbDokter.getSelectedRow(),1).toString(),tbDokter.getValueAt(tbDokter.getSelectedRow(),2).toString(),tbDokter.getValueAt(tbDokter.getSelectedRow(),0).toString(),"Ranap");  
