...
public final class DlgRawatJalan extends javax.swing.JDialog {
    ...
    List<Boolean> stts = new ArrayList<>();
...
//        setSize(885,620);
        ...
        tabModeDrPr = new DefaultTableModel(null, new Object[]{
            ...
            "Biaya", "Kode", "Tarif Dokter", "Tarif Petugas", "KSO", "KD Perawatan"}) {
            @Override
            public boolean isCellEditable(int rowIndex, int colIndex) {
                boolean a = false;
                if (colIndex == 0) {
...
//        tbSpri.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
        ...
        TabModeTindakan2 = new DefaultTableModel(null, new Object[]{
            "P", "Kode", "Nama Perawatan", "Kategori Perawatan", "Tarif/Biaya",
            "Bagian RS", "BHP", "JM Dokter", "JM Perawat", "KSO", "Menejemen"}) {
            @Override
            public boolean isCellEditable(int rowIndex, int colIndex) {
        ...
        TabModeTindakan3 = new DefaultTableModel(null, new Object[]{
            "P", "Kode", "Nama Perawatan", "Kategori Perawatan", "Tarif/Biaya",
            "Bagian RS", "BHP", "JM Dokter", "JM Perawat", "KSO", "Menejemen"}) {
            @Override
            public boolean isCellEditable(int rowIndex, int colIndex) {
...
//        System.out.println("Kd Poli=" + kode_poli + ", status=" + status);
    ...
    private void initComponents() {
        ...
        panelGlass9Layout.setVerticalGroup(
            ...
            .addGroup(panelGlass9Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(panelGlass9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelGlass9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(BtnCari, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(BtnTambahTindakan, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        BtnSeekPetugas2.setBounds(580, 40, 28, 23);
        ...
        TPerawat2.setBounds(200, 40, 370, 23);
        ...
        TDokter2.setBounds(200, 10, 370, 23);
        ...
        TPasien.setBounds(283, 10, 230, 23);

        jLabel23.setText("Tanggal :");
        jLabel23.setName("jLabel23"); // NOI18N
        FormInput.add(jLabel23);
        jLabel23.setBounds(520, 10, 60, 23);
            ...
            switch (TabRawat.getSelectedIndex()) {
                ...
                case 7:
                    if (akses.getdiagnosa_pasien() == true) {
                        panelDiagnosa1.setRM(TNoRw.getText(), TNoRM.getText(), Valid.SetDateToString(DTPCari1.getDate()), Valid.SetDateToString(DTPCari2.getDate()), "Ralan", TCari.getText().trim());
    ...
    private void messageSukses(boolean s) throws HeadlessException {
        for (Boolean stt : stts) {
            stt &= stt;
            s = stt;
        }
        ...
        if (s) {
            ...
            for (int i = 0; i < tbTindakan3.getRowCount(); i++) {
                tbTindakan3.setValueAt(false, i, 0);
            }
        } else {
            JOptionPane.showMessageDialog(rootPane, "Gagal Simpan (=_=).");
        }
    }
...
//                            } else {
                            ...
                            if (txtPenjab.getText().equals("364")||txtPenjab.getText().equals("INH")) {
        ...
        switch (TabRawat.getSelectedIndex()) {
            case 0:
                if (tabModeDr.getRowCount() == 0) {
                    ...
                    String tgl = " rawat_jl_dr.tgl_perawatan between '" + Valid.SetDateToString(DTPCari1.getDate()) + "' and '" + Valid.SetDateToString(DTPCari2.getDate()) + "' " + pas;
            ...
            case 1:
                if (tabModePr.getRowCount() == 0) {
                    ...
                    String tgl = " rawat_jl_pr.tgl_perawatan between '" + Valid.SetDateToString(DTPCari1.getDate()) + "' and '" + Valid.SetDateToString(DTPCari2.getDate()) + "' " + pas;
            ...
            case 2:
                if (tabModeDrPr.getRowCount() == 0) {
                    ...
                    String tgl = " rawat_jl_drpr.tgl_perawatan between '" + Valid.SetDateToString(DTPCari1.getDate()) + "' and '" + Valid.SetDateToString(DTPCari2.getDate()) + "' " + pas;
            ...
            case 3:
                if (tabModePemeriksaan.getRowCount() == 0) {
                    ...
                    String tgl = " pemeriksaan_ralan.tgl_perawatan between '" + Valid.SetDateToString(DTPCari1.getDate()) + "' and '" + Valid.SetDateToString(DTPCari2.getDate()) + "' " + pas;
            ...
            case 4:
                if (tabModeObstetri.getRowCount() == 0) {
                    ...
                    String tgl = " pemeriksaan_obstetri_ralan.tgl_perawatan between '" + Valid.SetDateToString(DTPCari1.getDate()) + "' and '" + Valid.SetDateToString(DTPCari2.getDate()) + "' " + pas;
            ...
            case 5:
                if (tabModeGinekologi.getRowCount() == 0) {
                    ...
                    String tgl = " pemeriksaan_ginekologi_ralan.tgl_perawatan between '" + Valid.SetDateToString(DTPCari1.getDate()) + "' and '" + Valid.SetDateToString(DTPCari2.getDate()) + "' " + pas;
            ...
            case 8:
                if (TabModeCatatan.getRowCount() == 0) {
                    ...
                    String tgl = " catatan_perawatan.tanggal between '" + Valid.SetDateToString(DTPCari1.getDate()) + "' and '" + Valid.SetDateToString(DTPCari2.getDate()) + "' " + pas;
...
//                TabRawatTindakanPetugasMouseClicked(null);
            ...
            case 6:
                ...
                TCariPasien.setText(TNoRM.getText());
                if (akses.getresume_pasien() == true) {
                    panelResume1.setRM(TNoRM.getText(), Valid.SetDateToString(DTPCari1.getDate()), Valid.SetDateToString(DTPCari2.getDate()), false);
                        ...
                        if (tbRawatDrPr.getValueAt(i, 0).toString().equals("true")) {
                            if (Sequel.cariRegistrasi(tbRawatDrPr.getValueAt(i, 1).toString()) > 0) {
                                ...
                                Sequel.mengedittf("rawat_jl_drpr", "no_rawat ='" + TNoRw.getText()
                                        + "' and kd_jenis_prw = '" + tbRawatDrPr.getValueAt(i, 16).toString() + "' ",
                ...
                if (!Catatan.getText().trim().equals("")) {
                    if (tbCatatan.getSelectedRow() > -1) {
                        if (Sequel.mengedittf("catatan_perawatan", "no_rawat='" + tbCatatan.getValueAt(tbCatatan.getSelectedRow(), 1)
                                ...
                                + "kd_dokter='" + KdDok3.getText() + "',tanggal='" + Valid.SetDateToString(DTPTgl.getDate()) + "',"
    ...
    private void tampilDrPr() {
        ...
        try {
            ps3 = koneksi.prepareStatement("select rawat_jl_drpr.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"
                    ...
                    + "rawat_jl_drpr.tarif_tindakandr,rawat_jl_drpr.tarif_tindakanpr,rawat_jl_drpr.kso, rawat_jl_drpr.kd_jenis_prw as kd_jenis  "
                    + "from pasien inner join reg_periksa inner join jns_perawatan inner join "
            ...
            try {
                ...
                while (rs.next()) {
                    tabModeDrPr.addRow(new Object[]{
                        ...
                        rs.getString("tarif_tindakandr"), rs.getString("tarif_tindakanpr"), rs.getString("kso"), rs.getString("kd_jenis")
                    });
                }
            } catch (Exception e) {
                System.out.println("Notifikasi : " + e);
            ...
            for (i = 0; i < tbTindakan.getRowCount(); i++) {
                if (tbTindakan.getValueAt(i, 0).toString().equals("true")) {
                    if (Sequel.menyimpantf("rawat_jl_dr", "?,?,?,?,?,?,?,?,?,?,?,'Belum'", "Tindakan", 11, new String[]{
                        TNoRw.getText(), tbTindakan.getValueAt(i, 1).toString(), KdDok.getText(), Valid.SetDateToString(DTPTgl.getDate()),
            ...
            for (i = 0; i < tbTindakan2.getRowCount(); i++) {
                if (tbTindakan2.getValueAt(i, 0).toString().equals("true")) {
                    if (Sequel.menyimpantf("rawat_jl_pr", "?,?,?,?,?,?,?,?,?,?,?,'Belum'", "Tindakan", 11, new String[]{
                        TNoRw.getText(), tbTindakan2.getValueAt(i, 1).toString(), kdptg.getText(), Valid.SetDateToString(DTPTgl.getDate()),
...
//                    }
    ...
    private boolean simpanRawatJlDrpr() {
        boolean s = Sequel.menyimpantf("rawat_jl_drpr", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "Tindakan", 15, new String[]{
            ...
            tbTindakan3.getValueAt(i, 4).toString(), "Belum", null
        });
        stts.add(s);
        return s;
    }
...
//    }
    private void hapusTindakanInhealth(String noSjp) {
        try {
            ...
            String jnsPelayanan = Sequel.cariIsi("select jnspelayanan from bridging_inhealth where no_rawat='" + TNoRw.getText() + "'");
            String tglMasukRawat = Sequel.cariIsi("select tgl_registrasi from bridging_inhealth inner join reg_periksa on reg_periksa.no_rawat=bridging_inhealth.no_rawat where bridging_inhealth.no_rawat='" + TNoRw.getText() + "'");
            String kodeTindakan = Sequel.cariIsi("select kd_inhealth from inhealth_tindakan_ralan where kd_jenis_prw='" + tbRawatDrPr.getValueAt(i, 16).toString() + "'");
            String poli = Sequel.cariIsi("select kd_poli_inhealth from inhealth_maping_poli where kd_poli_rs='" + kdpoli.getText() + "'");
            String kodeDokter = Sequel.cariIsi("select kd_inhealth from inhealth_maping_dokter where kd_dokter='" + KdDok2.getText() + "'");
            String tarip = Sequel.cariIsi("select tarif from tarif_inhealth where kode_jenpel='" + kodeTindakan + "' and kode_kelas='000'");
            String date = Valid.SetDateToString(DTPTgl.getDate());
...
//        dlgobt.setNoRm(TNoRw.getText(), TNoRM.getText(), TPasien.getText(), Valid.SetDateToString(DTPTgl.getDate()), cmbJam.getSelectedItem() + ":" + cmbMnt.getSelectedItem() + ":" + cmbDtk.getSelectedItem());
//        dlgobt.isCek();
