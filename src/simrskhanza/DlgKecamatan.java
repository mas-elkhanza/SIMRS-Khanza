...
//                    getData();
    ...
    */
    ...
    private void tampil() {
        ...
        try{ 
            ps=koneksi.prepareStatement("select nama, kode_wilayah from wilayah where nama like ? and mst_kode_wilayah=? and level=3 order by kode_wilayah");
            try {
                ps.setString(1,"%"+TCari.getText().trim()+"%");
                ps.setString(2,kd_kab);
                rs=ps.executeQuery();
                while(rs.next()){
