                ...
                if (sukses == true) {
                    for (int r = 0; r < tbObat.getRowCount(); r++) {
                        if (Valid.SetAngka(tbObat.getValueAt(r, 0).toString()) > 0) {
                            if (simpanBeriObatOperasi(r) == true) {
...
<<<<<<< Updated upstream
                ...
                if(sukses==true){
                    if(status.equals("Ranap")){
                        ...
                        sukses=jur.simpanJurnal(TNoRw.getText(),Valid.SetTgl(tgl.getSelectedItem()+""),"U","OPERASI RAWAT JALAN PASIEN "+TPasien.getText()+" DIPOSTING OLEH "+akses.getkode());                                              
=======
                }
...
>>>>>>> Stashed changes
    ...
    private boolean simpanLapOperasi() {
        return Sequel.menyimpantf2("laporan_operasi", "?,?,?,?,?,?,?,?", "laporan operasi", 8, new String[]{
    ...
    private boolean simpanBeriObatOperasi(int r) {
        return Sequel.menyimpantf2("beri_obat_operasi", "'" + TNoRw.getText() + "','" + Valid.SetTgl(tgl.getSelectedItem() + "") + " " + tgl.getSelectedItem().toString().substring(11, 19)
