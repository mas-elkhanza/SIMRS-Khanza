...
public class MenuBar extends JMenuBar {
    ...
    private final Color light = new Color(164, 164, 164);
    private final Color dark = new Color(164, 164, 164);
    private final Color black = new Color(164, 164, 164);
    private final Color warna = new Color(164, 164, 164);
