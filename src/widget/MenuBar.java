...
public class MenuBar extends JMenuBar {
    ...
    private final Color light = new Color(1F, 1F, 1F, 0.2F);
    private final Color dark = new Color(1F, 1F, 1F, 0.2F);
    //private Color black = Color.black;
    //private Color warna = Color.magenta.darker().darker().darker().darker();
    private final Color black = new Color(245,0,110);
    private final Color warna = new Color(245,0,110);
