 ...
 * @author perpustakaan
 */
public class DlgSuratMasuk extends javax.swing.JDialog {
    ...
    public DlgSuratMasuk(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        initComponents2();
    }
            ...
            public void run() {
                ...
                engine.titleProperty().addListener((ObservableValue<? extends String> observable, String oldValue, final String newValue) -> {
                    SwingUtilities.invokeLater(() -> {
                        DlgSuratMasuk.this.setTitle(newValue);
                    });
                });
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgSuratMasuk dialog = new DlgSuratMasuk(new javax.swing.JFrame(), true);
