...
public final class RMRiwayatPerawatan extends javax.swing.JDialog {    
    ...
    private void initComponents() {
        ...
        FormMenu.setPreferredSize(new java.awt.Dimension(255, 1167));
                                    ...
                                    htmlContent.append(
                                         ...
                                         "<tr>"+
                                            "<td valign='top'>"+
                                               ...
                                               "<table width='100%' border='0' align='center' cellpadding='3px' cellspacing='0px' class='tbl_form'>"+
                                                  "<tr>"+
                                                       "<td width='50%' valign='top'>Laboratorium : "+rs2.getString("lab").replaceAll("(\r\n|\r|\n|\n\r)","<br>")+"</td>"+
                                                       "<td width='50%' valign='top'>Radiologi : "+rs2.getString("rad").replaceAll("(\r\n|\r|\n|\n\r)","<br>")+"</td>"+
                                                  "</tr>"+
                                                  "<tr>"+
                                         ...
                                         "<tr>"+
                                            "<td valign='top'>"+
                                               ...
                                               "<table width='100%' border='0' align='center' cellpadding='3px' cellspacing='0px' class='tbl_form'>"+
                                                  ...
                                                  "</tr>"+
                                                  "<tr>"+
                                                       "<td width='50%' valign='top'>Tindakan/Rencana Pengobatan : "+rs2.getString("tindakan").replaceAll("(\r\n|\r|\n|\n\r)","<br>")+"</td>"+
                    ...
                    if(chkAsuhanMedisRanap.isSelected()==true){
                        try {
                            rs2=koneksi.prepareStatement(
                                    ...
                                    "where penilaian_medis_ranap.no_rawat='"+rs.getString("no_rawat")+"'").executeQuery();
                            if(rs2.next()){
                                htmlContent.append(
                                  "<tr class='isi'>"+ 
                                    "<td valign='top' width='2%'></td>"+        
                    ...
                    if(chkAsuhanMedisRanapKandungan.isSelected()==true){
                        try {
                            rs2=koneksi.prepareStatement(
                                    ...
                                    "where penilaian_medis_ranap_kandungan.no_rawat='"+rs.getString("no_rawat")+"'").executeQuery();
                            if(rs2.next()){
                                htmlContent.append(
                                  "<tr class='isi'>"+ 
                                    "<td valign='top' width='2%'></td>"+        
                                    ...
                                    htmlContent.append(
                                         ...
                                         "<tr>"+
                                            "<td valign='top'>"+
                                               ...
                                               "<table width='100%' border='0' align='center' cellpadding='3px' cellspacing='0px' class='tbl_form'>"+
                                                  "<tr>"+
                                                       "<td width='100%'>Ultrasonografi : "+rs2.getString("ultra").replaceAll("(\r\n|\r|\n|\n\r)","<br>")+"</td>"+
                                                  "</tr>"+
                                                  "<tr>"+
                                                       "<td width='100%'>Kardiotokografi : "+rs2.getString("kardio").replaceAll("(\r\n|\r|\n|\n\r)","<br>")+"</td>"+
                                                  "</tr>"+
                                                  "<tr>"+
                                                       "<td width='100%'>Laboratorium : "+rs2.getString("lab").replaceAll("(\r\n|\r|\n|\n\r)","<br>")+"</td>"+
                                                  "</tr>"+
