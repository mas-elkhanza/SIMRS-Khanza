...
public final class RMRiwayatPerawatan extends javax.swing.JDialog {    
    ...
    private void initComponents() {
        ...
        FormMenu.setPreferredSize(new java.awt.Dimension(255, 1107));
        ...
        try{   
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    if(chkAsuhanKeperawatanIGD.isSelected()==true){
                        try {
                            rs2=koneksi.prepareStatement(
                                ...
                                "penilaian_awal_keperawatan_igd.no_rawat='"+rs.getString("no_rawat")+"'").executeQuery();
                            if(rs2.next()){
                                htmlContent.append(
                                  "<tr class='isi'>"+ 
                                    "<td valign='top' width='2%'></td>"+        
                                    ...
                                    htmlContent.append(
                                         ...
                                         "<tr>"+
                                            "<td valign='top'>"+
                                               ...
                                               "<table width='100%' border='0' align='center' cellpadding='3px' cellspacing='0px' class='tbl_form'>"+
                                                  "<tr>"+
                                                      "<td width='100%'>Riwayat Penyakit Sekarang : "+rs2.getString("keluhan_utama")+"</td>"+
                                                  "</tr>"+
                                                  "<tr>"+
                                                      "<td width='100%'>Riwayat Penyakit Dahulu : "+rs2.getString("rpd")+"</td>"+
                                                  "</tr>"+
                                                  "<tr>"+
                                                      "<td width='100%'>Riwayat Penggunaan Obat : "+rs2.getString("rpo")+"</td>"+
                                                  "</tr>"+
                                                  "<tr>"+
                                         ...
                                         "<tr>"+
                                            "<td valign='top'>"+
                                               ...
                                               "<table width='100%' border='0' align='center' cellpadding='3px' cellspacing='0px' class='tbl_form'>"+
                                                  ...
                                                  "<tr>"+
                                                      "<td width='50%'>Riwayat Penyakit Keluarga : "+rs2.getString("rpk")+"</td>"+
                                                      "<td width='50%'>Riwayat Penggunaan Obat : "+rs2.getString("rpo")+"</td>"+
                                                  "</tr>"+
                                               "</table>"+
                                            "</td>"+
                                         "</tr>"+
                    ...
                    //menampilkan asuhan awal medis rawat THT
                    if(chkAsuhanMedisRalanTHT.isSelected()==true){
                        try {
                            rs2=koneksi.prepareStatement(
                                    ...
                                    "where penilaian_medis_ralan_tht.no_rawat='"+rs.getString("no_rawat")+"'").executeQuery();
                            if(rs2.next()){
                                htmlContent.append(
                                  "<tr class='isi'>"+ 
                                    "<td valign='top' width='2%'></td>"+        
                                    ...
                                    htmlContent.append(
                                         ...
                                         "<tr>"+
                                            "<td valign='top'>"+
                                               ...
                                               "<table width='100%' border='0' align='center' cellpadding='3px' cellspacing='0px' class='tbl_form'>"+
                                                  ...
                                                  "</tr>"+
                                                  "<tr>"+
                                                      "<td width='50%'>Riwayat Penyakit Sekarang : "+rs2.getString("rps")+"</td>"+
                                                      "<td width='50%'>Riwayat Penyakit Dahulu : "+rs2.getString("rpd")+"</td>"+
                                                  "</tr>"+
                                                  "<tr>"+
                                                      "<td width='50%'>Riwayat Penggunaan Obat : "+rs2.getString("rpo")+"</td>"+
                                         ...
                                         "<tr>"+
                                            "<td valign='top'>"+
                                               ...
                                               "<table width='100%' border='0' align='center' cellpadding='3px' cellspacing='0px' class='tbl_form'>"+
                                                  "<tr>"+
                                                       "<td width='50%' valign='top'>Laboratorium : "+rs2.getString("lab")+"</td>"+
                                                       "<td width='50%' valign='top'>Radiologi : "+rs2.getString("rad")+"</td>"+
                                                  "</tr>"+
                                                  "<tr>"+
                                                       "<td width='50%' valign='top'>Tes Pendengaran : "+rs2.getString("tes_pendengaran")+"</td>"+
                                                       "<td width='50%' valign='top'>Penunjang Lainnya : "+rs2.getString("penunjang")+"</td>"+
                                                  "</tr>"+
                                               "</table>"+
                                            "</td>"+
                                         "</tr>"+
                                         "<tr>"+
                                            "<td valign='top'>"+
                                               ...
                                               "<table width='100%' border='0' align='center' cellpadding='3px' cellspacing='0px' class='tbl_form'>"+
                                                  "<tr>"+
                                                       "<td width='50%' valign='top'>Asesmen Kerja : "+rs2.getString("diagnosis")+"</td>"+
                                                       "<td width='50%' valign='top'>Asesmen Banding : "+rs2.getString("diagnosisbanding")+"</td>"+
                                                  "</tr>"+
                                               "</table>"+
                                            "</td>"+
                                         "</tr>"+
                                         "<tr>"+
                                            "<td valign='top'>"+
                                               ...
                                               "<table width='100%' border='0' align='center' cellpadding='3px' cellspacing='0px' class='tbl_form'>"+
                                                  "<tr>"+
                                                       "<td width='50%' valign='top'>Permasalahan : "+rs2.getString("permasalahan")+"</td>"+
                                                       "<td width='50%' valign='top'>Terapi/Pengobatan : "+rs2.getString("terapi")+"</td>"+
                                                  "</tr>"+
                                                  "<tr>"+
                                                       "<td width='50%' valign='top'>Tindakan/Rencana Pengobatan : "+rs2.getString("tindakan")+"</td>"+
                                                       "<td width='50%' valign='top'>Tatalaksana Lainnya : "+rs2.getString("tatalaksana")+"</td>"+
                                                  "</tr>"+
                                               "</table>"+
                                            "</td>"+
                                         "</tr>"+
                                         "<tr>"+
                                            "<td valign='top'>"+
                                               ...
                                               "<table width='100%' border='0' align='center' cellpadding='3px' cellspacing='0px' class='tbl_form'>"+
                                                  "<tr>"+
                                                       "<td width='100%' border='0'>"+rs2.getString("edukasi")+"</td>"+
                                                  "</tr>"+
                                               "</table>"+
                                            "</td>"+
                                         "</tr>"); 
                                ...
                                while(rs2.next()){
                                    ...
                                    htmlContent.append(
                                            "<tr>"+
                                                ...
                                                "<td valign='top' width='8%' bgcolor='#FFFAF8' align='center'>Imunisasi Ke</td>"+
                                            "</tr>"+
                                            "<tr>"+
                                                "<td valign='top' align='center'></td>"+
                                                "<td valign='top'></td>"+
                                    ...
                                    if(!rs2.getString("instruksi").equals("")){
                                        htmlContent.append(
                                             "<tr>"+
                                                ...
                                                "<td valign='top' colspan='8'> : "+rs2.getString("instruksi")+"</td>"+
                                             "</tr>");
                                    }
                    ...
                    if(chkCatatanObservasiIGD.isSelected()==true){
                        try {
                            rs2=koneksi.prepareStatement(
                                    ...
                                    "where catatan_observasi_igd.no_rawat='"+rs.getString("no_rawat")+"'").executeQuery();
                            if(rs2.next()){
                                htmlContent.append(
                                  "<tr class='isi'>"+ 
                                    "<td valign='top' width='2%'></td>"+        
                    ...
                    if(chkCatatanObservasiRanap.isSelected()==true){
                        try {
                            rs2=koneksi.prepareStatement(
                                    ...
                                    "where catatan_observasi_ranap.no_rawat='"+rs.getString("no_rawat")+"'").executeQuery();
                            if(rs2.next()){
                                htmlContent.append(
                                  "<tr class='isi'>"+ 
                                    "<td valign='top' width='2%'></td>"+        
                    ...
                    if(chkCatatanObservasiRanapKebidanan.isSelected()==true){
                        try {
                            rs2=koneksi.prepareStatement(
                                    ...
                                    "where catatan_observasi_ranap_kebidanan.no_rawat='"+rs.getString("no_rawat")+"'").executeQuery();
                            if(rs2.next()){
                                htmlContent.append(
                                  "<tr class='isi'>"+ 
                                    "<td valign='top' width='2%'></td>"+        
                    ...
                    if(chkCatatanObservasiRanapPostPartum.isSelected()==true){
                        try {
                            rs2=koneksi.prepareStatement(
                                    ...
                                    "where catatan_observasi_ranap_postpartum.no_rawat='"+rs.getString("no_rawat")+"'").executeQuery();
                            if(rs2.next()){
                                htmlContent.append(
                                  "<tr class='isi'>"+ 
                                    "<td valign='top' width='2%'></td>"+        
