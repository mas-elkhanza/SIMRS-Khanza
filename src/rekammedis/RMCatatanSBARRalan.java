 ...
 * @author perpustakaan
 */
public final class RMCatatanSBARRalan extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public RMCatatanSBARRalan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        if ((!TSituation.getText().trim().equals("")) || (!TBackground.getText().trim().equals("")) || (!TAssesment.getText().trim().equals(""))
            ...
            if (KdPeg.getText().trim().equals("") || TPegawai.getText().trim().equals("")) {
                ...
                if (akses.getkode().equals("Admin Utama")) {
                    Sequel.menyimpan("pemeriksaan_ralan_sbar", "?,?,?,?,?,?,?,?,?", "Data", 9, new String[]{
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMCatatanSBARRalan dialog = new RMCatatanSBARRalan(new javax.swing.JFrame(), true);
    ...
    public void tampilPemeriksaanSbar() {
        ...
        try {
            ps = koneksi.prepareStatement("select pemeriksaan_ralan_sbar.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien,"
                    ...
                    + "pemeriksaan_ralan_sbar.assesment,pemeriksaan_ralan_sbar.recommendation,pemeriksaan_ralan_sbar.advis,pemeriksaan_ralan_sbar.nip,pegawai.nama,pegawai.jbtn, "
                    ...
                    + "left join pemeriksaan_ralan_sbar_validasi vps on concat(pemeriksaan_ralan_sbar.no_rawat, pemeriksaan_ralan_sbar.tgl_perawatan, pemeriksaan_ralan_sbar.jam_rawat) = concat(vps.no_rawat, vps.tgl_perawatan, vps.jam_rawat) "
                    + "where pemeriksaan_ralan_sbar.tgl_perawatan between ? and ? "
                    + (TCari.getText().trim().equals("") ? ""
                    : "and (reg_periksa.no_rkm_medis like ? or pemeriksaan_ralan_sbar.no_rawat like ? or pasien.nm_pasien like ? or "
                    ...
                    + "pemeriksaan_ralan_sbar.recommendation like ? or pemeriksaan_ralan_sbar.advis like ?) ")
