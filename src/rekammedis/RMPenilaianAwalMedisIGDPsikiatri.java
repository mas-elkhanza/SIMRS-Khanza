...
public final class RMPenilaianAwalMedisIGDPsikiatri extends javax.swing.JDialog {
    ...
    public RMPenilaianAwalMedisIGDPsikiatri(java.awt.Frame parent, boolean modal) {
        ...
        KeluhanUtama.setDocument(new batasInput((int)30).getKata(KeluhanUtama));
        GejalaMenyertai.setDocument(new batasInput((int)30).getKata(GejalaMenyertai));
        FaktorPencetus.setDocument(new batasInput((int)30).getKata(FaktorPencetus));
        KeteranganRiwayatPenyakitDahulu.setDocument(new batasInput((int)30).getKata(KeteranganRiwayatPenyakitDahulu));
        RiwayatKehamilan.setDocument(new batasInput((int)30).getKata(RiwayatKehamilan));
        KeteranganRiwayatSosial.setDocument(new batasInput((int)30).getKata(KeteranganRiwayatSosial));
        KeteranganRiwayatPekerjaan.setDocument(new batasInput((int)30).getKata(KeteranganRiwayatPekerjaan));
        RiwayatObatDiminum.setDocument(new batasInput((int)30).getKata(RiwayatObatDiminum));
        FaktorPremorbid.setDocument(new batasInput((int)30).getKata(FaktorPremorbid));
        KeteranganFaktorKeturunan.setDocument(new batasInput((int)30).getKata(KeteranganFaktorKeturunan));
        KeteranganFaktorOrganik.setDocument(new batasInput((int)30).getKata(KeteranganFaktorOrganik));
        RiwayatAlergi.setDocument(new batasInput((int)30).getKata(RiwayatAlergi));
        FisikTD.setDocument(new batasInput((int)30).getKata(FisikTD));
        FisikRR.setDocument(new batasInput((int)30).getKata(FisikRR));
        FisikSuhu.setDocument(new batasInput((int)30).getKata(FisikSuhu));
        FasikNadi.setDocument(new batasInput((int)30).getKata(FasikNadi));
        FisikBB.setDocument(new batasInput((int)30).getKata(FisikBB));
        FisikTB.setDocument(new batasInput((int)30).getKata(FisikTB));
        FisikStatusNutrisi.setDocument(new batasInput((int)30).getKata(FisikStatusNutrisi));
        FisikGCS.setDocument(new batasInput((int)30).getKata(FisikGCS));
        KeteranganStatusKepala.setDocument(new batasInput((int)30).getKata(KeteranganStatusKepala));
        KeteranganStatusLeher.setDocument(new batasInput((int)30).getKata(KeteranganStatusLeher));
        KeteranganStatusDada.setDocument(new batasInput((int)30).getKata(KeteranganStatusDada));
        KeteranganStatusPerut.setDocument(new batasInput((int)30).getKata(KeteranganStatusPerut));
        KeteranganStatusAnggotaGerak.setDocument(new batasInput((int)30).getKata(KeteranganStatusAnggotaGerak));
        StatusLokalisata.setDocument(new batasInput((int)30).getKata(StatusLokalisata));
        PsikiatriKesanUmum.setDocument(new batasInput((int)30).getKata(PsikiatriKesanUmum));
        PsikiatriSikap.setDocument(new batasInput((int)30).getKata(PsikiatriSikap));
        PsikiatriKesadaran.setDocument(new batasInput((int)30).getKata(PsikiatriKesadaran));
        PsikiatriOrientasi.setDocument(new batasInput((int)30).getKata(PsikiatriOrientasi));
        PsikiatriDayaIngat.setDocument(new batasInput((int)30).getKata(PsikiatriDayaIngat));
        PsikiatriPersepsi.setDocument(new batasInput((int)30).getKata(PsikiatriPersepsi));
        PsikiatriPikiran.setDocument(new batasInput((int)30).getKata(PsikiatriPikiran));
        PsikiatriInsight.setDocument(new batasInput((int)30).getKata(PsikiatriInsight));
        Laborat.setDocument(new batasInput((int)30).getKata(Laborat));
        Radiologi.setDocument(new batasInput((int)30).getKata(Radiologi));
        EKG.setDocument(new batasInput((int)30).getKata(EKG));
        Diagnosis.setDocument(new batasInput((int)30).getKata(Diagnosis));
        Permasalahan.setDocument(new batasInput((int)30).getKata(Permasalahan));
        Instruksi.setDocument(new batasInput((int)30).getKata(Instruksi));
        Rencana.setDocument(new batasInput((int)30).getKata(Rencana));
        KeteranganDipulangkan.setDocument(new batasInput((int)30).getKata(KeteranganDipulangkan));
        DirawatDiRuang.setDocument(new batasInput((int)30).getKata(DirawatDiRuang));
        IndikasiRanap.setDocument(new batasInput((int)30).getKata(IndikasiRanap));
        DirujukKe.setDocument(new batasInput((int)30).getKata(DirujukKe));
        KeteranganPulangPaksa.setDocument(new batasInput((int)30).getKata(KeteranganPulangPaksa));
        PenyebabKematian.setDocument(new batasInput((int)30).getKata(PenyebabKematian));
        PulangTD.setDocument(new batasInput((int)30).getKata(PulangTD));
        PulangNadi.setDocument(new batasInput((int)30).getKata(PulangNadi));
        PulangGCS.setDocument(new batasInput((int)30).getKata(PulangGCS));
        PulangSuhu.setDocument(new batasInput((int)30).getKata(PulangSuhu));
        PulangRR.setDocument(new batasInput((int)30).getKata(PulangRR));
        Edukasi.setDocument(new batasInput((int)30).getKata(Edukasi));
    ...
    private void initComponents() {
        ...
        MeninggalIGD.setBounds(159, 1530, 95, 23);
        ...
        jLabel60.setBounds(265, 1530, 120, 23);
        ...
        PenyebabKematian.setBounds(389, 1530, 465, 23);
    ...
    */
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            FisikGCS.setText(tbObat.getValueAt(tbObat.getSelectedRow(),35).toString());
            FisikStatusNutrisi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),36).toString());
            ...
            StatusAnggotaGerak.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),41).toString());
            KeteranganStatusAnggotaGerak.setText(tbObat.getValueAt(tbObat.getSelectedRow(),42).toString());
            StatusDada.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),43).toString());
            KeteranganStatusDada.setText(tbObat.getValueAt(tbObat.getSelectedRow(),44).toString());
            StatusPerut.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),45).toString());
            KeteranganStatusPerut.setText(tbObat.getValueAt(tbObat.getSelectedRow(),46).toString());
            ...
            KeteranganDipulangkan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),63).toString());
            DirawatDiRuang.setText(tbObat.getValueAt(tbObat.getSelectedRow(),64).toString());
            IndikasiRanap.setText(tbObat.getValueAt(tbObat.getSelectedRow(),65).toString());
            DirujukKe.setText(tbObat.getValueAt(tbObat.getSelectedRow(),66).toString());
            ...
            KeteranganPulangPaksa.setText(tbObat.getValueAt(tbObat.getSelectedRow(),69).toString());
            MeninggalIGD.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),70).toString());
            PenyebabKematian.setText(tbObat.getValueAt(tbObat.getSelectedRow(),71).toString());
            PulangKesadaran.setSelectedItem(tbObat.getValueAt(tbObat.getSelectedRow(),72).toString());
            PulangTD.setText(tbObat.getValueAt(tbObat.getSelectedRow(),73).toString());
            PulangNadi.setText(tbObat.getValueAt(tbObat.getSelectedRow(),74).toString());
            PulangRR.setText(tbObat.getValueAt(tbObat.getSelectedRow(),75).toString());
            PulangSuhu.setText(tbObat.getValueAt(tbObat.getSelectedRow(),76).toString());
            PulangGCS.setText(tbObat.getValueAt(tbObat.getSelectedRow(),77).toString());
    ...
    private void ganti() {
        if(Sequel.mengedittf("penilaian_medis_ralan_gawat_darurat_psikiatri","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,anamnesis=?,hubungan=?,keluhan_utama=?,gejala_keluhan=?,pencetus_keluhan=?,rps=?,keterangan_rps=?,riwayat_kehamilan=?,sosial=?,ket_sosial=?,pekerjaan=?,ket_pekerjaan=?,rpo=?,faktor_premorbid=?,keturunan=?,ket_keturunan=?,Faktor_organik=?,ket_organik=?,alergi=?,kesadaran=?,nyeri=?,td=?,nadi=?,suhu=?,rr=?,bb=?,"+
               ...
               tbObat.setValueAt(FisikGCS.getText(),tbObat.getSelectedRow(),35);
               tbObat.setValueAt(FisikStatusNutrisi.getText(),tbObat.getSelectedRow(),36);
               ...
               tbObat.setValueAt(StatusAnggotaGerak.getSelectedItem().toString(),tbObat.getSelectedRow(),41);
               tbObat.setValueAt(KeteranganStatusAnggotaGerak.getText(),tbObat.getSelectedRow(),42);
               tbObat.setValueAt(StatusDada.getSelectedItem().toString(),tbObat.getSelectedRow(),43);
               tbObat.setValueAt(KeteranganStatusDada.getText(),tbObat.getSelectedRow(),44);
               tbObat.setValueAt(StatusPerut.getSelectedItem().toString(),tbObat.getSelectedRow(),45);
               tbObat.setValueAt(KeteranganStatusPerut.getText(),tbObat.getSelectedRow(),46);
               ...
               tbObat.setValueAt(KeteranganDipulangkan.getText(),tbObat.getSelectedRow(),63);
               tbObat.setValueAt(DirawatDiRuang.getText(),tbObat.getSelectedRow(),64);
               tbObat.setValueAt(IndikasiRanap.getText(),tbObat.getSelectedRow(),65);
               tbObat.setValueAt(DirujukKe.getText(),tbObat.getSelectedRow(),66);
               ...
               tbObat.setValueAt(KeteranganPulangPaksa.getText(),tbObat.getSelectedRow(),69);
               tbObat.setValueAt(MeninggalIGD.getSelectedItem().toString(),tbObat.getSelectedRow(),70);
               tbObat.setValueAt(PenyebabKematian.getText(),tbObat.getSelectedRow(),71);
               tbObat.setValueAt(PulangKesadaran.getSelectedItem().toString(),tbObat.getSelectedRow(),72);
               tbObat.setValueAt(PulangTD.getText(),tbObat.getSelectedRow(),73);
               tbObat.setValueAt(PulangNadi.getText(),tbObat.getSelectedRow(),74);
               tbObat.setValueAt(PulangRR.getText(),tbObat.getSelectedRow(),75);
               tbObat.setValueAt(PulangSuhu.getText(),tbObat.getSelectedRow(),76);
               tbObat.setValueAt(PulangGCS.getText(),tbObat.getSelectedRow(),77);
