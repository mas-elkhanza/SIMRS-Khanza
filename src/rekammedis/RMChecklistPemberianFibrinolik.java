 ...
 * @author perpustakaan
 */
public final class RMChecklistPemberianFibrinolik extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMChecklistPemberianFibrinolik(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "20-04-2024 18:07:51" }));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMChecklistPemberianFibrinolik dialog = new RMChecklistPemberianFibrinolik(new javax.swing.JFrame(), true);
