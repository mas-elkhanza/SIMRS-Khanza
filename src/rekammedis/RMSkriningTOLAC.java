 ...
 * @author perpustakaan
 */
public final class RMSkriningTOLAC extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMSkriningTOLAC(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-09-2026" }));
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMSkriningTOLAC dialog = new RMSkriningTOLAC(new javax.swing.JFrame(), true);
