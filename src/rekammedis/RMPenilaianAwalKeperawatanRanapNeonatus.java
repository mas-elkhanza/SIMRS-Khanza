    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            /*if(Sequel.menyimpantf("penilaian_awal_keperawatan_ranap_neonatus","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",236,new String[]{
                    TNoRw.getText(),Valid.SetTgl(TglAsuhan.getSelectedItem()+"")+" "+TglAsuhan.getSelectedItem().toString().substring(11,19),asal_pasien.getText(),cara_masuk.getText(),diperoleh_dari.getText(),hubungan_dengan_pasien.getText(),keluhan_utama.getText(),prenatal_g.getText(),prenatal_p.getText(),prenatal_a.getText(),prenatal_uk.getText(),prenatal_riwayat_penyakit_ibu.getText(),prenatal_riwayat_penyakit_ibu_keterangan.getText(),prenatal_riwayat_pengobatan_ibu_selama_hamil.getText(),prenatal_pernah_dirawat.getText(),prenatal_pernah_dirawat_keterangan.getText(),prenatal_status_gizi_ibu.getText(),intranatal_g.getText(),intranatal_p.getText(),intranatal_a.getText(),intranatal_kondisi_lahir.getText(),intranatal_cara_persalinan.getText(),intranatal_cara_persalinan_keterangan.getText(),intranatal_apgar.getText(),intranatal_letak.getText(),intranatal_tali_pusat.getText(),intranatal_ketuban.getText(),intranatal_bb.getText(),intranatal_pb.getText(),intranatal_lk.getText(),intranatal_ld.getText(),intranatal_lp.getText(),risiko_infeksi_mayor.getText(),risiko_infeksi_mayor_keterangan.getText(),risiko_infeksi_minor.getText(),risiko_infeksi_minor_keterangan.getText(),kebutuhan_biologis_nutrisi.getText(),kebutuhan_biologis_nutrisi_keterangan.getText(),kebutuhan_biologis_nutrisi_frekuensi.getText(),kebutuhan_biologis_nutrisi_kali.getText(),kebutuhan_biologis_bak.getText(),kebutuhan_biologis_bak_keterangan.getText(),kebutuhan_biologis_bab.getText(),kebutuhan_biologis_bab_keterangan.getText(),alergi_obat.getText(),alergi_obat_keterangan.getText(),alergi_obat_reaksi.getText(),alergi_makanan.getText(),alergi_makanan_keterangan.getText(),alergi_makanan_reaksi.getText(),alergi_lainnya.getText(),alergi_lainnya_keterangan.getText(),alergi_lainnya_reaksi.getText(),riwayat_penyakit_keluarga.getText(),riwayat_penyakit_keluarga_keterangan.getText(),riwayat_imunisasi.getText(),riwayat_imunisasi_keterangan.getText(),riwayat_tranfusi_darah.getText(),riwayat_tranfusi_darah_keterangan.getText(),riwayat_tranfusi_darah_reaksi.getText(),riwayat_tranfusi_darah_reaksi_keterangan.getText(),kebiasan_ibu_obat_diminum.getText(),kebiasan_ibu_obat_diminum_keterangan.getText(),kebiasan_ibu_narkoba.getText(),kebiasan_ibu_narkoba_keterangan.getText(),kebiasan_ibu_merokok.getText(),kebiasan_ibu_merokok_keterangan.getText(),kebiasan_ibu_alkohol.getText(),kebiasan_ibu_alkohol_keterangan.getText(),kesadaran.getText(),keadaan_umum.getText(),gcs.getText(),td.getText(),suhu.getText(),hr.getText(),rr.getText(),spo2.getText(),down_score.getText(),bb.getText(),tb.getText(),lk.getText(),ld.getText(),lp.getText(),gd_bayi.getText(),gd_ibu.getText(),gd_ayah.getText(),saraf_pusat_gerak_bayi.getText(),saraf_pusat_kepala.getText(),saraf_pusat_kepala_keterangan.getText(),saraf_pusat_ubunubun.getText(),saraf_pusat_ubunubun_keterangan.getText(),saraf_pusat_wajah.getText(),saraf_pusat_wajah_keterangan.getText(),saraf_pusat_kejang.getText(),saraf_pusat_kejang_keterangan.getText(),saraf_pusat_refleks.getText(),saraf_pusat_refleks_keterangan.getText(),saraf_pusat_tangisbayi.getText(),saraf_pusat_tangisbayi_keterangan.getText(),kardiovaskular_denyutnadi.getText(),kardiovaskular_sirkulasi.getText(),kardiovaskular_sirkulasi_keterangan.getText(),kardiovaskular_pulsasi.getText(),kardiovaskular_pulsasi_keterangan.getText(),respirasi_polanafas.getText(),respirasi_jenispernapasan.getText(),respirasi_jenispernapasan_keterangan.getText(),respirasi_retraksi.getText(),respirasi_airentry.getText(),respirasi_merintih.getText(),respirasi_suara_napas.getText(),gastrointestinal_mulut.getText(),gastrointestinal_mulut_keterangan.getText(),gastrointestinal_lidah.getText(),gastrointestinal_lidah_keterangan.getText(),gastrointestinal_tenggorakan.getText(),gastrointestinal_tenggorakan_keterangan.getText(),gastrointestinal_abdomen.getText(),gastrointestinal_abdomen_keterangan.getText(),gastrointestinal_bab.getText(),gastrointestinal_bab_keterangan.getText(),gastrointestinal_warnabab.getText(),gastrointestinal_warnabab_keterangan.getText(),gastrointestinal_bak.getText(),gastrointestinal_bak_keterangan.getText(),gastrointestinal_bakwarna.getText(),gastrointestinal_bakwarna_keterangan.getText(),neurologi_posisi_mata.getText(),neurologi_kelopak_mata.getText(),neurologi_kelopak_mata_keterangan.getText(),neurologi_besar_pupil.getText(),neurologi_konjugtiva.getText(),neurologi_konjugtiva_keterangan.getText(),neurologi_sklera.getText(),neurologi_sklera_keterangan.getText(),neurologi_pendengaran.getText(),neurologi_pendengaran_keterangan.getText(),neurologi_penciuman.getText(),neurologi_penciuman_keterangan.getText(),integument_warna_kulit.getText(),integument_warna_kulit_keterangan.getText(),integument_vernic_kaseosa.getText(),integument_vernic_kaseosa_keterangan.getText(),integument_turgor.getText(),integument_lanugo.getText(),integument_kulit.getText(),integument_risiko_dekubitas.getText(),reproduksi.getText(),reproduksi_keterangan.getText(),muskuloskeletal_rekoil_telinga.getText(),muskuloskeletal_rekoil_telinga_keterangan.getText(),muskuloskeletal_lengan.getText(),muskuloskeletal_lengan_keterangan.getText(),muskuloskeletal_tungkai.getText(),muskuloskeletal_tungkai_keterangan.getText(),muskuloskeletal_telapak_kaki.getText(),kondisi_psikologis.getText(),gangguan_jiwa.getText(),menerima_kondisi_bayi.getText(),status_menikah.getText(),masalah_pernikahan.getText(),masalah_pernikahan_keterangan.getText(),pekerjaan.getText(),agama.getText(),nilai_kepercayaan.getText(),nilai_kepercayaan_keterangan.getText(),suku.getText(),pendidikan.getText(),pembayaran.getText(),tinggal_bersama.getText(),tinggal_bersama_keterangan.getText(),hubungan_keluarga.getText(),respon_emosi.getText(),bahasa_sehari_hari.getText(),kemampuan_bacatulis.getText(),butuh_penterjemah.getText(),butuh_penterjemah_keterangan.getText(),terdapat_hambatan_belajar.getText(),hambatan_belajar.getText(),hambatan_belajar_keterangan.getText(),hambatan_cara_bicara.getText(),hambatan_bahasa_isyarat.getText(),cara_belajar_disukai.getText(),kesediaan_menerima_informasi.getText(),kesediaan_menerima_informasi_keterangan.getText(),pemahaman_nutrisi.getText(),pemahaman_penyakit.getText(),pemahaman_pengobatan.getText(),pemahaman_perawatan.getText(),masalah_gizi1.getText(),nilai_gizi1.getText(),masalah_gizi2.getText(),nilai_gizi2.getText(),masalah_gizi3.getText(),nilai_gizi3.getText(),totalgizi.getText(),keterangan_gizi.getText(),penilaian_humptydumpty_skala1.getText(),penilaian_humptydumpty_nilai1.getText(),penilaian_humptydumpty_skala2.getText(),penilaian_humptydumpty_nilai2.getText(),penilaian_humptydumpty_skala3.getText(),penilaian_humptydumpty_nilai3.getText(),penilaian_humptydumpty_skala4.getText(),penilaian_humptydumpty_nilai4.getText(),penilaian_humptydumpty_skala5.getText(),penilaian_humptydumpty_nilai5.getText(),penilaian_humptydumpty_skala6.getText(),penilaian_humptydumpty_nilai6.getText(),penilaian_humptydumpty_skala7.getText(),penilaian_humptydumpty_nilai7.getText(),penilaian_humptydumpty_totalnilai.getText(),penilaian_humptydumpty_hasil.getText(),skala_nips1.getText(),skala_nips1_nilai.getText(),skala_nips2.getText(),skala_nips2_nilai.getText(),skala_nips3.getText(),skala_nips3_nilai.getText(),skala_nips4.getText(),skala_nips4_nilai.getText(),skala_nips5.getText(),skala_nips5_nilai.getText(),skala_nips_total.getText(),skala_nips_keterangan.getText(),informasi_perencanaan_pulang.getText(),lama_ratarata.getText(),perencanaan_pulang.getText(),kondisi_klinis_pulang.getText(),perawatan_lanjutan_dirumah.getText(),cara_transportasi_pulang.getText(),transportasi_digunakan.getText(),
