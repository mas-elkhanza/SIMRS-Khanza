...
public final class RMPenilaianAwalMedisRalanBedahMulut extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "27-05-2023 17:10:45" }));
                            ...
                            "<table width='4200px' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
                                "<tr class='isi2'>"+
                                    "<td valign='top' align='center'>"+
                                        ...
                                        "<font size='2' face='Tahoma'>DATA PENILAIAN AWAL MEDIS RALAN BEDAH MULUT<br><br></font>"+        
                                    "</td>"+
                               "</tr>"+
                            "</table>")
                );
