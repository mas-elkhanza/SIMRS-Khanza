...
//        tblDiagnosa.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
//
        for (int j = 0; j < 2; j++) {
...
//        KodeDiagnosaSekunder4.setDocument(new batasInput((int) 10).getKata(KodeDiagnosaSekunder4));
        ...
        carikeluhan.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (carikeluhan.getTable().getSelectedRow() != -1) {
                    ...
                    PemeriksaanPenunjang.append(carikeluhan.getTable().getValueAt(carikeluhan.getTable().getSelectedRow(), 3).toString() + ", ");
    ...
    private void initComponents() {
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "16-07-2020" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "16-07-2020" }));
        ...
        PanelInput.setPreferredSize(new java.awt.Dimension(192, 648));
        ...
        TPasien.setBounds(384, 10, 410, 23);
        ...
        jLabel8.setBounds(10, 160, 240, 23);
        ...
        scrollPane3.setBounds(250, 100, 541, 50);

        jLabel9.setText("Pemeriksaan Fisik :");
        jLabel9.setName("jLabel9"); // NOI18N
        FormInput.add(jLabel9);
        jLabel9.setBounds(10, 220, 240, 23);
        ...
        scrollPane4.setBounds(250, 220, 541, 50);

        jLabel10.setText("Hasil laboratorium yang positif :");
        jLabel10.setName("jLabel10"); // NOI18N
        FormInput.add(jLabel10);
        jLabel10.setBounds(10, 280, 240, 23);
        ...
        scrollPane5.setBounds(250, 280, 541, 50);

        jLabel11.setText("Obat-obatan waktu pulang/nasihat :");
        jLabel11.setName("jLabel11"); // NOI18N
        FormInput.add(jLabel11);
        jLabel11.setBounds(10, 490, 240, 23);
        ...
        scrollPane6.setBounds(250, 490, 541, 50);

        jLabel29.setText("Diagnosa Akhir :");
        jLabel29.setName("jLabel29"); // NOI18N
        FormInput.add(jLabel29);
        jLabel29.setBounds(10, 340, 240, 23);
        ...
        Kondisi.setBounds(690, 40, 100, 23);

        jLabel12.setText("Kondisi Pasien Pulang :");
        jLabel12.setName("jLabel12"); // NOI18N
        FormInput.add(jLabel12);
        jLabel12.setBounds(560, 40, 130, 23);
        ...
        BtnDokter1.setBounds(220, 120, 28, 23);
        ...
        BtnDokter4.setBounds(220, 520, 28, 23);

        jLabel13.setText("Alasan Dirawat :");
        jLabel13.setName("jLabel13"); // NOI18N
        FormInput.add(jLabel13);
        jLabel13.setBounds(10, 100, 240, 23);
        ...
        scrollPane7.setBounds(250, 160, 540, 50);
        ...
        KodeDokter.setBounds(110, 40, 141, 23);
        ...
        scrollPane1.setBounds(250, 340, 540, 140);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TNoRw.getText().equals("") || TNoRM.getText().equals("") || TPasien.getText().equals("")) {
            ...
            if (Sequel.menyimpantf("resume_pasien", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "No.Rawat", 26, new String[]{
                TNoRw.getText(), KeluhanUtama.getText(), KeluhanUtama.getText(), JalannyaPenyakit.getText(), PemeriksaanPenunjang.getText(), HasilLaborat.getText(),
        ...
        if (TNoRw.getText().equals("") || TNoRM.getText().equals("") || TPasien.getText().equals("")) {
            ...
            if (tbObat.getSelectedRow() > -1) {
                if (Sequel.mengedittf("resume_pasien", "no_rawat=?", "no_rawat=?,kd_dokter=?,keluhan_utama=?,jalannya_penyakit=?,pemeriksaan_penunjang=?,hasil_laborat=?,diagnosa_utama=?,kd_diagnosa_utama=?,diagnosa_sekunder=?,kd_diagnosa_sekunder=?,diagnosa_sekunder2=?,kd_diagnosa_sekunder2=?,diagnosa_sekunder3=?,kd_diagnosa_sekunder3=?,diagnosa_sekunder4=?,kd_diagnosa_sekunder4=?,prosedur_utama=?,kd_prosedur_utama=?,prosedur_sekunder=?,kd_prosedur_sekunder=?,prosedur_sekunder2=?,kd_prosedur_sekunder2=?,prosedur_sekunder3=?,kd_prosedur_sekunder3=?,kondisi_pulang=?,obat_pulang=?", 27, new String[]{
                    TNoRw.getText(), KeluhanUtama.getText(), KeluhanUtama.getText(), JalannyaPenyakit.getText(), PemeriksaanPenunjang.getText(), HasilLaborat.getText(),
                    tblDiagnosa.getModel().getValueAt(0, 1).toString(), tblDiagnosa.getModel().getValueAt(0, 0).toString(), tblDiagnosa.getModel().getValueAt(1, 1).toString(), tblDiagnosa.getModel().getValueAt(1, 0).toString(),
                    tblDiagnosa.getModel().getValueAt(2, 1).toString(), tblDiagnosa.getModel().getValueAt(2, 0).toString(), tblDiagnosa.getModel().getValueAt(3, 1).toString(), tblDiagnosa.getModel().getValueAt(3, 0).toString(),
                    tblDiagnosa.getModel().getValueAt(4, 1).toString(), tblDiagnosa.getModel().getValueAt(4, 0).toString(),
                    "", "", "", "", "", "", "", "", Kondisi.getSelectedItem().toString(), Obat2an.getText(),
                    tbObat.getValueAt(tbObat.getSelectedRow(), 2).toString()
                }) == true) {
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            if (TCari.getText().equals("")) {
                Valid.MyReportqry("reportResumeRanap.jasper", "report", "::[ Data Resume Pasien ]::",
                        "select reg_periksa.tgl_registrasi,reg_periksa.no_rawat,reg_periksa.status_lanjut,reg_periksa.no_rkm_medis,pasien.nm_pasien,pasien.tgl_lahir,"
                        + "pasien.alamat,if(pasien.jk='L','Laki-Laki','Perempuan') AS jk,kamar_inap.tgl_masuk,kamar_inap.tgl_keluar,kamar_inap.diagnosa_awal,bangsal.nm_bangsal, "
                        ...
                        + "resume_pasien.obat_pulang,resume_pasien.riwayat_penyakit,pemeriksaan_ranap.keluhan,pemeriksaan_ranap.pemeriksaan "
                        + "from resume_pasien inner join reg_periksa on resume_pasien.no_rawat=reg_periksa.no_rawat  "
                        + "inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join dokter on resume_pasien.kd_dokter=dokter.kd_dokter inner join kamar_inap ON "
                        + "reg_periksa.no_rawat = kamar_inap.no_rawat inner join kamar ON kamar.kd_kamar = kamar_inap.kd_kamar inner join bangsal ON kamar.kd_bangsal = bangsal.kd_bangsal inner join pemeriksaan_ranap on reg_periksa.no_rawat=pemeriksaan_ranap.no_rawat "
    ...
    private void KondisiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KondisiKeyPressed
        Valid.pindah(evt, KeluhanUtama, KeluhanUtama);
    ...
    private void isDiagnosaAhir() {
        ...
        try {
            ps1 = koneksi.prepareStatement("select diagnosa_pasien.kd_penyakit,penyakit.nm_penyakit "
                    + "from diagnosa_pasien inner join penyakit on diagnosa_pasien.kd_penyakit=penyakit.kd_penyakit where no_rawat='" + TNoRw.getText() + "'");
            try {
                ...
                while (rs1.next()) {
                    ...
                    if (x == 1) {
                        tabMode1.addRow(new Object[]{null, null});
                        tabMode1.addRow(new Object[]{null, null});
                        tabMode1.addRow(new Object[]{null, null});
                    }
                    if (x == 2) {
