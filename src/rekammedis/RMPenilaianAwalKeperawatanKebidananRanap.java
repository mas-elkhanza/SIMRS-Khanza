...
public final class RMPenilaianAwalKeperawatanKebidananRanap extends javax.swing.JDialog {
    ...
    public RMPenilaianAwalKeperawatanKebidananRanap(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Lamanya KB","Komplikasi KB","Ket Komplikasi KB","Berhenti KB","Alasan Berhenti KB","Riwayat Genekologi","Obat/Vitamin","Keterangan Obat/Vitamin"
        }){
    ...
    private void initComponents() {
        ...
        TanggalPersalinan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "23-07-2021" }));
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "23-07-2021 18:32:17" }));
        ...
        HPHT.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "23-07-2021" }));
        ...
        TP.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "23-07-2021" }));
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "23-07-2021" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "23-07-2021" }));
            ...
            try{
                ...
                try {
                    ...
                    while(rs.next()){
                        ...
                        //  `masalah,penilaian_awal_keperawatan_kebidanan_ranap.tindakan,penilaian_awal_keperawatan_kebidanan_ranap.nip`
                    }
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                ...
                "pasien.tgl_lahir,pasien.jk,pengkaji1.nama as pengkaji1,pengkaji2.nama as pengkaji2,dokter.nm_dokter,reg_periksa.no_rkm_medis,pasien.nm_pasien "+
                "from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                ...
                "penilaian_awal_keperawatan_kebidanan_ranap.tanggal between ? and ? "+
                 (TCari.getText().trim().equals("")?"":"and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or penilaian_awal_keperawatan_kebidanan_ranap.nip1 like ? or pengkaji1.nama like ?)")+
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("riwayat_kb_alasanberhenti"),rs.getString("riwayat_genekologi"),rs.getString("riwayat_kebiasaan_obat"),rs.getString("riwayat_kebiasaan_ket_obat")
                    });
                }
            } catch (Exception e) {
                System.out.println("Notif : "+e);
