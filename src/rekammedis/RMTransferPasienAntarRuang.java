...
public final class RMTransferPasienAntarRuang extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        setUndecorated(true);
        setPreferredSize(new java.awt.Dimension(462, 673));
        setResizable(false);
        ...
        TanggalMasuk.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "17-12-2022 22:11:33" }));
        ...
        TanggalPindah.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "17-12-2022 22:11:33" }));
    ...
    private void btnAmbilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAmbilActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            if(tbObat.getSelectedRow()>-1){
                ...
                Sequel.queryu("delete from bukti_persetujuan_transfer_pasien_antar_ruang where no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"' and tanggal_masuk='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'");
            }else{
