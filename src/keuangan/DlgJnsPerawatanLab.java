...
public final class DlgJnsPerawatanLab extends javax.swing.JDialog {
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            Sequel.menyimpan("jns_perawatan_lab","?,?,?,?,?,?,?,?,?,?","Kode Periksa",10,new String[]{
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(TKd.getText().trim().equals("")){
            ...
            Sequel.mengedit("jns_perawatan_lab","kd_jenis_prw=?","kd_jenis_prw=?,nm_perawatan=?,bagian_rs=?,tarif_tindakan_petugas=?,total_byr=?,kd_pj=?,tarif_tindakan_dokter=?,tarif_perujuk=?,bhp=?",10,new String[]{
        ...
        if(tabMode.getRowCount()==0){
            ...
            BtnBatal.requestFocus();
                ...
                Valid.MyReport("rptTarifLab.jrxml","report","::[ Data Tarif Laboratorium ]::","select jns_perawatan_lab.kd_jenis_prw,jns_perawatan_lab.nm_perawatan,jns_perawatan_lab.bagian_rs,"+
                    "jns_perawatan_lab.bhp,jns_perawatan_lab.tarif_perujuk,jns_perawatan_lab.tarif_tindakan_dokter,jns_perawatan_lab.tarif_tindakan_petugas,jns_perawatan_lab.total_byr,penjab.png_jawab "+
    ...
    */
    ...
    private void isjml(){
        if((! BagianRs.getText().equals(""))&&(! JMLaborat.getText().equals(""))&&(! JMDokter.getText().equals(""))&&(! JMPerujuk.getText().equals(""))&&(! Bhp.getText().equals(""))){
            TotalBiaya.setText(Valid.SetAngka2(Double.parseDouble(BagianRs.getText().trim())+Double.parseDouble(JMDokter.getText().trim())+Double.parseDouble(JMLaborat.getText().trim())+Double.parseDouble(JMPerujuk.getText().trim())+Double.parseDouble(Bhp.getText().trim())));
        }
    }
