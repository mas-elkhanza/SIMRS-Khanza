...
public class DlgRBTindakanDokter extends javax.swing.JDialog {
        ...
        penjab1.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if (penjab1.getTable().getSelectedRow() != -1) {
                    pilihancarabayar = (penjab1.getTable().getValueAt(penjab1.getTable().getSelectedRow(), 1).toString());
                    kdJb.setText((penjab1.getTable().getValueAt(penjab1.getTable().getSelectedRow(), 1).toString()));
                    nmJb.setText((penjab1.getTable().getValueAt(penjab1.getTable().getSelectedRow(), 2).toString()));
                    //prosesCari();
                }
                prosesCariByJB();
            }
    ...
    private void queryTindakan() {
        try {
            ...
            Logger.getLogger(DlgRBTindakanDokter.class.getName()).log(Level.SEVERE, null, e);
        }
    }
    ...
    private void initComponents() {
        ...
        kdJb = new widget.TextBox();
        nmJb = new widget.TextBox();
        BtnJbBrowse = new widget.Button();
        ...
        nmdokter.setPreferredSize(new java.awt.Dimension(200, 23));
        ...
        kdJb.setName("kdJb"); // NOI18N
        kdJb.setPreferredSize(new java.awt.Dimension(70, 23));
        kdJb.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                kdJbKeyPressed(evt);
            }
        });
        ...
        nmJb.setEditable(false);
        nmJb.setName("nmJb"); // NOI18N
        nmJb.setPreferredSize(new java.awt.Dimension(200, 23));
        panelisi4.add(nmJb);

        BtnJbBrowse.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnJbBrowse.setMnemonic('3');
        BtnJbBrowse.setToolTipText("Alt+3");
        BtnJbBrowse.setName("BtnJbBrowse"); // NOI18N
        BtnJbBrowse.setPreferredSize(new java.awt.Dimension(28, 23));
        BtnJbBrowse.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnJbBrowseActionPerformed(evt);
            }
        });
        BtnJbBrowse.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                BtnJbBrowseKeyPressed(evt);
            }
        });
        panelisi4.add(BtnJbBrowse);
...
*/
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            param.put("Tanggal", Tgl1.getSelectedItem());
...
private void ppTampilkanPasienBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppTampilkanPasienBtnPrintActionPerformed
    ...
    private void kdJbKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_kdJbKeyPressed
        // TODO add your handling code here:
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            Sequel.cariIsi("select png_jawab from penjab where kd_pj=?", nmJb, kdJb.getText());
            pilihancarabayar = kdJb.getText().toUpperCase();
            prosesCariByJB();
            BtnAll.requestFocus();
        }
    }//GEN-LAST:event_kdJbKeyPressed

    private void BtnJbBrowseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnJbBrowseActionPerformed
        // TODO add your handling code here:
        penjab1.isCek();
    ...
    }//GEN-LAST:event_BtnJbBrowseActionPerformed

    private void BtnJbBrowseKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnJbBrowseKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_BtnJbBrowseKeyPressed
    ...
    private widget.Button BtnJbBrowse;
