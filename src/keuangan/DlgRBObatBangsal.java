...
public class DlgRBObatBangsal extends javax.swing.JDialog {
    ...
    private PreparedStatement psbangsal, psdokter, psobat, psobat1;
    private ResultSet rsbangsal, rsdokter, rsobat, rsobat1;
    ...
    private void initComponents() {
        ...
        tabPane1.addTab("Laporan 1", scrollPane1);
...
*/
    ...
    private void cetak1() throws HeadlessException {
    ...
    private void cetak2() throws HeadlessException {
        if (tabMode.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "Maaf, data sudah habis. Tidak ada data yang bisa anda print...!!!!");
            //TCari.requestFocus();
        } else if (tabMode.getRowCount() != 0) {
