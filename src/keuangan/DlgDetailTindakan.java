            ...
            if(KdDokterRanapDokterParamedis.getText().equals("")
                ...
                if(cmbStatus.getSelectedItem().equals("Semua")){
                    ps=koneksi.prepareStatement(
                           ...
                           "kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(rawat_inap_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and concat(kamar.kd_bangsal,bangsal.nm_bangsal) like ? and bangsal.nm_bangsal like ? and and kamar_inap.stts_pulang not like '%Pindah Kamar%'  "+
                    ...
                    ps=koneksi.prepareStatement(
                           ...
                           "reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien where status='Belum Lunas') and kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(rawat_inap_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and concat(kamar.kd_bangsal,bangsal.nm_bangsal) like ? and petugas.nama like ? and kamar_inap.stts_pulang not like '%Pindah Kamar%' or "+
                           "reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien where status='Belum Lunas') and kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(rawat_inap_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and concat(kamar.kd_bangsal,bangsal.nm_bangsal) like ? and penjab.png_jawab like ? and kamar_inap.stts_pulang not like '%Pindah Kamar%' or "+
                           "reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien where status='Belum Lunas') and kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(rawat_inap_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and concat(bangsal.kd_bangsal,bangsal.nm_bangsal) like ? and bangsal.nm_bangsal like ? and and kamar_inap.stts_pulang not like '%Pindah Kamar%' "+
                           " order by rawat_inap_drpr.no_rawat desc");
                }   
            }
