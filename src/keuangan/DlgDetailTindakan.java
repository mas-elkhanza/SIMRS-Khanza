...
public final class DlgDetailTindakan extends javax.swing.JDialog {
    ...
    private DefaultTableModel tabModeRalanDokter, tabModeRalanParamedis,
            ...
            tabModeDetailLaborat, tabModeOperasi, tabModelRincian;
    ...
    public DlgDetailTindakan(java.awt.Frame parent, boolean modal) {
        ...
        tabModeRalanParamedis = new DefaultTableModel(null, new Object[]{
            ...
            "Paramedis Yg Menangani", "Tanggal", "Jam", "Cara Bayar", "Ruangan", "Status",
        ...
        tabModeRalanDokterParamedis = new DefaultTableModel(null, new Object[]{
            ...
            "Status", "Jasa Sarana", "Paket BHP", "JM Dokter", "JM Paramedis", "KSO", "Menejemen", "Total"}) {
            @Override
            public boolean isCellEditable(int rowIndex, int colIndex) {
                return false;
            }
        ...
        tabModeRanapDokterParamedis = new DefaultTableModel(null, new Object[]{
            ...
            "Dokter Yg Menangani", "Paramedis Yg Menangani", "Dokter Pertama", "Tanggal Pulang", "Tanggal Tindakan", "Jam", "Cara Bayar", "Ruangan",
        ...
        //TODO: Update 2021-05-03 Penambahan Perincian Pasien Ranap CD Dokter
        ...
        tbRincianRanap.setModel(tabModelRincian);
        ...
        tbRincianRanap.setDefaultRenderer(Object.class, new WarnaTable());
            ...
            public void windowClosed(WindowEvent e) {
                if (caribangsal.getTable().getSelectedRow() != -1) {
                    ...
                    switch (TabRawat.getSelectedIndex()) {
                        case 6:
                            KdRuanganRanapDokterParamedis.setText(caribangsal.getTable().getValueAt(caribangsal.getTable().getSelectedRow(), 0).toString());
                            KdRuanganrRanapDokterParamedis.setText(caribangsal.getTable().getValueAt(caribangsal.getTable().getSelectedRow(), 1).toString());
                            KdRuanganrRanapDokterParamedis.requestFocus();
                            break;
                        case 10:
                            KdRuanganRanapDokterParamedis1.setText(caribangsal.getTable().getValueAt(caribangsal.getTable().getSelectedRow(), 0).toString());
                            KdRuanganrRanapDokterParamedis1.setText(caribangsal.getTable().getValueAt(caribangsal.getTable().getSelectedRow(), 1).toString());
                            BtnCaraBayarRanapDokterParamedis2.requestFocus();
                            break;
                        default:
                            break;
                    }
                ...
                if (dokter.getTable().getSelectedRow() != -1) {
                    switch (TabRawat.getSelectedIndex()) {
                        ...
                        case 9:
                            ...
                            break;
                        case 10:
                            KdDokterRanapDokterParamedis1.setText(dokter.getTable().getValueAt(dokter.getTable().getSelectedRow(), 0).toString());
                            NmDokterRanapDokterParamedis1.setText(dokter.getTable().getValueAt(dokter.getTable().getSelectedRow(), 1).toString());
                            BtnDokterRanapDokterParamedis1.requestFocus();
                            break;
                        default:
                            break;
                    }
                ...
                if (petugas.getTable().getSelectedRow() != -1) {
                    switch (TabRawat.getSelectedIndex()) {
                        ...
                        case 9:
                            ...
                            break;
                        case 10:
                            KdPetugasRanapDokterParamedis1.setText(petugas.getTable().getValueAt(petugas.getTable().getSelectedRow(), 0).toString());
                            NmPetugasRanapDokterParamedis1.setText(petugas.getTable().getValueAt(petugas.getTable().getSelectedRow(), 1).toString());
                            BtnPetugasDetailLab.requestFocus();
                            break;
                        default:
                            break;
                ...
                if (penjab.getTable().getSelectedRow() != -1) {
                    switch (TabRawat.getSelectedIndex()) {
                        ...
                        case 6:
                            ...
                            BtnRuangrRanapDokterParamedis.requestFocus();
                            break;
                        case 7:
                        ...
                        case 9:
                            ...
                            break;
                        case 10:
                            KdCaraBayarRanapDokterParamedis1.setText(penjab.getTable().getValueAt(penjab.getTable().getSelectedRow(), 1).toString());
                            NmCaraBayarRanapDokterParamedis1.setText(penjab.getTable().getValueAt(penjab.getTable().getSelectedRow(), 2).toString());
                            BtnRuangrRanapDokterParamedis1.requestFocus();
                            break;
                        default:
                            break;
                    }
    ...
    private void initComponents() {
        ...
        BtnRuangrRanapDokterParamedis = new widget.Button();
        ...
        KdRuanganrRanapDokterParamedis = new widget.TextBox();
        BtnCaraBayarRanapDokterParamedis1 = new widget.Button();
        KdRuanganRanapDokterParamedis = new widget.TextBox();
        ...
        tbRincianRanap = new widget.Table();
        PanelInput6 = new javax.swing.JPanel();
        ChkInput6 = new widget.CekBox();
        FormInput6 = new widget.panelisi();
        label36 = new widget.Label();
        KdPetugasRanapDokterParamedis1 = new widget.TextBox();
        NmPetugasRanapDokterParamedis1 = new widget.TextBox();
        BtnPetugasRanapDokterParamedis1 = new widget.Button();
        label37 = new widget.Label();
        KdCaraBayarRanapDokterParamedis1 = new widget.TextBox();
        NmCaraBayarRanapDokterParamedis1 = new widget.TextBox();
        BtnRuangrRanapDokterParamedis1 = new widget.Button();
        label38 = new widget.Label();
        KdDokterRanapDokterParamedis1 = new widget.TextBox();
        NmDokterRanapDokterParamedis1 = new widget.TextBox();
        BtnDokterRanapDokterParamedis1 = new widget.Button();
        label51 = new widget.Label();
        KdRuanganrRanapDokterParamedis1 = new widget.TextBox();
        BtnCaraBayarRanapDokterParamedis2 = new widget.Button();
        KdRuanganRanapDokterParamedis1 = new widget.TextBox();
        ...
        TabRawat.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        ...
        cmbStatusRawat.setPreferredSize(new java.awt.Dimension(115, 23));
        FormInput2.add(cmbStatusRawat);
        cmbStatusRawat.setBounds(1070, 10, 115, 23);
        ...
        FormInput2.add(jLabel13);
        jLabel13.setBounds(970, 10, 90, 23);
        ...
        KdCaraBayarRanapDokterParamedis.setBounds(710, 10, 65, 23);
        ...
        BtnRuangrRanapDokterParamedis.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnRuangrRanapDokterParamedis.setMnemonic('3');
        BtnRuangrRanapDokterParamedis.setToolTipText("Alt+3");
        BtnRuangrRanapDokterParamedis.setName("BtnRuangrRanapDokterParamedis"); // NOI18N
        BtnRuangrRanapDokterParamedis.setPreferredSize(new java.awt.Dimension(28, 23));
        BtnRuangrRanapDokterParamedis.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnRuangrRanapDokterParamedisActionPerformed(evt);
            }
        });
        FormInput5.add(BtnRuangrRanapDokterParamedis);
        BtnRuangrRanapDokterParamedis.setBounds(930, 10, 28, 23);
        ...
        FormInput5.add(label34);
        label34.setBounds(960, 10, 70, 23);

        KdRuanganrRanapDokterParamedis.setEditable(false);
        KdRuanganrRanapDokterParamedis.setName("KdRuanganrRanapDokterParamedis"); // NOI18N
        KdRuanganrRanapDokterParamedis.setPreferredSize(new java.awt.Dimension(50, 23));
        FormInput5.add(KdRuanganrRanapDokterParamedis);
        KdRuanganrRanapDokterParamedis.setBounds(1110, 10, 140, 23);

        BtnCaraBayarRanapDokterParamedis1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnCaraBayarRanapDokterParamedis1.setMnemonic('3');
        BtnCaraBayarRanapDokterParamedis1.setToolTipText("Alt+3");
        BtnCaraBayarRanapDokterParamedis1.setName("BtnCaraBayarRanapDokterParamedis1"); // NOI18N
        BtnCaraBayarRanapDokterParamedis1.setPreferredSize(new java.awt.Dimension(28, 23));
        BtnCaraBayarRanapDokterParamedis1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnCaraBayarRanapDokterParamedis1ActionPerformed(evt);
            }
        });
        FormInput5.add(BtnCaraBayarRanapDokterParamedis1);
        BtnCaraBayarRanapDokterParamedis1.setBounds(1250, 10, 28, 23);

        KdRuanganRanapDokterParamedis.setEditable(false);
        KdRuanganRanapDokterParamedis.setName("KdRuanganRanapDokterParamedis"); // NOI18N
        KdRuanganRanapDokterParamedis.setPreferredSize(new java.awt.Dimension(50, 23));
        FormInput5.add(KdRuanganRanapDokterParamedis);
        KdRuanganRanapDokterParamedis.setBounds(1035, 10, 70, 23);
        ...
        tbRincianRanap.setName("tbRincianRanap"); // NOI18N
        tbRincianRanap.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbRincianRanapMouseClicked(evt);
            }
        });
        tbRincianRanap.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tbRincianRanapKeyPressed(evt);
            }
        });
        Scroll10.setViewportView(tbRincianRanap);

        internalFrame12.add(Scroll10, java.awt.BorderLayout.CENTER);

        PanelInput6.setBackground(new java.awt.Color(255, 255, 255));
        PanelInput6.setName("PanelInput6"); // NOI18N
        PanelInput6.setOpaque(false);
        PanelInput6.setPreferredSize(new java.awt.Dimension(192, 65));
        ...
        ChkInput6.setMnemonic('M');
        ChkInput6.setText(".: Filter Data");
        ...
        label36.setPreferredSize(new java.awt.Dimension(50, 23));
        FormInput6.add(label36);
        label36.setBounds(315, 10, 60, 23);

        KdPetugasRanapDokterParamedis1.setEditable(false);
        KdPetugasRanapDokterParamedis1.setName("KdPetugasRanapDokterParamedis1"); // NOI18N
        KdPetugasRanapDokterParamedis1.setPreferredSize(new java.awt.Dimension(80, 23));
        FormInput6.add(KdPetugasRanapDokterParamedis1);
        KdPetugasRanapDokterParamedis1.setBounds(380, 10, 65, 23);

        NmPetugasRanapDokterParamedis1.setEditable(false);
        NmPetugasRanapDokterParamedis1.setName("NmPetugasRanapDokterParamedis1"); // NOI18N
        NmPetugasRanapDokterParamedis1.setPreferredSize(new java.awt.Dimension(150, 23));
        FormInput6.add(NmPetugasRanapDokterParamedis1);
        NmPetugasRanapDokterParamedis1.setBounds(447, 10, 150, 23);

        BtnPetugasRanapDokterParamedis1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnPetugasRanapDokterParamedis1.setMnemonic('3');
        BtnPetugasRanapDokterParamedis1.setToolTipText("Alt+3");
        BtnPetugasRanapDokterParamedis1.setName("BtnPetugasRanapDokterParamedis1"); // NOI18N
        BtnPetugasRanapDokterParamedis1.setPreferredSize(new java.awt.Dimension(28, 23));
        BtnPetugasRanapDokterParamedis1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnPetugasRanapDokterParamedis1ActionPerformed(evt);
            }
        });
        FormInput6.add(BtnPetugasRanapDokterParamedis1);
        BtnPetugasRanapDokterParamedis1.setBounds(600, 10, 28, 23);

        label37.setText("Cara Bayar :");
        label37.setName("label37"); // NOI18N
        label37.setPreferredSize(new java.awt.Dimension(75, 23));
        FormInput6.add(label37);
        label37.setBounds(640, 10, 70, 23);

        KdCaraBayarRanapDokterParamedis1.setEditable(false);
        KdCaraBayarRanapDokterParamedis1.setName("KdCaraBayarRanapDokterParamedis1"); // NOI18N
        KdCaraBayarRanapDokterParamedis1.setPreferredSize(new java.awt.Dimension(50, 23));
        FormInput6.add(KdCaraBayarRanapDokterParamedis1);
        KdCaraBayarRanapDokterParamedis1.setBounds(710, 10, 65, 23);

        NmCaraBayarRanapDokterParamedis1.setEditable(false);
        NmCaraBayarRanapDokterParamedis1.setName("NmCaraBayarRanapDokterParamedis1"); // NOI18N
        NmCaraBayarRanapDokterParamedis1.setPreferredSize(new java.awt.Dimension(150, 23));
        FormInput6.add(NmCaraBayarRanapDokterParamedis1);
        NmCaraBayarRanapDokterParamedis1.setBounds(780, 10, 150, 23);

        BtnRuangrRanapDokterParamedis1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnRuangrRanapDokterParamedis1.setMnemonic('3');
        BtnRuangrRanapDokterParamedis1.setToolTipText("Alt+3");
        BtnRuangrRanapDokterParamedis1.setName("BtnRuangrRanapDokterParamedis1"); // NOI18N
        BtnRuangrRanapDokterParamedis1.setPreferredSize(new java.awt.Dimension(28, 23));
        BtnRuangrRanapDokterParamedis1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnRuangrRanapDokterParamedis1ActionPerformed(evt);
            }
        });
        FormInput6.add(BtnRuangrRanapDokterParamedis1);
        BtnRuangrRanapDokterParamedis1.setBounds(930, 10, 28, 23);

        label38.setText("Dokter :");
        label38.setName("label38"); // NOI18N
        label38.setPreferredSize(new java.awt.Dimension(50, 23));
        FormInput6.add(label38);
        label38.setBounds(0, 10, 60, 23);

        KdDokterRanapDokterParamedis1.setEditable(false);
        KdDokterRanapDokterParamedis1.setName("KdDokterRanapDokterParamedis1"); // NOI18N
        KdDokterRanapDokterParamedis1.setPreferredSize(new java.awt.Dimension(80, 23));
        FormInput6.add(KdDokterRanapDokterParamedis1);
        KdDokterRanapDokterParamedis1.setBounds(63, 10, 65, 23);

        NmDokterRanapDokterParamedis1.setEditable(false);
        NmDokterRanapDokterParamedis1.setName("NmDokterRanapDokterParamedis1"); // NOI18N
        NmDokterRanapDokterParamedis1.setPreferredSize(new java.awt.Dimension(150, 23));
        FormInput6.add(NmDokterRanapDokterParamedis1);
        NmDokterRanapDokterParamedis1.setBounds(130, 10, 150, 23);

        BtnDokterRanapDokterParamedis1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnDokterRanapDokterParamedis1.setMnemonic('3');
        BtnDokterRanapDokterParamedis1.setToolTipText("Alt+3");
        BtnDokterRanapDokterParamedis1.setName("BtnDokterRanapDokterParamedis1"); // NOI18N
        BtnDokterRanapDokterParamedis1.setPreferredSize(new java.awt.Dimension(28, 23));
        BtnDokterRanapDokterParamedis1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnDokterRanapDokterParamedis1ActionPerformed(evt);
            }
        });
        FormInput6.add(BtnDokterRanapDokterParamedis1);
        BtnDokterRanapDokterParamedis1.setBounds(283, 10, 28, 23);

        label51.setText("Ruangan :");
        label51.setName("label51"); // NOI18N
        label51.setPreferredSize(new java.awt.Dimension(75, 23));
        FormInput6.add(label51);
        label51.setBounds(960, 10, 70, 23);

        KdRuanganrRanapDokterParamedis1.setEditable(false);
        KdRuanganrRanapDokterParamedis1.setName("KdRuanganrRanapDokterParamedis1"); // NOI18N
        KdRuanganrRanapDokterParamedis1.setPreferredSize(new java.awt.Dimension(50, 23));
        FormInput6.add(KdRuanganrRanapDokterParamedis1);
        KdRuanganrRanapDokterParamedis1.setBounds(1110, 10, 140, 23);

        BtnCaraBayarRanapDokterParamedis2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/190.png"))); // NOI18N
        BtnCaraBayarRanapDokterParamedis2.setMnemonic('3');
        BtnCaraBayarRanapDokterParamedis2.setToolTipText("Alt+3");
        BtnCaraBayarRanapDokterParamedis2.setName("BtnCaraBayarRanapDokterParamedis2"); // NOI18N
        BtnCaraBayarRanapDokterParamedis2.setPreferredSize(new java.awt.Dimension(28, 23));
        BtnCaraBayarRanapDokterParamedis2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnCaraBayarRanapDokterParamedis2ActionPerformed(evt);
            }
        });
        FormInput6.add(BtnCaraBayarRanapDokterParamedis2);
        BtnCaraBayarRanapDokterParamedis2.setBounds(1250, 10, 28, 23);

        KdRuanganRanapDokterParamedis1.setEditable(false);
        KdRuanganRanapDokterParamedis1.setName("KdRuanganRanapDokterParamedis1"); // NOI18N
        KdRuanganRanapDokterParamedis1.setPreferredSize(new java.awt.Dimension(50, 23));
        FormInput6.add(KdRuanganRanapDokterParamedis1);
        KdRuanganRanapDokterParamedis1.setBounds(1035, 10, 70, 23);

        PanelInput6.add(FormInput6, java.awt.BorderLayout.CENTER);

        internalFrame12.add(PanelInput6, java.awt.BorderLayout.PAGE_START);

        TabRawat.addTab("Perincian Pasien Ranap", internalFrame12);
        ...
        switch (TabRawat.getSelectedIndex()) {
                ...
                if (tabModeRalanDokter.getRowCount() == 0) {
                    ...
                    if (KdDokterRalanDokter.getText().equals("") && NmDokterRalanDokter.getText().equals("") && KdPoliRalanDokter.getText().equals("") && NmPoliRalanDokter.getText().equals("") && KdCaraBayarRalanDokter.getText().equals("") && NmCaraBayarRalanDokter.getText().equals("") && TCari.getText().equals("") && cmbStatus.getSelectedItem().equals("Semua")) {
                        Valid.MyReportqry("rptDetailTindakanRalanDokter.jasper", "report", "::[ Detail Tindakan Ralan Yang Ditangani Dokter ]::",
                                ...
                                + "where rawat_jl_dr.tgl_perawatan between '" + Valid.SetTgl(Tgl1.getSelectedItem() + "") + "' and '" + Valid.SetTgl(Tgl2.getSelectedItem() + "") + "' order by dokter.nm_dokter asc, rawat_jl_dr.no_rawat desc", param);
                    } else {
                        if (cmbStatus.getSelectedItem().equals("Semua")) {
                            Valid.MyReportqry("rptDetailTindakanRalanDokter.jasper", "report", "::[ Detail Tindakan Ralan Yang Ditangani Dokter ]::",
                                    ...
                                    + " order by dokter.nm_dokter asc, rawat_jl_dr.no_rawat desc", param);
            ...
            case 2:
                if (tabModeRalanDokterParamedis.getRowCount() == 0) {
                    ...
                    if (cmbStatusRawat.getSelectedItem().equals("Ralan")) {
                        whereStatusRawat = " and reg_periksa.status_lanjut = " + "'Ralan' ";
                    } else if (cmbStatusRawat.getSelectedItem().equals("Ranap")) {
                        whereStatusRawat = " and reg_periksa.status_lanjut = " + "'Ranap' ";
                    }
                    ...
                    if (KdDokterRalanDokterParamedis.getText().equals("") && NmDokterRalanDokterParamedis.getText().equals("") && KdPetugasRalanDokterParamedis.getText().equals("") && NmPetugasRalanDokterParamedis.getText().equals("") && KdPoliRalanDokterParamedis.getText().equals("") && NmPoliRalanDokterParamedis.getText().equals("") && KdCaraBayarRalanDokterParamedis.getText().equals("") && NmCaraBayarRalanDokterParamedis.getText().equals("") && TCari.getText().equals("") && cmbStatus.getSelectedItem().equals("Semua")) {
                        Valid.MyReportqry("rptDetailTindakanRalanDokterParamedis.jasper", "report", "::[ Detail Tindakan Ralan Yang Ditangani Dokter & Petugas ]::",
                                ...
                                + "where rawat_jl_drpr.tgl_perawatan between '" + Valid.SetTgl(Tgl1.getSelectedItem() + "") + "' and '" + Valid.SetTgl(Tgl2.getSelectedItem() + "") + "' " + whereStatusRawat + " order by dokter.nm_dokter asc, rawat_jl_drpr.no_rawat desc", param);
                    } else {
                        if (cmbStatus.getSelectedItem().equals("Semua")) {
                            Valid.MyReportqry("rptDetailTindakanRalanDokterParamedis.jasper", "report", "::[ Detail Tindakan Ralan Yang Ditangani Dokter & Petugas ]::",
                                    "select rawat_jl_drpr.no_rawat,reg_periksa.no_rkm_medis,"
                                    ...
                                    + "rawat_jl_drpr.tgl_perawatan between '" + Valid.SetTgl(Tgl1.getSelectedItem() + "") + "' and '" + Valid.SetTgl(Tgl2.getSelectedItem() + "") + "' and concat(rawat_jl_drpr.kd_dokter,dokter.nm_dokter) like '%" + KdDokterRalanDokterParamedis.getText() + NmDokterRalanDokterParamedis.getText() + "%' and concat(reg_periksa.kd_poli,poliklinik.nm_poli) like '%" + KdPoliRalanDokterParamedis.getText() + NmPoliRalanDokterParamedis.getText() + "%' and concat(rawat_jl_drpr.nip,petugas.nama) like '%" + KdPetugasRalanDokterParamedis.getText() + NmPetugasRalanDokterParamedis.getText() + "%' and concat(reg_periksa.kd_pj,penjab.png_jawab) like '%" + KdCaraBayarRalanDokterParamedis.getText() + NmCaraBayarRalanDokterParamedis.getText() + "%' and poliklinik.nm_poli like '%" + TCari.getText().trim() + "%' " + whereStatusRawat
                                    + " order by dokter.nm_dokter asc, rawat_jl_drpr.no_rawat desc", param);
                        } else if (cmbStatus.getSelectedItem().equals("Belum Lunas")) {
                            Valid.MyReportqry("rptDetailTindakanRalanDokterParamedis.jasper", "report", "::[ Detail Tindakan Ralan Yang Ditangani Dokter & Petugas ]::",
                                    "select rawat_jl_drpr.no_rawat,reg_periksa.no_rkm_medis,"
                                    + "pasien.nm_pasien,rawat_jl_drpr.kd_jenis_prw,jns_perawatan.nm_perawatan,"
                ...
                if (tabModeOperasi.getRowCount() == 0) {
                    ...
                    if (KdOperatorOperasi.getText().equals("") && NmOperatorOperasi.getText().equals("") && KdAsistenOperasi.getText().equals("") && NmAsistenOperasi.getText().equals("") && KdCaraBayarOperasi.getText().equals("") && NmCaraBayarOperasi.getText().equals("") && TCari.getText().equals("") && cmbStatus.getSelectedItem().equals("Semua")) {
                        Valid.MyReportqry("rptDetailTindakanOperasi.jasper", "report", "::[ Detail Tindakan Operasi ]::",
                                ...
                                + "where operasi.tgl_operasi between '" + Valid.SetTgl(Tgl1.getSelectedItem() + "") + " 00:00:00' and '" + Valid.SetTgl(Tgl2.getSelectedItem() + "") + " 23:59:59' order by dokter.nm_dokter asc, operasi.no_rawat desc", param);
                    } else {
                        if (cmbStatus.getSelectedItem().equals("Semua")) {
                            Valid.MyReportqry("rptDetailTindakanOperasi.jasper", "report", "::[ Detail Tindakan Operasi ]::",
                                    "select operasi.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien, "
                                    ...
                                    + "order by dokter.nm_dokter asc, operasi.no_rawat desc", param);
                        } else if (cmbStatus.getSelectedItem().equals("Belum Lunas")) {
                            Valid.MyReportqry("rptDetailTindakanOperasi.jasper", "report", "::[ Detail Tindakan Operasi ]::",
                                    "select operasi.no_rawat,reg_periksa.no_rkm_medis,pasien.nm_pasien, "
                                    + "operasi.kode_paket,paket_operasi.nm_perawatan,operasi.tgl_operasi, "
                ...
                if (tabModeRanapDokterParamedis.getRowCount() == 0) {
                    ...
                    if (KdDokterRanapDokterParamedis.getText().equals("") && NmDokterRanapDokterParamedis.getText().equals("") && KdPetugasRanapDokterParamedis.getText().equals("") && NmPetugasRanapDokterParamedis.getText().equals("") && KdCaraBayarRanapDokterParamedis.getText().equals("") && NmCaraBayarRanapDokterParamedis.getText().equals("") && TCari.getText().equals("") && cmbStatus.getSelectedItem().equals("Semua")) {
                        Valid.MyReportqry("rptDetailTindakanRanapDokterParamedis.jasper", "report", "::[ Detail Tindakan Ranap Yang Ditangani Dokter & Paramedis ]::",
                                ...
                                + "rawat_inap_drpr.jam_rawat, penjab.png_jawab, rawat_inap_drpr.kd_kamar, kamar.kelas, "
                                + "rawat_inap_drpr.material, rawat_inap_drpr.bhp, rawat_inap_drpr.tarif_tindakandr, rawat_inap_drpr.tarif_tindakanpr, "
                                + "rawat_inap_drpr.kso, rawat_inap_drpr.menejemen, rawat_inap_drpr.biaya_rawat, dokter_pertama.nm_dokter as dokter_pertama,  kamar_inap.tgl_keluar,"
                                + "kamar.kd_kamar,kamar.kd_bangsal,bangsal.nm_bangsal "
                                + "from pasien inner join reg_periksa on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                                ...
                                + "where kamar_inap.tgl_keluar between '" + Valid.SetTgl(Tgl1.getSelectedItem() + "") + "' and '" + Valid.SetTgl(Tgl2.getSelectedItem() + "") + "' and kamar_inap.stts_pulang not like '%Pindah Kamar%' ", param);
                    } else {
                        if (cmbStatus.getSelectedItem().equals("Semua")) {
                            Valid.MyReportqry("rptDetailTindakanRanapDokterParamedis.jasper", "report", "::[ Detail Tindakan Ranap Yang Ditangani Dokter & Paramedis ]::",
                                    "select rawat_inap_drpr.no_rawat,reg_periksa.no_rkm_medis, "
    ...
    private void BtnAllActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAllActionPerformed
        ...
        switch (TabRawat.getSelectedIndex()) {
            ...
            case 6:
                ...
                KdRuanganRanapDokterParamedis.setText("");
                KdRuanganrRanapDokterParamedis.setText("");
                break;
            case 7:
            ...
            case 9:
                ...
                break;
            case 10:
                KdDokterRanapDokterParamedis1.setText("");
                NmDokterRanapDokterParamedis1.setText("");
                KdPetugasRanapDokterParamedis1.setText("");
                NmPetugasRanapDokterParamedis1.setText("");
                KdCaraBayarRanapDokterParamedis1.setText("");
                NmCaraBayarRanapDokterParamedis1.setText("");
                KdRuanganRanapDokterParamedis1.setText("");
                KdRuanganrRanapDokterParamedis1.setText("");
                break;
            default:
                break;
        }
    ...
    private void BtnRuangrRanapDokterParamedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnRuangrRanapDokterParamedisActionPerformed
        BtnCaraBayarRalanDokterActionPerformed(null);
    }//GEN-LAST:event_BtnRuangrRanapDokterParamedisActionPerformed
    ...
    private void BtnCaraBayarRanapDokterParamedis1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCaraBayarRanapDokterParamedis1ActionPerformed
        // TODO add your handling code here:
        caribangsal.isCek();
    ...
    }//GEN-LAST:event_BtnCaraBayarRanapDokterParamedis1ActionPerformed

    private void tbRincianRanapMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbRincianRanapMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_tbRincianRanapMouseClicked

    private void tbRincianRanapKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbRincianRanapKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_tbRincianRanapKeyPressed
    ...
    private void BtnPetugasRanapDokterParamedis1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPetugasRanapDokterParamedis1ActionPerformed
        // TODO add your handling code here:
        BtnPetugasRalanParamedisActionPerformed(null);
    }//GEN-LAST:event_BtnPetugasRanapDokterParamedis1ActionPerformed

    private void BtnRuangrRanapDokterParamedis1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnRuangrRanapDokterParamedis1ActionPerformed
        // TODO add your handling code here:
        BtnCaraBayarRalanDokterActionPerformed(null);
    }//GEN-LAST:event_BtnRuangrRanapDokterParamedis1ActionPerformed

    private void BtnDokterRanapDokterParamedis1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnDokterRanapDokterParamedis1ActionPerformed
        // TODO add your handling code here:
        BtnDokterRalanDokterActionPerformed(null);
    }//GEN-LAST:event_BtnDokterRanapDokterParamedis1ActionPerformed

    private void BtnCaraBayarRanapDokterParamedis2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnCaraBayarRanapDokterParamedis2ActionPerformed
        // TODO add your handling code here:
        caribangsal.isCek();
        caribangsal.emptTeks();
        caribangsal.setSize(internalFrame1.getWidth() - 20, internalFrame1.getHeight() - 20);
        ...
        caribangsal.setAlwaysOnTop(false);
        caribangsal.setVisible(true);
    }//GEN-LAST:event_BtnCaraBayarRanapDokterParamedis2ActionPerformed
    ...
    private widget.Button BtnCaraBayarRanapDokterParamedis1;
    private widget.Button BtnCaraBayarRanapDokterParamedis2;
    ...
    private widget.Button BtnDokterRanapDokterParamedis1;
    ...
    private widget.Button BtnPetugasRanapDokterParamedis1;
    ...
    private widget.Button BtnRuangrRanapDokterParamedis;
    private widget.Button BtnRuangrRanapDokterParamedis1;
    ...
    private widget.panelisi FormInput6;
    ...
    private widget.TextBox KdCaraBayarRanapDokterParamedis1;
    ...
    private widget.TextBox KdDokterRanapDokterParamedis1;
    ...
    private widget.TextBox KdPetugasRanapDokterParamedis1;
    ...
    private widget.TextBox KdRuanganRanapDokterParamedis;
    private widget.TextBox KdRuanganRanapDokterParamedis1;
    private widget.TextBox KdRuanganrRanapDokterParamedis;
    private widget.TextBox KdRuanganrRanapDokterParamedis1;
    ...
    private widget.TextBox NmCaraBayarRanapDokterParamedis1;
    ...
    private widget.TextBox NmDokterRanapDokterParamedis1;
    ...
    private widget.TextBox NmPetugasRanapDokterParamedis1;
    ...
    private widget.Table tbRincianRanap;
    ...
    public void tampil3() {
        ...
        try {
            if (KdDokterRalanDokterParamedis.getText().equals("") && NmDokterRalanDokterParamedis.getText().equals("")
                    && KdPetugasRalanDokterParamedis.getText().equals("") && NmPetugasRalanDokterParamedis.getText().equals("")
                    && KdPoliRalanDokterParamedis.getText().equals("") && NmPoliRalanDokterParamedis.getText().equals("")
                    && KdCaraBayarRalanDokterParamedis.getText().equals("") && NmCaraBayarRalanDokterParamedis.getText().equals("")
                ...
                ps = koneksi.prepareStatement(
                        ...
                        + "rawat_jl_drpr.jam_rawat, penjab.png_jawab, poliklinik.nm_poli, "
                        + "rawat_jl_drpr.material, rawat_jl_drpr.bhp, rawat_jl_drpr.tarif_tindakandr, rawat_jl_drpr.tarif_tindakanpr, "
                        + "rawat_jl_drpr.kso, rawat_jl_drpr.menejemen, rawat_jl_drpr.biaya_rawat, reg_periksa.status_lanjut "
                        + "from pasien inner join reg_periksa on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                        + "inner join rawat_jl_drpr on rawat_jl_drpr.no_rawat=reg_periksa.no_rawat "
                        + "inner join jns_perawatan on rawat_jl_drpr.kd_jenis_prw=jns_perawatan.kd_jenis_prw "
                        + "inner join dokter on rawat_jl_drpr.kd_dokter=dokter.kd_dokter "
                        ...
                        + "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "
                        + "inner join petugas on rawat_jl_drpr.nip=petugas.nip "
                        + "where rawat_jl_drpr.tgl_perawatan between ? and ? " + whereStatusRawat + " order by dokter.nm_dokter asc, rawat_jl_drpr.no_rawat desc");
            } else {
                if (cmbStatus.getSelectedItem().equals("Semua")) {
                    ps = koneksi.prepareStatement(
                            "select rawat_jl_drpr.no_rawat,reg_periksa.no_rkm_medis,"
                            ...
                            + "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "
                            + "inner join petugas on rawat_jl_drpr.nip=petugas.nip "
                            + "where rawat_jl_drpr.tgl_perawatan between ? and ? and concat(rawat_jl_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(reg_periksa.kd_poli,poliklinik.nm_poli) like ? and concat(rawat_jl_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and rawat_jl_drpr.no_rawat like ? " + whereStatusRawat + " or "
                            + "rawat_jl_drpr.tgl_perawatan between ? and ? and concat(rawat_jl_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(reg_periksa.kd_poli,poliklinik.nm_poli) like ? and concat(rawat_jl_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and reg_periksa.no_rkm_medis like ? " + whereStatusRawat + " or "
                            + "rawat_jl_drpr.tgl_perawatan between ? and ? and concat(rawat_jl_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(reg_periksa.kd_poli,poliklinik.nm_poli) like ? and concat(rawat_jl_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and pasien.nm_pasien like ? " + whereStatusRawat + " or "
                            + "rawat_jl_drpr.tgl_perawatan between ? and ? and concat(rawat_jl_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(reg_periksa.kd_poli,poliklinik.nm_poli) like ? and concat(rawat_jl_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and jns_perawatan.nm_perawatan like ? " + whereStatusRawat + " or "
                            + "rawat_jl_drpr.tgl_perawatan between ? and ? and concat(rawat_jl_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(reg_periksa.kd_poli,poliklinik.nm_poli) like ? and concat(rawat_jl_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and rawat_jl_drpr.kd_dokter like ? " + whereStatusRawat + " or "
                            + "rawat_jl_drpr.tgl_perawatan between ? and ? and concat(rawat_jl_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(reg_periksa.kd_poli,poliklinik.nm_poli) like ? and concat(rawat_jl_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and dokter.nm_dokter like ? " + whereStatusRawat + " or "
                            + "rawat_jl_drpr.tgl_perawatan between ? and ? and concat(rawat_jl_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(reg_periksa.kd_poli,poliklinik.nm_poli) like ? and concat(rawat_jl_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and rawat_jl_drpr.nip like ? " + whereStatusRawat + " or "
                            + "rawat_jl_drpr.tgl_perawatan between ? and ? and concat(rawat_jl_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(reg_periksa.kd_poli,poliklinik.nm_poli) like ? and concat(rawat_jl_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and petugas.nama like ? " + whereStatusRawat + " or "
                            + "rawat_jl_drpr.tgl_perawatan between ? and ? and concat(rawat_jl_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(reg_periksa.kd_poli,poliklinik.nm_poli) like ? and concat(rawat_jl_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and penjab.png_jawab like ? " + whereStatusRawat + " or "
                            + "rawat_jl_drpr.tgl_perawatan between ? and ? and concat(rawat_jl_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(reg_periksa.kd_poli,poliklinik.nm_poli) like ? and concat(rawat_jl_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and poliklinik.nm_poli like ? " + whereStatusRawat
                            + " order by dokter.nm_dokter asc, rawat_jl_drpr.no_rawat desc");
                } else if (cmbStatus.getSelectedItem().equals("Belum Lunas")) {
                    ps = koneksi.prepareStatement(
                            "select rawat_jl_drpr.no_rawat,reg_periksa.no_rkm_medis,"
                            + "pasien.nm_pasien,rawat_jl_drpr.kd_jenis_prw,jns_perawatan.nm_perawatan,"
                            ...
                            + "where reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Belum Lunas' and rawat_jl_drpr.tgl_perawatan between ? and ? and concat(rawat_jl_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(reg_periksa.kd_poli,poliklinik.nm_poli) like ? and concat(rawat_jl_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and rawat_jl_drpr.no_rawat like ? " + whereStatusRawat + " or "
                            + "reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Belum Lunas' and rawat_jl_drpr.tgl_perawatan between ? and ? and concat(rawat_jl_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(reg_periksa.kd_poli,poliklinik.nm_poli) like ? and concat(rawat_jl_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and reg_periksa.no_rkm_medis like ? " + whereStatusRawat + " or "
                            + "reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Belum Lunas' and rawat_jl_drpr.tgl_perawatan between ? and ? and concat(rawat_jl_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(reg_periksa.kd_poli,poliklinik.nm_poli) like ? and concat(rawat_jl_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and pasien.nm_pasien like ? " + whereStatusRawat + " or "
                            + "reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Belum Lunas' and rawat_jl_drpr.tgl_perawatan between ? and ? and concat(rawat_jl_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(reg_periksa.kd_poli,poliklinik.nm_poli) like ? and concat(rawat_jl_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and jns_perawatan.nm_perawatan like ? " + whereStatusRawat + " or "
                            + "reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Belum Lunas' and rawat_jl_drpr.tgl_perawatan between ? and ? and concat(rawat_jl_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(reg_periksa.kd_poli,poliklinik.nm_poli) like ? and concat(rawat_jl_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and rawat_jl_drpr.kd_dokter like ? " + whereStatusRawat + " or "
                            + "reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Belum Lunas' and rawat_jl_drpr.tgl_perawatan between ? and ? and concat(rawat_jl_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(reg_periksa.kd_poli,poliklinik.nm_poli) like ? and concat(rawat_jl_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and dokter.nm_dokter like ? " + whereStatusRawat + " or "
                            + "reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Belum Lunas' and rawat_jl_drpr.tgl_perawatan between ? and ? and concat(rawat_jl_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(reg_periksa.kd_poli,poliklinik.nm_poli) like ? and concat(rawat_jl_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and rawat_jl_drpr.nip like ? " + whereStatusRawat + " or "
                            + "reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Belum Lunas' and rawat_jl_drpr.tgl_perawatan between ? and ? and concat(rawat_jl_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(reg_periksa.kd_poli,poliklinik.nm_poli) like ? and concat(rawat_jl_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and petugas.nama like ? " + whereStatusRawat + " or "
                            + "reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Belum Lunas' and rawat_jl_drpr.tgl_perawatan between ? and ? and concat(rawat_jl_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(reg_periksa.kd_poli,poliklinik.nm_poli) like ? and concat(rawat_jl_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and penjab.png_jawab like ? " + whereStatusRawat + " or "
                            + "reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Belum Lunas' and rawat_jl_drpr.tgl_perawatan between ? and ? and concat(rawat_jl_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(reg_periksa.kd_poli,poliklinik.nm_poli) like ? and concat(rawat_jl_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and poliklinik.nm_poli like ? " + whereStatusRawat
                            + " order by dokter.nm_dokter asc, rawat_jl_drpr.no_rawat desc");
                } else if (cmbStatus.getSelectedItem().equals("Sudah Lunas")) {
                    ps = koneksi.prepareStatement(
                            "select rawat_jl_drpr.no_rawat,reg_periksa.no_rkm_medis,"
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    tabModeRalanDokterParamedis.addRow(new Object[]{
                        ...
                        rs.getString(13), rs.getString(21), rs.getDouble(14), rs.getDouble(15), rs.getDouble(16),
    ...
    public void tampil7() {
        ...
        try {
            if (KdDokterRanapDokterParamedis.getText().equals("")
                    && NmDokterRanapDokterParamedis.getText().equals("")
                    && KdPetugasRanapDokterParamedis.getText().equals("")
                    && NmPetugasRanapDokterParamedis.getText().equals("")
                    && KdCaraBayarRanapDokterParamedis.getText().equals("")
                    && NmCaraBayarRanapDokterParamedis.getText().equals("")
                    && KdRuanganRanapDokterParamedis.getText().equals("")
                    && KdRuanganrRanapDokterParamedis.getText().equals("")
                ...
                ps = koneksi.prepareStatement(
                        ...
                        + "left join kamar on rawat_inap_drpr.kd_kamar = kamar.kd_kamar "
                        + "left join bangsal on bangsal.kd_bangsal = kamar.kd_bangsal "
                        + "where kamar_inap.tgl_keluar between ? and ? and kamar_inap.stts_pulang not like '%Pindah Kamar%' ");
            } else {
                if (cmbStatus.getSelectedItem().equals("Semua")) {
                    ps = koneksi.prepareStatement(
                            "select rawat_inap_drpr.no_rawat,reg_periksa.no_rkm_medis, "
                            ...
                            + "rawat_inap_drpr.material,rawat_inap_drpr.bhp,rawat_inap_drpr.tarif_tindakandr,rawat_inap_drpr.tarif_tindakanpr,"
                            + "rawat_inap_drpr.kso,rawat_inap_drpr.menejemen,rawat_inap_drpr.biaya_rawat, dokter_pertama.nm_dokter as dokter_pertama, kamar_inap.tgl_keluar, "
                            + "kamar.kd_kamar,kamar.kd_bangsal,bangsal.kd_bangsal, bangsal.nm_bangsal "
                            + "from pasien inner join reg_periksa on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                            + "inner join kamar_inap on kamar_inap.no_rawat=reg_periksa.no_rawat "
                            + "inner join rawat_inap_drpr on rawat_inap_drpr.no_rawat=reg_periksa.no_rawat "
                            + "inner join jns_perawatan_inap on rawat_inap_drpr.kd_jenis_prw=jns_perawatan_inap.kd_jenis_prw "
                            ...
                            + "left join kamar on rawat_inap_drpr.kd_kamar = kamar.kd_kamar "
                            + "left join bangsal on bangsal.kd_bangsal = kamar.kd_bangsal "
                            + "where kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(rawat_inap_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and concat(kamar.kd_bangsal,bangsal.nm_bangsal) like ? and rawat_inap_drpr.no_rawat like ? and kamar_inap.stts_pulang not like '%Pindah Kamar%' or "
                            + "kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(rawat_inap_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and concat(kamar.kd_bangsal,bangsal.nm_bangsal) like ? and reg_periksa.no_rkm_medis like ? and kamar_inap.stts_pulang not like '%Pindah Kamar%' or "
                            + "kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(rawat_inap_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and concat(kamar.kd_bangsal,bangsal.nm_bangsal) like ? and pasien.nm_pasien like ? and kamar_inap.stts_pulang not like '%Pindah Kamar%' or "
                            + "kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(rawat_inap_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and concat(kamar.kd_bangsal,bangsal.nm_bangsal) like ? and jns_perawatan_inap.nm_perawatan like ? and kamar_inap.stts_pulang not like '%Pindah Kamar%' or "
                            + "kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(rawat_inap_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and concat(kamar.kd_bangsal,bangsal.nm_bangsal) like ? and rawat_inap_drpr.kd_dokter like ? and kamar_inap.stts_pulang not like '%Pindah Kamar%' or "
                            + "kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(rawat_inap_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and concat(kamar.kd_bangsal,bangsal.nm_bangsal) like ? and dokter.nm_dokter like ? and kamar_inap.stts_pulang not like '%Pindah Kamar%' or "
                            + "kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(rawat_inap_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and concat(kamar.kd_bangsal,bangsal.nm_bangsal) like ? and rawat_inap_drpr.nip like ? and kamar_inap.stts_pulang not like '%Pindah Kamar%' or "
                            + "kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(rawat_inap_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and concat(kamar.kd_bangsal,bangsal.nm_bangsal) like ? and petugas.nama like ? and kamar_inap.stts_pulang not like '%Pindah Kamar%' or "
                            + "kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(rawat_inap_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and concat(kamar.kd_bangsal,bangsal.nm_bangsal) like ? and penjab.png_jawab like ? and kamar_inap.stts_pulang not like '%Pindah Kamar%' or "
                            + "kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(rawat_inap_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and concat(kamar.kd_bangsal,bangsal.nm_bangsal) like ? and bangsal.nm_bangsal like ? and kamar_inap.stts_pulang not like '%Pindah Kamar%'  "
                    ...
                    ps = koneksi.prepareStatement(
                            ...
                            + "reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Belum Lunas' and kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(rawat_inap_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and concat(kamar.kd_bangsal,bangsal.nm_bangsal) like ? and petugas.nama like ? and kamar_inap.stts_pulang not like '%Pindah Kamar%' or "
                            + "reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Belum Lunas' and kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(rawat_inap_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and concat(kamar.kd_bangsal,bangsal.nm_bangsal) like ? and penjab.png_jawab like ? and kamar_inap.stts_pulang not like '%Pindah Kamar%' or "
                            + "reg_periksa.status_bayar='Sudah Bayar' and piutang_pasien.status='Belum Lunas' and kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(rawat_inap_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and concat(bangsal.kd_bangsal,bangsal.nm_bangsal) like ? and bangsal.nm_bangsal like ? and kamar_inap.stts_pulang not like '%Pindah Kamar%' "
                            + " order by rawat_inap_drpr.no_rawat desc");
                } else if (cmbStatus.getSelectedItem().equals("Sudah Lunas")) {
                    ps = koneksi.prepareStatement(
                            "select rawat_inap_drpr.no_rawat, reg_periksa.no_rkm_medis, "
            ...
            try {
                if (KdDokterRanapDokterParamedis.getText().equals("") && NmDokterRanapDokterParamedis.getText().equals("")
                        && KdPetugasRanapDokterParamedis.getText().equals("") && NmPetugasRanapDokterParamedis.getText().equals("")
                        && KdCaraBayarRanapDokterParamedis.getText().equals("") && NmCaraBayarRanapDokterParamedis.getText().equals("")
                        && KdRuanganRanapDokterParamedis.getText().equals("") && KdRuanganrRanapDokterParamedis.getText().equals("")
                        && TCari.getText().equals("") && cmbStatus.getSelectedItem().equals("Semua")) {
                    ps.setString(1, Valid.SetTgl(Tgl1.getSelectedItem() + ""));
                    ps.setString(2, Valid.SetTgl(Tgl2.getSelectedItem() + ""));
                } else {
                    ...
                    ps.setString(6, "%" + KdRuanganRanapDokterParamedis.getText() + KdRuanganrRanapDokterParamedis.getText() + "%");
                    ps.setString(7, "%" + TCari.getText().trim() + "%");
                    ps.setString(8, Valid.SetTgl(Tgl1.getSelectedItem() + ""));
                    ps.setString(9, Valid.SetTgl(Tgl2.getSelectedItem() + ""));
                    ps.setString(10, "%" + KdDokterRanapDokterParamedis.getText() + NmDokterRanapDokterParamedis.getText() + "%");
                    ps.setString(11, "%" + KdPetugasRanapDokterParamedis.getText() + NmPetugasRanapDokterParamedis.getText() + "%");
                    ps.setString(12, "%" + KdCaraBayarRanapDokterParamedis.getText() + NmCaraBayarRanapDokterParamedis.getText() + "%");
                    ps.setString(13, "%" + KdRuanganRanapDokterParamedis.getText() + KdRuanganrRanapDokterParamedis.getText() + "%");
                    ps.setString(14, "%" + TCari.getText().trim() + "%");
                    ps.setString(15, Valid.SetTgl(Tgl1.getSelectedItem() + ""));
                    ps.setString(16, Valid.SetTgl(Tgl2.getSelectedItem() + ""));
                    ps.setString(17, "%" + KdDokterRanapDokterParamedis.getText() + NmDokterRanapDokterParamedis.getText() + "%");
                    ps.setString(18, "%" + KdPetugasRanapDokterParamedis.getText() + NmPetugasRanapDokterParamedis.getText() + "%");
                    ps.setString(19, "%" + KdCaraBayarRanapDokterParamedis.getText() + NmCaraBayarRanapDokterParamedis.getText() + "%");
                    ps.setString(20, "%" + KdRuanganRanapDokterParamedis.getText() + KdRuanganrRanapDokterParamedis.getText() + "%");
                    ps.setString(21, "%" + TCari.getText().trim() + "%");
                    ps.setString(22, Valid.SetTgl(Tgl1.getSelectedItem() + ""));
                    ps.setString(23, Valid.SetTgl(Tgl2.getSelectedItem() + ""));
                    ps.setString(24, "%" + KdDokterRanapDokterParamedis.getText() + NmDokterRanapDokterParamedis.getText() + "%");
                    ps.setString(25, "%" + KdPetugasRanapDokterParamedis.getText() + NmPetugasRanapDokterParamedis.getText() + "%");
                    ps.setString(26, "%" + KdCaraBayarRanapDokterParamedis.getText() + NmCaraBayarRanapDokterParamedis.getText() + "%");
                    ps.setString(27, "%" + KdRuanganRanapDokterParamedis.getText() + KdRuanganrRanapDokterParamedis.getText() + "%");
                    ps.setString(28, "%" + TCari.getText().trim() + "%");
                    ps.setString(29, Valid.SetTgl(Tgl1.getSelectedItem() + ""));
                    ps.setString(30, Valid.SetTgl(Tgl2.getSelectedItem() + ""));
                    ps.setString(31, "%" + KdDokterRanapDokterParamedis.getText() + NmDokterRanapDokterParamedis.getText() + "%");
                    ps.setString(32, "%" + KdPetugasRanapDokterParamedis.getText() + NmPetugasRanapDokterParamedis.getText() + "%");
                    ps.setString(33, "%" + KdCaraBayarRanapDokterParamedis.getText() + NmCaraBayarRanapDokterParamedis.getText() + "%");
                    ps.setString(34, "%" + KdRuanganRanapDokterParamedis.getText() + KdRuanganrRanapDokterParamedis.getText() + "%");
                    ps.setString(35, "%" + TCari.getText().trim() + "%");
                    ps.setString(36, Valid.SetTgl(Tgl1.getSelectedItem() + ""));
                    ps.setString(37, Valid.SetTgl(Tgl2.getSelectedItem() + ""));
                    ps.setString(38, "%" + KdDokterRanapDokterParamedis.getText() + NmDokterRanapDokterParamedis.getText() + "%");
                    ps.setString(39, "%" + KdPetugasRanapDokterParamedis.getText() + NmPetugasRanapDokterParamedis.getText() + "%");
                    ps.setString(40, "%" + KdCaraBayarRanapDokterParamedis.getText() + NmCaraBayarRanapDokterParamedis.getText() + "%");
                    ps.setString(41, "%" + KdRuanganRanapDokterParamedis.getText() + KdRuanganrRanapDokterParamedis.getText() + "%");
                    ps.setString(42, "%" + TCari.getText().trim() + "%");
                    ps.setString(43, Valid.SetTgl(Tgl1.getSelectedItem() + ""));
                    ps.setString(44, Valid.SetTgl(Tgl2.getSelectedItem() + ""));
                    ...
                    ps.setString(48, "%" + KdRuanganRanapDokterParamedis.getText() + KdRuanganrRanapDokterParamedis.getText() + "%");
                    ps.setString(49, "%" + TCari.getText().trim() + "%");
                    ps.setString(50, Valid.SetTgl(Tgl1.getSelectedItem() + ""));
                    ps.setString(51, Valid.SetTgl(Tgl2.getSelectedItem() + ""));
                    ps.setString(52, "%" + KdDokterRanapDokterParamedis.getText() + NmDokterRanapDokterParamedis.getText() + "%");
                    ps.setString(53, "%" + KdPetugasRanapDokterParamedis.getText() + NmPetugasRanapDokterParamedis.getText() + "%");
                    ps.setString(54, "%" + KdCaraBayarRanapDokterParamedis.getText() + NmCaraBayarRanapDokterParamedis.getText() + "%");
                    ps.setString(55, "%" + KdRuanganRanapDokterParamedis.getText() + KdRuanganrRanapDokterParamedis.getText() + "%");
                    ps.setString(56, "%" + TCari.getText().trim() + "%");
                    ps.setString(57, Valid.SetTgl(Tgl1.getSelectedItem() + ""));
                    ps.setString(58, Valid.SetTgl(Tgl2.getSelectedItem() + ""));
                    ps.setString(59, "%" + KdDokterRanapDokterParamedis.getText() + NmDokterRanapDokterParamedis.getText() + "%");
                    ps.setString(60, "%" + KdPetugasRanapDokterParamedis.getText() + NmPetugasRanapDokterParamedis.getText() + "%");
                    ps.setString(61, "%" + KdCaraBayarRanapDokterParamedis.getText() + NmCaraBayarRanapDokterParamedis.getText() + "%");
                    ps.setString(62, "%" + KdRuanganRanapDokterParamedis.getText() + KdRuanganrRanapDokterParamedis.getText() + "%");
                    ps.setString(63, "%" + TCari.getText().trim() + "%");
                    ps.setString(64, Valid.SetTgl(Tgl1.getSelectedItem() + ""));
                    ps.setString(65, Valid.SetTgl(Tgl2.getSelectedItem() + ""));
                    ps.setString(66, "%" + KdDokterRanapDokterParamedis.getText() + NmDokterRanapDokterParamedis.getText() + "%");
                    ps.setString(67, "%" + KdPetugasRanapDokterParamedis.getText() + NmPetugasRanapDokterParamedis.getText() + "%");
                    ps.setString(68, "%" + KdCaraBayarRanapDokterParamedis.getText() + NmCaraBayarRanapDokterParamedis.getText() + "%");
                    ps.setString(69, "%" + KdRuanganRanapDokterParamedis.getText() + KdRuanganrRanapDokterParamedis.getText() + "%");
                    ps.setString(70, "%" + TCari.getText().trim() + "%");
                }
...
//                    String kelas_rawat = rs.getString("kelas") == null ? "" : " (" + rs.getString("kelas") + ")";
//                    kamar_sementara = kamar_rawat + "" + kelas_rawat;
                    if (rs.getString("nm_bangsal") == null) {
                        kamar_sementara = "-";
                    } else {
                    ...
                    tabModeRanapDokterParamedis.addRow(new Object[]{
                        i, rs.getString(1), rs.getString(2), rs.getString(3), rs.getString(4),
                        rs.getString(5), rs.getString(7), rs.getString(9), rs.getString(22), rs.getString(23),
    ...
    private void tampil11() {
        try {
            ...
            ps = koneksi.prepareStatement(
                    "select rawat_inap_drpr.no_rawat, reg_periksa.no_rkm_medis, "
                    + "pasien.nm_pasien, rawat_inap_drpr.kd_jenis_prw, jns_perawatan_inap.nm_perawatan, "
                    + "rawat_inap_drpr.kd_dokter, (SELECT nm_dokter FROM dokter WHERE kd_dokter=rawat_inap_drpr.kd_dokter)AS drvisit, "
                    + "rawat_inap_drpr.nip, petugas.nama, min(rawat_inap_drpr.tgl_perawatan) as tgl_perawatan, "
                    + "min(rawat_inap_drpr.jam_rawat) as jam_rawat,  penjab.png_jawab, rawat_inap_drpr.kd_kamar, kamar.kelas, "
                    + "rawat_inap_drpr.material, rawat_inap_drpr.bhp, rawat_inap_drpr.tarif_tindakandr, rawat_inap_drpr.tarif_tindakanpr, "
                    + "rawat_inap_drpr.kso, rawat_inap_drpr.menejemen, rawat_inap_drpr.biaya_rawat, dokter_pertama.nm_dokter as dokter_pertama, kamar_inap.tgl_keluar, "
                    + "kamar.kd_kamar,kamar.kd_bangsal,bangsal.kd_bangsal, bangsal.nm_bangsal,jns_perawatan_inap.total_byrdrpr,operasi.biayaoperator1 "
                    + "from pasien inner join reg_periksa on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "
                    + "inner join kamar_inap on kamar_inap.no_rawat=reg_periksa.no_rawat "
                    + "inner join rawat_inap_drpr on rawat_inap_drpr.no_rawat=reg_periksa.no_rawat "
                    + "inner join jns_perawatan_inap on rawat_inap_drpr.kd_jenis_prw=jns_perawatan_inap.kd_jenis_prw "
                    ...
                    + "left join kamar on rawat_inap_drpr.kd_kamar = kamar.kd_kamar "
                    + "left join bangsal on bangsal.kd_bangsal = kamar.kd_bangsal "
                    + "left join operasi on operasi.no_rawat = kamar_inap.no_rawat "
                    + "where "
                    + visit + "reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien where status='Belum Lunas') and kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(rawat_inap_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and rawat_inap_drpr.no_rawat like ? and kamar_inap.stts_pulang not like '%Pindah Kamar%' or "
                    + visit + "reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien where status='Belum Lunas') and kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(rawat_inap_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and reg_periksa.no_rkm_medis like ? and kamar_inap.stts_pulang not like '%Pindah Kamar%' or "
                    + visit + "reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien where status='Belum Lunas') and kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(rawat_inap_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and pasien.nm_pasien like ? and kamar_inap.stts_pulang not like '%Pindah Kamar%' or "
                    + visit + "reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien where status='Belum Lunas') and kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(rawat_inap_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and jns_perawatan_inap.nm_perawatan like ? and kamar_inap.stts_pulang not like '%Pindah Kamar%' or "
                    + visit + "reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien where status='Belum Lunas') and kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(rawat_inap_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and rawat_inap_drpr.kd_dokter like ? and kamar_inap.stts_pulang not like '%Pindah Kamar%' or "
                    + visit + "reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien where status='Belum Lunas') and kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(rawat_inap_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and dokter.nm_dokter like ? and kamar_inap.stts_pulang not like '%Pindah Kamar%' or "
                    + visit + "reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien where status='Belum Lunas') and kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(rawat_inap_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and rawat_inap_drpr.nip like ? and kamar_inap.stts_pulang not like '%Pindah Kamar%' or "
                    + visit + "reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien where status='Belum Lunas') and kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(rawat_inap_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and petugas.nama like ? and kamar_inap.stts_pulang not like '%Pindah Kamar%' or "
                    + visit + "reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien where status='Belum Lunas') and kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(rawat_inap_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and penjab.png_jawab like ? and kamar_inap.stts_pulang not like '%Pindah Kamar%' or "
                    + visit + "reg_periksa.status_bayar='Sudah Bayar' and reg_periksa.no_rawat not in (select no_rawat from piutang_pasien where status='Belum Lunas') and kamar_inap.tgl_keluar between ? and ? and concat(rawat_inap_drpr.kd_dokter,dokter.nm_dokter) like ? and concat(rawat_inap_drpr.nip,petugas.nama) like ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? and bangsal.nm_bangsal like ? and kamar_inap.stts_pulang not like '%Pindah Kamar%' "
                    + " GROUP BY kamar_inap.no_rawat order by rawat_inap_drpr.tgl_perawatan, rawat_inap_drpr.jam_rawat asc");

            try {
                ps.setString(1, Valid.SetTgl(Tgl1.getSelectedItem() + ""));
                ps.setString(2, Valid.SetTgl(Tgl2.getSelectedItem() + ""));
                ps.setString(3, "%" + KdDokterRanapDokterParamedis1.getText() + NmDokterRanapDokterParamedis1.getText() + "%");
                ps.setString(4, "%" + KdPetugasRanapDokterParamedis1.getText() + NmPetugasRanapDokterParamedis1.getText() + "%");
                ps.setString(5, "%" + KdCaraBayarRanapDokterParamedis1.getText() + NmCaraBayarRanapDokterParamedis1.getText() + "%");
                ps.setString(6, "%" + TCari.getText().trim() + "%");
                ps.setString(7, Valid.SetTgl(Tgl1.getSelectedItem() + ""));
                ps.setString(8, Valid.SetTgl(Tgl2.getSelectedItem() + ""));
                ps.setString(9, "%" + KdDokterRanapDokterParamedis1.getText() + NmDokterRanapDokterParamedis1.getText() + "%");
                ps.setString(10, "%" + KdPetugasRanapDokterParamedis1.getText() + NmPetugasRanapDokterParamedis1.getText() + "%");
                ps.setString(11, "%" + KdCaraBayarRanapDokterParamedis1.getText() + NmCaraBayarRanapDokterParamedis1.getText() + "%");
                ps.setString(12, "%" + TCari.getText().trim() + "%");
                ps.setString(13, Valid.SetTgl(Tgl1.getSelectedItem() + ""));
                ps.setString(14, Valid.SetTgl(Tgl2.getSelectedItem() + ""));
                ps.setString(15, "%" + KdDokterRanapDokterParamedis1.getText() + NmDokterRanapDokterParamedis1.getText() + "%");
                ps.setString(16, "%" + KdPetugasRanapDokterParamedis1.getText() + NmPetugasRanapDokterParamedis1.getText() + "%");
                ps.setString(17, "%" + KdCaraBayarRanapDokterParamedis1.getText() + NmCaraBayarRanapDokterParamedis1.getText() + "%");
                ps.setString(18, "%" + TCari.getText().trim() + "%");
                ps.setString(19, Valid.SetTgl(Tgl1.getSelectedItem() + ""));
                ps.setString(20, Valid.SetTgl(Tgl2.getSelectedItem() + ""));
                ps.setString(21, "%" + KdDokterRanapDokterParamedis1.getText() + NmDokterRanapDokterParamedis1.getText() + "%");
                ps.setString(22, "%" + KdPetugasRanapDokterParamedis1.getText() + NmPetugasRanapDokterParamedis1.getText() + "%");
                ps.setString(23, "%" + KdCaraBayarRanapDokterParamedis1.getText() + NmCaraBayarRanapDokterParamedis1.getText() + "%");
                ps.setString(24, "%" + TCari.getText().trim() + "%");
                ps.setString(25, Valid.SetTgl(Tgl1.getSelectedItem() + ""));
                ps.setString(26, Valid.SetTgl(Tgl2.getSelectedItem() + ""));
                ps.setString(27, "%" + KdDokterRanapDokterParamedis1.getText() + NmDokterRanapDokterParamedis1.getText() + "%");
                ps.setString(28, "%" + KdPetugasRanapDokterParamedis1.getText() + NmPetugasRanapDokterParamedis1.getText() + "%");
                ps.setString(29, "%" + KdCaraBayarRanapDokterParamedis1.getText() + NmCaraBayarRanapDokterParamedis1.getText() + "%");
                ps.setString(30, "%" + TCari.getText().trim() + "%");
                ps.setString(31, Valid.SetTgl(Tgl1.getSelectedItem() + ""));
                ps.setString(32, Valid.SetTgl(Tgl2.getSelectedItem() + ""));
                ps.setString(33, "%" + KdDokterRanapDokterParamedis1.getText() + NmDokterRanapDokterParamedis1.getText() + "%");
                ps.setString(34, "%" + KdPetugasRanapDokterParamedis1.getText() + NmPetugasRanapDokterParamedis1.getText() + "%");
                ps.setString(35, "%" + KdCaraBayarRanapDokterParamedis1.getText() + NmCaraBayarRanapDokterParamedis1.getText() + "%");
                ps.setString(36, "%" + TCari.getText().trim() + "%");
                ps.setString(37, Valid.SetTgl(Tgl1.getSelectedItem() + ""));
                ps.setString(38, Valid.SetTgl(Tgl2.getSelectedItem() + ""));
                ps.setString(39, "%" + KdDokterRanapDokterParamedis1.getText() + NmDokterRanapDokterParamedis1.getText() + "%");
                ps.setString(40, "%" + KdPetugasRanapDokterParamedis1.getText() + NmPetugasRanapDokterParamedis1.getText() + "%");
                ps.setString(41, "%" + KdCaraBayarRanapDokterParamedis1.getText() + NmCaraBayarRanapDokterParamedis1.getText() + "%");
                ps.setString(42, "%" + TCari.getText().trim() + "%");
                ps.setString(43, Valid.SetTgl(Tgl1.getSelectedItem() + ""));
                ps.setString(44, Valid.SetTgl(Tgl2.getSelectedItem() + ""));
                ps.setString(45, "%" + KdDokterRanapDokterParamedis1.getText() + NmDokterRanapDokterParamedis1.getText() + "%");
                ps.setString(46, "%" + KdPetugasRanapDokterParamedis1.getText() + NmPetugasRanapDokterParamedis1.getText() + "%");
                ps.setString(47, "%" + KdCaraBayarRanapDokterParamedis1.getText() + NmCaraBayarRanapDokterParamedis1.getText() + "%");
                ps.setString(48, "%" + TCari.getText().trim() + "%");
                ps.setString(49, Valid.SetTgl(Tgl1.getSelectedItem() + ""));
                ps.setString(50, Valid.SetTgl(Tgl2.getSelectedItem() + ""));
                ps.setString(51, "%" + KdDokterRanapDokterParamedis1.getText() + NmDokterRanapDokterParamedis1.getText() + "%");
                ps.setString(52, "%" + KdPetugasRanapDokterParamedis1.getText() + NmPetugasRanapDokterParamedis1.getText() + "%");
                ps.setString(53, "%" + KdCaraBayarRanapDokterParamedis1.getText() + NmCaraBayarRanapDokterParamedis1.getText() + "%");
                ps.setString(54, "%" + TCari.getText().trim() + "%");
                ps.setString(55, Valid.SetTgl(Tgl1.getSelectedItem() + ""));
                ps.setString(56, Valid.SetTgl(Tgl2.getSelectedItem() + ""));
                ps.setString(57, "%" + KdDokterRanapDokterParamedis1.getText() + NmDokterRanapDokterParamedis1.getText() + "%");
                ps.setString(58, "%" + KdPetugasRanapDokterParamedis1.getText() + NmPetugasRanapDokterParamedis1.getText() + "%");
                ps.setString(59, "%" + KdCaraBayarRanapDokterParamedis1.getText() + NmCaraBayarRanapDokterParamedis1.getText() + "%");
                ps.setString(60, "%" + TCari.getText().trim() + "%");
