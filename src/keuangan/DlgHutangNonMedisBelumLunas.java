...
public final class DlgHutangNonMedisBelumLunas extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Hutang Barang Non Medis dan Penunjang ( Lab & RO ) ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(130,100,100))); // NOI18N
        ...
        if(tabMode.getRowCount()==0){
            ...
            for(int i=0;i<row;i++){  
                    Sequel.menyimpan("temporary","'0','"+
                                ...
                                Valid.SetAngka(Double.parseDouble(tabMode.getValueAt(i,9).toString()))+"','','','','','','','','','','','','','','','','','','','','','','','','','','','',''","Piutang Pasien"); 
            }
            ...
            Valid.MyReport("rptHutangNonMedisBelumLunas.jrxml","report","::[ Data Hutang Barang Non Medis ]::",
                ...
                if(tabMode.getValueAt(i,0).toString().equals("true")){
                    if(Double.parseDouble(tbBangsal.getValueAt(i,10).toString())>0){
                        if(Sequel.menyimpantf("bayar_pemesanan_non_medis","?,?,?,?,?,?,?","Data", 7,new String[]{
                            ...
                            jur.simpanJurnal(no_bukti.getText(),Valid.SetTgl(tgl_bayar.getSelectedItem()+""),"U","BAYAR PELUNASAN HUTANG BARANG NON MEDIS NO.FAKTUR "+tabMode.getValueAt(i,1).toString());                            
                        }
                    }                        
                }
            }
    ...
    public void tampil(){
        ...
        try{
            ps=koneksi.prepareStatement(
                    ...
                    "ipsrspemesanan.status<>'Sudah Dibayar' and ipsrssuplier.nama_suplier like ? and ipsrspemesanan.no_faktur like ? or "+
                    "ipsrspemesanan.status<>'Sudah Dibayar' and ipsrssuplier.nama_suplier like ? and ipsrspemesanan.no_order like ? or "+
                    "ipsrspemesanan.status<>'Sudah Dibayar' and ipsrssuplier.nama_suplier like ? and ipsrspemesanan.tgl_tempo like ? or "+
                    "ipsrspemesanan.status<>'Sudah Dibayar' and ipsrssuplier.nama_suplier like ? and ipsrssuplier.nama_suplier like ? or "+
                    "ipsrspemesanan.status<>'Sudah Dibayar' and ipsrssuplier.nama_suplier like ? and petugas.nama like ? order by ipsrspemesanan.tgl_tempo ");
            try {
