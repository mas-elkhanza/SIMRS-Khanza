...
public class DlgPengaturanRekening extends javax.swing.JDialog {
    ...
    private String Tindakan_Ralan, Laborat_Ralan, Radiologi_Ralan, Obat_Ralan, Registrasi_Ralan, 
            ...
            Beban_Jasa_Menejemen_Radiologi_Ranap,Utang_Jasa_Menejemen_Radiologi_Ranap,Kerugian_Klaim_BPJS,
            Lebih_Bayar_Klaim_BPJS;
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TabRawat.getSelectedIndex()==0){
            ...
            Kerugian_Klaim_BPJS=tbPengaturan.getValueAt(177,1).toString();
            Lebih_Bayar_Klaim_BPJS=tbPengaturan.getValueAt(178,1).toString();
            ...
            if(Pengadaan_Obat.equals("")||Pemesanan_Obat.equals("")||Kontra_Pemesanan_Obat.equals("")||Bayar_Pemesanan_Obat.equals("")||Penjualan_Obat.equals("")||
                    ...
                    Harian_Ranap.equals("")||Uang_Muka_Ranap.equals("")||Piutang_Pasien_Ranap.equals("")||Kerugian_Klaim_BPJS.equals("")||Lebih_Bayar_Klaim_BPJS.equals("")){
                ...
                Sequel.menyimpan("set_akun","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",50,new String[]{
                    Pengadaan_Obat,
                    ...
                    Kontra_Retur_Piutang_Toko,Kerugian_Klaim_BPJS,Lebih_Bayar_Klaim_BPJS
                });
        ...
        try{    
            ...
            try {
                ...
                if(rs.next()){                    
                    ...
                    Kerugian_Klaim_BPJS=rs.getString("Kerugian_Klaim_BPJS");
                    Lebih_Bayar_Klaim_BPJS=rs.getString("Lebih_Bayar_Klaim_BPJS");
                }               
            } catch (Exception e) {
            ...
            tabMode.addRow(new Object[]{" [Debet] Kerugian Klaim BPJS pada menu RVP Piutang BPJS",Kerugian_Klaim_BPJS,
                Sequel.cariIsi("select nm_rek from rekening where kd_rek=?",Kerugian_Klaim_BPJS),
                Sequel.cariIsi("select tipe from rekening where kd_rek=?",Kerugian_Klaim_BPJS),
                Sequel.cariIsi("select balance from rekening where kd_rek=?",Kerugian_Klaim_BPJS)
            });
            tabMode.addRow(new Object[]{" [Debet] Lebih Bayar Klaim BPJS pada menu RVP Piutang BPJS",Lebih_Bayar_Klaim_BPJS,
                Sequel.cariIsi("select nm_rek from rekening where kd_rek=?",Lebih_Bayar_Klaim_BPJS),
                Sequel.cariIsi("select tipe from rekening where kd_rek=?",Lebih_Bayar_Klaim_BPJS),
                Sequel.cariIsi("select balance from rekening where kd_rek=?",Lebih_Bayar_Klaim_BPJS)
            });
        }catch(Exception e){
