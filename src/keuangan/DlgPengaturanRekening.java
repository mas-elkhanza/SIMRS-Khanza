...
public class DlgPengaturanRekening extends javax.swing.JDialog {
    ...
    private String Tindakan_Ralan, Laborat_Ralan, Radiologi_Ralan, Obat_Ralan, Registrasi_Ralan, Tambahan_Ralan,
            ...
            Kontra_Retur_Beli_Toko, Retur_Beli_Non_Medis, Kontra_Retur_Beli_Non_Medis, kode_pendapatan_tindakan,
            ...
            nama_beban_menejemen, kode_utang_menejemen, nama_utang_menejemen;
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(
                ...
                "::[ Pengaturan Rekening ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_BtnSimpanActionPerformed
        if (TabRawat.getSelectedIndex() == 0) {
            ...
            if (Tindakan_Ralan.equals("") || Laborat_Ralan.equals("") || Radiologi_Ralan.equals("")
                    || Obat_Ralan.equals("") || Registrasi_Ralan.equals("") || Tambahan_Ralan.equals("")
                    || Potongan_Ralan.equals("") || Tindakan_Ranap.equals("") || Laborat_Ranap.equals("")
                    || Radiologi_Ranap.equals("") || Obat_Ranap.equals("") || Registrasi_Ranap.equals("")
                    || Tambahan_Ranap.equals("") || Potongan_Ranap.equals("") || Retur_Obat_Ranap.equals("")
                    || Resep_Pulang_Ranap.equals("") || Kamar_Inap.equals("") || Operasi_Ranap.equals("")
                    || Harian_Ranap.equals("") || Uang_Muka_Ranap.equals("") || Piutang_Pasien_Ranap.equals("")
                    || Pengadaan_Obat.equals("") || Pemesanan_Obat.equals("") || Kontra_Pemesanan_Obat.equals("")
                    || Bayar_Pemesanan_Obat.equals("") || Penjualan_Obat.equals("") || Piutang_Obat.equals("")
                    || Kontra_Piutang_Obat.equals("") || Retur_Ke_Suplayer.equals("") || Retur_Dari_pembeli.equals("")
                    || Retur_Piutang_Obat.equals("") || Kontra_Retur_Piutang_Obat.equals("")
                    || Pengadaan_Ipsrs.equals("") || Stok_Keluar_Ipsrs.equals("") || Kontra_Stok_Keluar_Ipsrs.equals("")
                    || Bayar_Piutang_Pasien.equals("") || Kontra_Retur_Ke_Suplayer.equals("")
                    || Kontra_Retur_Dari_Pembeli.equals("") || Service_Ranap.equals("") || Pengambilan_Utd.equals("")
                    || Kontra_Pengambilan_Utd.equals("") || Pengambilan_Penunjang_Utd.equals("")
                    || Kontra_Pengambilan_Penunjang_Utd.equals("") || Operasi_Ralan.equals("")
                    || Penyerahan_Darah.equals("") || Beban_Jasa_Medik_Dokter_Tindakan_Ralan.equals("")
                    || Utang_Jasa_Medik_Dokter_Tindakan_Ralan.equals("")
                    || Beban_Jasa_Medik_Paramedis_Tindakan_Ralan.equals("")
                    || Utang_Jasa_Medik_Paramedis_Tindakan_Ralan.equals("") || Beban_KSO_Tindakan_Ralan.equals("")
                    || Utang_KSO_Tindakan_Ralan.equals("") || Beban_Jasa_Medik_Dokter_Laborat_Ralan.equals("")
                    || Utang_Jasa_Medik_Dokter_Laborat_Ralan.equals("")
                    || Beban_Jasa_Medik_Petugas_Laborat_Ralan.equals("")
                    || Utang_Jasa_Medik_Petugas_Laborat_Ralan.equals("") || Beban_Kso_Laborat_Ralan.equals("")
                    || Utang_Kso_Laborat_Ralan.equals("") || HPP_Persediaan_Laborat_Rawat_Jalan.equals("")
                    || Persediaan_BHP_Laborat_Rawat_Jalan.equals("")
                    || Beban_Jasa_Medik_Dokter_Radiologi_Ralan.equals("")
                    || Utang_Jasa_Medik_Dokter_Radiologi_Ralan.equals("")
                    || Beban_Jasa_Medik_Petugas_Radiologi_Ralan.equals("")
                    || Utang_Jasa_Medik_Petugas_Radiologi_Ralan.equals("") || Beban_Kso_Radiologi_Ralan.equals("")
                    || Utang_Kso_Radiologi_Ralan.equals("") || HPP_Persediaan_Radiologi_Rawat_Jalan.equals("")
                    || Persediaan_BHP_Radiologi_Rawat_Jalan.equals("") || HPP_Obat_Rawat_Jalan.equals("")
                    || Persediaan_Obat_Rawat_Jalan.equals("") || Beban_Jasa_Medik_Dokter_Operasi_Ralan.equals("")
                    || Utang_Jasa_Medik_Dokter_Operasi_Ralan.equals("")
                    || Beban_Jasa_Medik_Paramedis_Operasi_Ralan.equals("")
                    || Utang_Jasa_Medik_Paramedis_Operasi_Ralan.equals("") || HPP_Obat_Operasi_Ralan.equals("")
                    || Persediaan_Obat_Kamar_Operasi_Ralan.equals("") || Suspen_Piutang_Tindakan_Ranap.equals("")
                    || Beban_Jasa_Medik_Dokter_Tindakan_Ranap.equals("")
                    || Utang_Jasa_Medik_Dokter_Tindakan_Ranap.equals("")
                    || Beban_Jasa_Medik_Paramedis_Tindakan_Ranap.equals("")
                    || Utang_Jasa_Medik_Paramedis_Tindakan_Ranap.equals("") || Beban_KSO_Tindakan_Ranap.equals("")
                    || Utang_KSO_Tindakan_Ranap.equals("") || Suspen_Piutang_Laborat_Ranap.equals("")
                    || Beban_Jasa_Medik_Dokter_Laborat_Ranap.equals("")
                    || Utang_Jasa_Medik_Dokter_Laborat_Ranap.equals("")
                    || Beban_Jasa_Medik_Petugas_Laborat_Ranap.equals("")
                    || Utang_Jasa_Medik_Petugas_Laborat_Ranap.equals("") || Beban_Kso_Laborat_Ranap.equals("")
                    || Utang_Kso_Laborat_Ranap.equals("") || HPP_Persediaan_Laborat_Rawat_inap.equals("")
                    || Persediaan_BHP_Laborat_Rawat_Inap.equals("") || Suspen_Piutang_Radiologi_Ranap.equals("")
                    || Beban_Jasa_Medik_Dokter_Radiologi_Ranap.equals("")
                    || Utang_Jasa_Medik_Dokter_Radiologi_Ranap.equals("")
                    || Beban_Jasa_Medik_Petugas_Radiologi_Ranap.equals("")
                    || Utang_Jasa_Medik_Petugas_Radiologi_Ranap.equals("") || Beban_Kso_Radiologi_Ranap.equals("")
                    || Utang_Kso_Radiologi_Ranap.equals("") || HPP_Persediaan_Radiologi_Rawat_Inap.equals("")
                    || Persediaan_BHP_Radiologi_Rawat_Inap.equals("") || HPP_Obat_Rawat_Inap.equals("")
                    || Persediaan_Obat_Rawat_Inap.equals("") || Suspen_Piutang_Obat_Ranap.equals("")
                    || Suspen_Piutang_Operasi_Ranap.equals("") || Beban_Jasa_Medik_Dokter_Operasi_Ranap.equals("")
                    || Utang_Jasa_Medik_Dokter_Operasi_Ranap.equals("")
                    || Beban_Jasa_Medik_Paramedis_Operasi_Ranap.equals("")
                    || Utang_Jasa_Medik_Paramedis_Operasi_Ranap.equals("") || HPP_Obat_Operasi_Ranap.equals("")
                    || Persediaan_Obat_Kamar_Operasi_Ranap.equals("") || Stok_Keluar_Medis.equals("")
                    || Kontra_Stok_Keluar_Medis.equals("") || HPP_Obat_Jual_Bebas.equals("")
                    || Persediaan_Obat_Jual_Bebas.equals("") || Penerimaan_NonMedis.equals("")
                    || Kontra_Penerimaan_NonMedis.equals("") || Bayar_Pemesanan_Non_Medis.equals("")
                    || Hibah_Obat.equals("") || Kontra_Hibah_Obat.equals("") || Penerimaan_Toko.equals("")
                    || Kontra_Penerimaan_Toko.equals("") || Pengadaan_Toko.equals("") || Bayar_Pemesanan_Toko.equals("")
                    || Penjualan_Toko.equals("") || HPP_Barang_Toko.equals("") || Persediaan_Barang_Toko.equals("")
                    || Piutang_Toko.equals("") || Kontra_Piutang_Toko.equals("") || Retur_Beli_Toko.equals("")
                    || Kontra_Retur_Beli_Toko.equals("") || Retur_Beli_Non_Medis.equals("")
                    || Kontra_Retur_Beli_Non_Medis.equals("")) {
                ...
                Sequel.menyimpan("set_akun_ralan",
                        "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", 38,
                        new String[] { Tindakan_Ralan, Beban_Jasa_Medik_Dokter_Tindakan_Ralan,
                                Utang_Jasa_Medik_Dokter_Tindakan_Ralan, Beban_Jasa_Medik_Paramedis_Tindakan_Ralan,
                                Utang_Jasa_Medik_Paramedis_Tindakan_Ralan, Beban_KSO_Tindakan_Ralan,
                                Utang_KSO_Tindakan_Ralan, Laborat_Ralan, Beban_Jasa_Medik_Dokter_Laborat_Ralan,
                                ...
                                Persediaan_BHP_Laborat_Rawat_Jalan, Radiologi_Ralan,
                                Beban_Jasa_Medik_Dokter_Radiologi_Ralan, Utang_Jasa_Medik_Dokter_Radiologi_Ralan,
                                Beban_Jasa_Medik_Petugas_Radiologi_Ralan, Utang_Jasa_Medik_Petugas_Radiologi_Ralan,
                                Beban_Kso_Radiologi_Ralan, Utang_Kso_Radiologi_Ralan,
                                HPP_Persediaan_Radiologi_Rawat_Jalan, Persediaan_BHP_Radiologi_Rawat_Jalan, Obat_Ralan,
                                HPP_Obat_Rawat_Jalan, Persediaan_Obat_Rawat_Jalan, Registrasi_Ralan, Operasi_Ralan,
                                Beban_Jasa_Medik_Dokter_Operasi_Ralan, Utang_Jasa_Medik_Dokter_Operasi_Ralan,
                ...
                Sequel.menyimpan("set_akun_ranap",
                        "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,"
                                + "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",
                        50,
                        new String[] { Suspen_Piutang_Tindakan_Ranap, Tindakan_Ranap,
                                ...
                                Utang_Jasa_Medik_Petugas_Laborat_Ranap, Beban_Kso_Laborat_Ranap,
                                Utang_Kso_Laborat_Ranap, HPP_Persediaan_Laborat_Rawat_inap,
                                Persediaan_BHP_Laborat_Rawat_Inap, Suspen_Piutang_Radiologi_Ranap, Radiologi_Ranap,
                                ...
                                Registrasi_Ranap, Service_Ranap, Tambahan_Ranap, Potongan_Ranap, Retur_Obat_Ranap,
                                Resep_Pulang_Ranap, Kamar_Inap, Suspen_Piutang_Operasi_Ranap, Operasi_Ranap,
                                Beban_Jasa_Medik_Dokter_Operasi_Ranap, Utang_Jasa_Medik_Dokter_Operasi_Ranap,
                                Beban_Jasa_Medik_Paramedis_Operasi_Ranap, Utang_Jasa_Medik_Paramedis_Operasi_Ranap,
                                HPP_Obat_Operasi_Ranap, Persediaan_Obat_Kamar_Operasi_Ranap, Harian_Ranap,
                                Uang_Muka_Ranap, Piutang_Pasien_Ranap });
                Sequel.queryu("delete from set_akun");
                Sequel.menyimpan("set_akun",
                        "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", 44,
                        new String[] { Pengadaan_Obat, Pemesanan_Obat, Kontra_Pemesanan_Obat, Bayar_Pemesanan_Obat,
                                Penjualan_Obat, Piutang_Obat, Kontra_Piutang_Obat, Retur_Ke_Suplayer,
                                Kontra_Retur_Ke_Suplayer, Retur_Dari_pembeli, Kontra_Retur_Dari_Pembeli,
                                Retur_Piutang_Obat, Kontra_Retur_Piutang_Obat, Pengadaan_Ipsrs, Stok_Keluar_Ipsrs,
                                Kontra_Stok_Keluar_Ipsrs, Bayar_Piutang_Pasien, Pengambilan_Utd, Kontra_Pengambilan_Utd,
                                Pengambilan_Penunjang_Utd, Kontra_Pengambilan_Penunjang_Utd, Penyerahan_Darah,
                                Stok_Keluar_Medis, Kontra_Stok_Keluar_Medis, HPP_Obat_Jual_Bebas,
                                Persediaan_Obat_Jual_Bebas, Penerimaan_NonMedis, Kontra_Penerimaan_NonMedis,
                                Bayar_Pemesanan_Non_Medis, Hibah_Obat, Kontra_Hibah_Obat, Penerimaan_Toko,
                                Kontra_Penerimaan_Toko, Pengadaan_Toko, Bayar_Pemesanan_Toko, Penjualan_Toko,
                                HPP_Barang_Toko, Persediaan_Barang_Toko, Piutang_Toko, Kontra_Piutang_Toko,
                                Retur_Beli_Toko, Kontra_Retur_Beli_Toko, Retur_Beli_Non_Medis,
            ...
            for (i = 0; i < tbPengaturanRalan.getRowCount(); i++) {
                if ((!tbPengaturanRalan.getValueAt(i, 5).equals("")) && (!tbPengaturanRalan.getValueAt(i, 6).equals(""))
                        && (!tbPengaturanRalan.getValueAt(i, 7).equals(""))
                        && (!tbPengaturanRalan.getValueAt(i, 8).equals(""))
                        && (!tbPengaturanRalan.getValueAt(i, 9).equals(""))
                        && (!tbPengaturanRalan.getValueAt(i, 10).equals(""))
                        && (!tbPengaturanRalan.getValueAt(i, 11).equals(""))
                        && (!tbPengaturanRalan.getValueAt(i, 12).equals(""))
                        && (!tbPengaturanRalan.getValueAt(i, 13).equals(""))
                        && (!tbPengaturanRalan.getValueAt(i, 14).equals(""))
                        && (!tbPengaturanRalan.getValueAt(i, 15).equals(""))
                        && (!tbPengaturanRalan.getValueAt(i, 16).equals(""))
                        && (!tbPengaturanRalan.getValueAt(i, 17).equals(""))
                        && (!tbPengaturanRalan.getValueAt(i, 18).equals(""))
                        && (!tbPengaturanRalan.getValueAt(i, 19).equals(""))
                        && (!tbPengaturanRalan.getValueAt(i, 20).equals(""))
                        && (!tbPengaturanRalan.getValueAt(i, 21).equals(""))
                        && (!tbPengaturanRalan.getValueAt(i, 22).equals(""))
                        && (!tbPengaturanRalan.getValueAt(i, 23).equals(""))
                        && (!tbPengaturanRalan.getValueAt(i, 24).equals(""))
                        && (!tbPengaturanRalan.getValueAt(i, 25).equals(""))
                        && (!tbPengaturanRalan.getValueAt(i, 26).equals(""))
                        && (!tbPengaturanRalan.getValueAt(i, 27).equals(""))
                        && (!tbPengaturanRalan.getValueAt(i, 28).equals(""))
                        && (!tbPengaturanRalan.getValueAt(i, 29).equals(""))
                        && (!tbPengaturanRalan.getValueAt(i, 30).equals(""))) {
                    Sequel.meghapus("matrik_akun_jns_perawatan", "kd_jenis_prw",
                            tbPengaturanRalan.getValueAt(i, 0).toString());
                    Sequel.menyimpan("matrik_akun_jns_perawatan", "?,?,?,?,?,?,?,?,?,?,?,?,?,?", 14,
                            new String[] { tbPengaturanRalan.getValueAt(i, 0).toString(),
            ...
            for (i = 0; i < tbPengaturanRanap.getRowCount(); i++) {
                if ((!tbPengaturanRanap.getValueAt(i, 6).equals("")) && (!tbPengaturanRanap.getValueAt(i, 7).equals(""))
                        && (!tbPengaturanRanap.getValueAt(i, 8).equals(""))
                        && (!tbPengaturanRanap.getValueAt(i, 9).equals(""))
                        && (!tbPengaturanRanap.getValueAt(i, 10).equals(""))
                        && (!tbPengaturanRanap.getValueAt(i, 11).equals(""))
                        && (!tbPengaturanRanap.getValueAt(i, 12).equals(""))
                        && (!tbPengaturanRanap.getValueAt(i, 13).equals(""))
                        && (!tbPengaturanRanap.getValueAt(i, 14).equals(""))
                        && (!tbPengaturanRanap.getValueAt(i, 15).equals(""))
                        && (!tbPengaturanRanap.getValueAt(i, 16).equals(""))
                        && (!tbPengaturanRanap.getValueAt(i, 17).equals(""))
                        && (!tbPengaturanRanap.getValueAt(i, 18).equals(""))
                        && (!tbPengaturanRanap.getValueAt(i, 19).equals(""))
                        && (!tbPengaturanRanap.getValueAt(i, 20).equals(""))
                        && (!tbPengaturanRanap.getValueAt(i, 21).equals(""))
                        && (!tbPengaturanRanap.getValueAt(i, 22).equals(""))
                        && (!tbPengaturanRanap.getValueAt(i, 23).equals(""))
                        && (!tbPengaturanRanap.getValueAt(i, 24).equals(""))
                        && (!tbPengaturanRanap.getValueAt(i, 25).equals(""))
                        && (!tbPengaturanRanap.getValueAt(i, 26).equals(""))
                        && (!tbPengaturanRanap.getValueAt(i, 27).equals(""))
                        && (!tbPengaturanRanap.getValueAt(i, 28).equals(""))
                        && (!tbPengaturanRanap.getValueAt(i, 29).equals(""))
                        && (!tbPengaturanRanap.getValueAt(i, 30).equals(""))
                        && (!tbPengaturanRanap.getValueAt(i, 31).equals(""))) {
                    Sequel.meghapus("matrik_akun_jns_perawatan_inap", "kd_jenis_prw",
                            tbPengaturanRanap.getValueAt(i, 0).toString());
                    Sequel.menyimpan("matrik_akun_jns_perawatan_inap", "?,?,?,?,?,?,?,?,?,?,?,?,?,?", 14,
                            new String[] { tbPengaturanRanap.getValueAt(i, 0).toString(),
            ...
            if (evt.getClickCount() == 1) {
                if (copyakun.equals("copy")) {
                    int reply = JOptionPane.showConfirmDialog(rootPane,
                            "Eeiiiiiits, udah bener belum data copy akun rekeningnya..??", "Konfirmasi",
                            JOptionPane.YES_NO_OPTION);
                    if (reply == JOptionPane.YES_OPTION) {
                        Sequel.meghapus("matrik_akun_jns_perawatan", "kd_jenis_prw",
                                tbPengaturanRalan.getValueAt(tbPengaturanRalan.getSelectedRow(), 0).toString());
                        Sequel.menyimpan("matrik_akun_jns_perawatan", "?,?,?,?,?,?,?,?,?,?,?,?,?,?", 14,
                                new String[] {
                                        tbPengaturanRalan.getValueAt(tbPengaturanRalan.getSelectedRow(), 0).toString(),
                                        tbPengaturanRalan.getValueAt(barisdicopy, 5).toString(),
                                        tbPengaturanRalan.getValueAt(barisdicopy, 7).toString(),
                                        tbPengaturanRalan.getValueAt(barisdicopy, 9).toString(),
                                        tbPengaturanRalan.getValueAt(barisdicopy, 11).toString(),
                                        tbPengaturanRalan.getValueAt(barisdicopy, 13).toString(),
                                        tbPengaturanRalan.getValueAt(barisdicopy, 15).toString(),
                                        tbPengaturanRalan.getValueAt(barisdicopy, 17).toString(),
                                        tbPengaturanRalan.getValueAt(barisdicopy, 19).toString(),
                                        tbPengaturanRalan.getValueAt(barisdicopy, 21).toString(),
                                        tbPengaturanRalan.getValueAt(barisdicopy, 23).toString(),
                                        tbPengaturanRalan.getValueAt(barisdicopy, 25).toString(),
                                        tbPengaturanRalan.getValueAt(barisdicopy, 27).toString(),
                                        tbPengaturanRalan.getValueAt(barisdicopy, 29).toString() });
                        tampilralan();
                        barisdicopy = -1;
                        copyakun = "";
                    } else {
    ...
    private void tampil() {
        ...
        try {
            ...
            tabMode.addRow(new Object[] { " [Kredit] Akun Pendapatan Tindakan pada menu Billing Rawat Jalan",
                    Tindakan_Ralan, Sequel.cariIsi("select nm_rek from rekening where kd_rek=?", Tindakan_Ralan),
            ...
            tabMode.addRow(new Object[] { " [Debet] Akun Beban Jasa Medik Dokter Tindakan Rawat Jalan",
                    Beban_Jasa_Medik_Dokter_Tindakan_Ralan,
                    Sequel.cariIsi("select nm_rek from rekening where kd_rek=?",
                            Beban_Jasa_Medik_Dokter_Tindakan_Ralan),
                    Sequel.cariIsi("select tipe from rekening where kd_rek=?", Beban_Jasa_Medik_Dokter_Tindakan_Ralan),
                    Sequel.cariIsi("select balance from rekening where kd_rek=?",
                            Beban_Jasa_Medik_Dokter_Tindakan_Ralan) });
            ...
            tabMode.addRow(new Object[] { " [Debet] Akun Beban Jasa Medik Paramedis Tindakan Rawat Jalan",
                    ...
                    Sequel.cariIsi("select nm_rek from rekening where kd_rek=?",
                            Beban_Jasa_Medik_Paramedis_Tindakan_Ralan),
                    Sequel.cariIsi("select tipe from rekening where kd_rek=?",
                            Beban_Jasa_Medik_Paramedis_Tindakan_Ralan),
                    Sequel.cariIsi("select balance from rekening where kd_rek=?",
                            Beban_Jasa_Medik_Paramedis_Tindakan_Ralan) });
            ...
            tabMode.addRow(new Object[] { " [Kredit] Akun Pendapatan Laborat pada menu Billing Rawat Jalan",
                    Laborat_Ralan, Sequel.cariIsi("select nm_rek from rekening where kd_rek=?", Laborat_Ralan),
            ...
            tabMode.addRow(new Object[] { " [Debet] Akun HPP BHP Laborat Rawat Jalan",
                    HPP_Persediaan_Laborat_Rawat_Jalan,
            ...
            tabMode.addRow(new Object[] { " [Kredit] Akun Pendapatan Radiologi pada menu Billing Rawat Jalan",
                    Radiologi_Ralan, Sequel.cariIsi("select nm_rek from rekening where kd_rek=?", Radiologi_Ralan),
            ...
            tabMode.addRow(new Object[] { " [Debet] Akun HPP BHP Radiologi Rawat Jalan",
                    HPP_Persediaan_Radiologi_Rawat_Jalan,
            ...
            tabMode.addRow(new Object[] { " [Kredit] Akun Pendapatan Registrasi pada menu Billing Rawat Jalan",
                    Registrasi_Ralan, Sequel.cariIsi("select nm_rek from rekening where kd_rek=?", Registrasi_Ralan),
            ...
            tabMode.addRow(new Object[] { " [Kredit] Akun Pendapatan Operasi pada menu Billing Rawat Jalan",
                    Operasi_Ralan, Sequel.cariIsi("select nm_rek from rekening where kd_rek=?", Operasi_Ralan),
            ...
            tabMode.addRow(new Object[] { " [Kredit] Akun Pendapatan Tambahan Biaya pada menu Billing Rawat Jalan",
                    Tambahan_Ralan, Sequel.cariIsi("select nm_rek from rekening where kd_rek=?", Tambahan_Ralan),
            ...
            tabMode.addRow(new Object[] { " [Debet] Akun Suspen Piutang Tindakan Rawat Inap",
                    Suspen_Piutang_Tindakan_Ranap,
            ...
            tabMode.addRow(new Object[] { " [Debet] Akun HPP Persediaan Laborat Rawat Inap",
                    HPP_Persediaan_Laborat_Rawat_inap,
            ...
            tabMode.addRow(new Object[] { " [Debet] Akun Suspen Piutang Radiologi Ranap",
                    Suspen_Piutang_Radiologi_Ranap,
            ...
            tabMode.addRow(new Object[] { " [Kredit] Akun Pendapatan Registrasi pada menu Billing Rawat Inap",
                    Registrasi_Ranap, Sequel.cariIsi("select nm_rek from rekening where kd_rek=?", Registrasi_Ranap),
            ...
            tabMode.addRow(new Object[] { " [Kredit] Akun Pendapatan Biaya Service pada menu Billing Rawat Inap",
                    Service_Ranap, Sequel.cariIsi("select nm_rek from rekening where kd_rek=?", Service_Ranap),
            ...
            tabMode.addRow(new Object[] { " [Kredit] Akun Pendapatan Tambahan Biaya pada menu Billing Rawat Inap",
                    Tambahan_Ranap, Sequel.cariIsi("select nm_rek from rekening where kd_rek=?", Tambahan_Ranap),
            ...
            tabMode.addRow(new Object[] { " [Kredit] Akun Pendapatan Kamar Inap pada menu Billing Rawat Inap",
                    Kamar_Inap, Sequel.cariIsi("select nm_rek from rekening where kd_rek=?", Kamar_Inap),
            ...
            tabMode.addRow(new Object[] { " [Kredit] Akun Pendapatan Harian Ranap pada menu Billing Rawat Inap",
                    Harian_Ranap, Sequel.cariIsi("select nm_rek from rekening where kd_rek=?", Harian_Ranap),
            ...
            tabMode.addRow(new Object[] { " [Kredit] Akun Uang Muka Pasien pada Billing menu Rawat Inap",
                    Uang_Muka_Ranap, Sequel.cariIsi("select nm_rek from rekening where kd_rek=?", Uang_Muka_Ranap),
            ...
            tabMode.addRow(
                    new Object[] { " [Debet] Akun Piutang Pasien pada Billing menu Rawat Inap", Piutang_Pasien_Ranap,
            ...
            tabMode.addRow(new Object[] { " [Debet] Akun Pengadaan Obat & BHP pada menu Pengadaan Obat & BHP",
                    Pengadaan_Obat, Sequel.cariIsi("select nm_rek from rekening where kd_rek=?", Pengadaan_Obat),
            ...
            tabMode.addRow(new Object[] { " [Debet] Akun Penerimaan Obat & BHP pada menu Penerimaan Obat & BHP",
                    Pemesanan_Obat, Sequel.cariIsi("select nm_rek from rekening where kd_rek=?", Pemesanan_Obat),
            ...
            tabMode.addRow(new Object[] { " [Kredit] Akun Penjualan Obat & BHP pada menu Penjualan Obat & BHP",
                    Penjualan_Obat, Sequel.cariIsi("select nm_rek from rekening where kd_rek=?", Penjualan_Obat),
            ...
            tabMode.addRow(new Object[] { " [Kredit] Akun Retur Obat & BHP ke Suplier pada menu Retur Ke Suplier",
                    Retur_Ke_Suplayer, Sequel.cariIsi("select nm_rek from rekening where kd_rek=?", Retur_Ke_Suplayer),
            ...
            tabMode.addRow(
                    new Object[] { " [Debet] Akun Retur Obat & BHP dari Pasien/Pembeli pada menu Retur Dari Pembeli",
                            Retur_Dari_pembeli,
            ...
            tabMode.addRow(new Object[] {
                    " [Kredit] Kontra Akun Retur Obat & BHP dari Pasien/Pembeli pada menu Retur Dari Pembeli",
                    Kontra_Retur_Dari_Pembeli,
            ...
            tabMode.addRow(
                    new Object[] { " [Kredit] Kontra Akun Retur Piutang Obat & BHP pada menu Retur Piutang Pembeli",
                            Kontra_Retur_Piutang_Obat,
            ...
            tabMode.addRow(new Object[] {
                    ...
                    Pengadaan_Ipsrs, Sequel.cariIsi("select nm_rek from rekening where kd_rek=?", Pengadaan_Ipsrs),
            ...
            tabMode.addRow(new Object[] {
                    ...
                    Stok_Keluar_Ipsrs, Sequel.cariIsi("select nm_rek from rekening where kd_rek=?", Stok_Keluar_Ipsrs),
            ...
            tabMode.addRow(new Object[] { " [Debet] Akun Pengambilan BHP Medis UTD pada menu Pengambilan BHP UTD",
                    Pengambilan_Utd, Sequel.cariIsi("select nm_rek from rekening where kd_rek=?", Pengambilan_Utd),
            ...
            tabMode.addRow(
                    new Object[] { " [Kredit] Kontra Akun Pengambilan BHP Medis UTD pada menu Pengambilan BHP UTD",
                            Kontra_Pengambilan_Utd,
            ...
            tabMode.addRow(new Object[] { " [Kredit] Akun Pendapatan Penjualan Darah pada menu Penyerahan Darah",
                    Penyerahan_Darah, Sequel.cariIsi("select nm_rek from rekening where kd_rek=?", Penyerahan_Darah),
            ...
            tabMode.addRow(new Object[] {
                    ...
                    Stok_Keluar_Medis, Sequel.cariIsi("select nm_rek from rekening where kd_rek=?", Stok_Keluar_Medis),
            ...
            tabMode.addRow(new Object[] { " [Kredit] Kontra Akun Hibah Obat & BHP pada menu Hibah Obat & BHP",
                    Kontra_Hibah_Obat, Sequel.cariIsi("select nm_rek from rekening where kd_rek=?", Kontra_Hibah_Obat),
            ...
            tabMode.addRow(new Object[] { " [Debet] Akun Penerimaan Barang Toko pada menu Penerimaan Barang Toko",
                    Penerimaan_Toko, Sequel.cariIsi("select nm_rek from rekening where kd_rek=?", Penerimaan_Toko),
            ...
            tabMode.addRow(
                    new Object[] { " [Kredit] Kontra Akun Penerimaan Barang Toko pada menu Penerimaan Barang Toko",
                            Kontra_Penerimaan_Toko,
            ...
            tabMode.addRow(new Object[] { " [Debet] Akun Pengadaan Barang Toko pada menu Pengadaan Barang Toko",
                    Pengadaan_Toko, Sequel.cariIsi("select nm_rek from rekening where kd_rek=?", Pengadaan_Toko),
            ...
            tabMode.addRow(
                    new Object[] { " [Kredit] Kontra Akun Piutang Toko pada menu Piutang Toko", Kontra_Piutang_Toko,
            ...
            tabMode.addRow(new Object[] { " [Kredit] Akun Retur Barang Toko ke Suplier pada menu Retur Ke Suplier Toko",
                    Retur_Beli_Toko, Sequel.cariIsi("select nm_rek from rekening where kd_rek=?", Retur_Beli_Toko),
