...
public class DlgDetailJMDokter extends javax.swing.JDialog {
    ...
    private String jml="",biaya="",jm="",uangrs="",bhp="",tarif="",tanggal="",kamar="",penjab="",pasien="";
    ...
    public DlgDetailJMDokter(java.awt.Frame parent, boolean modal) {
        ...
        try {
            ...
            pspasienranap=koneksi.prepareStatement("select rawat_inap_dr.no_rawat from rawat_inap_dr where rawat_inap_dr.kd_dokter=? and rawat_inap_dr.tgl_perawatan between ? and ? group by rawat_inap_dr.no_rawat");
            pspasienranapdrpr=koneksi.prepareStatement("select rawat_inap_drpr.no_rawat from rawat_inap_drpr where rawat_inap_drpr.kd_dokter=? and rawat_inap_drpr.tgl_perawatan between ? and ? group by rawat_inap_drpr.no_rawat");            
            pspasienralan=koneksi.prepareStatement(
                    ...
                    "where rawat_jl_dr.kd_dokter=? and reg_periksa.tgl_registrasi between ? and ? group by rawat_jl_dr.no_rawat");
            pspasienralandrpr=koneksi.prepareStatement(
                    ...
                    "and reg_periksa.kd_pj=penjab.kd_pj and reg_periksa.kd_poli=poliklinik.kd_poli "+
                    "where rawat_jl_drpr.kd_dokter=? and reg_periksa.tgl_registrasi between ? and ? group by rawat_jl_drpr.no_rawat");
            ...
            pspasienradiologi=koneksi.prepareStatement("select periksa_radiologi.no_rawat,periksa_radiologi.tgl_periksa,"+
                    ...
                    "where periksa_radiologi.kd_dokter=? and periksa_radiologi.tgl_periksa between ? and ? group by periksa_radiologi.no_rawat");
            ...
            pspasienradiologi2=koneksi.prepareStatement("select periksa_radiologi.no_rawat,periksa_radiologi.tgl_periksa,"+
                    ...
                    "on periksa_radiologi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "and reg_periksa.kd_pj=penjab.kd_pj "+
                    "where periksa_radiologi.dokter_perujuk=? and periksa_radiologi.tgl_periksa between ? and ? group by periksa_radiologi.no_rawat");
            ...
            pspasienlab=koneksi.prepareStatement("select periksa_lab.no_rawat,periksa_lab.tgl_periksa,"+
                    ...
                    "and reg_periksa.kd_pj=penjab.kd_pj "+
                    "where periksa_lab.kd_dokter=? and periksa_lab.tgl_periksa between ? and ? group by periksa_lab.no_rawat");                    
            ...
            pspasienlab2=koneksi.prepareStatement("select periksa_lab.no_rawat,periksa_lab.tgl_periksa,"+
                    ...
                    "on periksa_lab.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "and reg_periksa.kd_pj=penjab.kd_pj "+
                    "where periksa_lab.dokter_perujuk=? and periksa_lab.tgl_periksa between ? and ? group by periksa_lab.no_rawat");                    
            ...
            pspasienoperator1=koneksi.prepareStatement("select operasi.no_rawat,operasi.tgl_operasi,"+
                    ...
                    "and reg_periksa.kd_pj=penjab.kd_pj "+
                    "where operasi.operator1=? and operasi.tgl_operasi between ? and ? group by operasi.no_rawat");
            ...
            pspasienoperator2=koneksi.prepareStatement("select operasi.no_rawat,operasi.tgl_operasi,"+
                    ...
                    "on operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "and reg_periksa.kd_pj=penjab.kd_pj "+
                    "where operasi.operator2=? and operasi.tgl_operasi between ? and ? group by operasi.no_rawat");
            ...
            pspasienoperator3=koneksi.prepareStatement("select operasi.no_rawat,operasi.tgl_operasi,"+
                    ...
                    "on operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "and reg_periksa.kd_pj=penjab.kd_pj "+
                    "where operasi.operator3=? and operasi.tgl_operasi between ? and ? group by operasi.no_rawat");
            ...
            pspasiendokter_anak=koneksi.prepareStatement("select operasi.no_rawat,operasi.tgl_operasi,"+
                    ...
                    "on operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "and reg_periksa.kd_pj=penjab.kd_pj "+
                    "where operasi.dokter_anak=? and operasi.tgl_operasi between ? and ? group by operasi.no_rawat");
            ...
            pspasiendokter_anestesi=koneksi.prepareStatement("select operasi.no_rawat,operasi.tgl_operasi,"+
                    ...
                    "on operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "and reg_periksa.kd_pj=penjab.kd_pj "+
                    "where operasi.dokter_anestesi=? and operasi.tgl_operasi between ? and ? group by operasi.no_rawat");
            ...
            pspasiendokter_pjanak=koneksi.prepareStatement("select operasi.no_rawat,operasi.tgl_operasi,"+
                    ...
                    "on operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "and reg_periksa.kd_pj=penjab.kd_pj "+
                    "where operasi.dokter_pjanak=? and operasi.tgl_operasi between ? and ? group by operasi.no_rawat");
            ...
            pspasiendokter_umum=koneksi.prepareStatement("select operasi.no_rawat,operasi.tgl_operasi,"+
                    ...
                    "on operasi.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                    "and reg_periksa.kd_pj=penjab.kd_pj "+
                    "where operasi.dokter_umum=? and operasi.tgl_operasi between ? and ? group by operasi.no_rawat");
