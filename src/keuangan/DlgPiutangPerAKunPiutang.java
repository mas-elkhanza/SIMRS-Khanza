...
public final class DlgPiutangPerAKunPiutang extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(
                ...
                "::[ Piutang Pasien Per Akun Piutang ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_BtnPrintActionPerformed
        ...
        try {
            ...
            bg.write(
                    ".isi td{border-right: 1px solid #e2e7dd;font: 9px Arial;height:12px;border-bottom: 1px solid #e2e7dd;background: #ffffff;color:#464646;}"
                            + ".isi2 td{font: 9px Arial;height:12px;background: #ffffff;color:#464646;}"
                            + ".head td{border-right: 1px solid #777777;font: 9px Arial;height:10px;border-bottom: 1px solid #e2e7dd;background: #ffffff;color:#464646;}"
                            + ".isi3 td{border-right: 1px solid #e2e7dd;font: 9px Arial;height:12px;border-top: 1px solid #e2e7dd;background: #ffffff;color:#464646;}"
                            + ".isi4 td{font: 12px Arial;height:12px;background: #ffffff;color:#464646;}");
            bg.close();
            ...
            bw.write(LoadHTML.getText().replaceAll("<head>",
                    "<head><link href=\"fileakunbayar.css\" rel=\"stylesheet\" type=\"text/css\" />"
                            ...
                            + "<tr class='isi2'>" + "<td valign='top' align='center'>" + "<font size='5' face='Tahoma'>"
                            + akses.getnamars() + "</font><br>" + akses.getalamatrs() + ", " + akses.getkabupatenrs()
                            + ", " + akses.getpropinsirs() + "<br>" + akses.getkontakrs() + ", E-mail : "
                            + akses.getemailrs() + "<br><br>"
                            + "<font size='3' face='Tahoma'>PIUTANG PER AKUN PIUTANG<br>TANGGAL "
                            + Tgl1.getSelectedItem() + " s.d. " + Tgl2.getSelectedItem() + "<br><br></font>" + "</td>"
                            + "</tr>" + "</table>"));
            bw.close();
    ...
    public void tampil() {
        ...
        try {
            ...
            htmlContent.append(
                    "<tr class='head'>" + "<td valign='middle' bgcolor='#FFFAF8' align='center' width='27px'>No.</td>"
            ...
            try {
                ...
                while (rsakunbayar.next()) {
                    ...
                    kolom++;
                    htmlContent.append("<td valign='middle' bgcolor='#FFFAF8' align='center' width='130px'>"
                            + rsakunbayar.getString("nama_bayar") + "</td>");
                }
            } catch (Exception e) {
                System.out.println("Akun Bayar : " + e);
            } finally {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    htmlContent.append("<tr class='isi'>" + "<td valign='middle' align='center'>" + no + "</td>"
                            ...
                            + "<td valign='middle' align='right'>" + Valid.SetAngka(rs.getDouble("totalpiutang"))
                            + "</td>");
                    for (i = 0; i < kolom; i++) {
            ...
            htmlContent.append("<tr class='isi'>" + "<td valign='middle' align='center'></td>"
                    + "<td valign='middle' align='right'>Total :</td>" + "<td valign='middle' align='center'></td>"
                    + "<td valign='middle' align='center'></td>" + "<td valign='middle' align='right'>"
                    + Valid.SetAngka(uangmuka) + "</td>" + "<td valign='middle' align='right'>"
                    + Valid.SetAngka(piutang) + "</td>");
            for (i = 0; i < kolom; i++) {
