 ...
 * @author perpustakaan
 */
public final class DlgReklasifikasiRalan extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgReklasifikasiRalan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgReklasifikasiRalan dialog = new DlgReklasifikasiRalan(new javax.swing.JFrame(), true);
