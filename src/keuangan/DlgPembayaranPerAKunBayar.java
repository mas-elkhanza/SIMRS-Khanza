...
public final class DlgPembayaranPerAKunBayar extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Pembayaran Per Akun Bayar ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(90, 120, 80))); // NOI18N
    ...
    */
    ...
    public void tampil(){
        ...
        try{        
            ...
            htmlContent.append(                             
                "<tr class='isi'>"+
                    "<td valign='middle' bgcolor='#f7fcf2' align='center' width='27px'>No.</td>"+
                    "<td valign='middle' bgcolor='#f7fcf2' align='center' width='110px'>Tanggal</td>"+
                    "<td valign='middle' bgcolor='#f7fcf2' align='center' width='50px'>Shift</td>"+
                    "<td valign='middle' bgcolor='#f7fcf2' align='center' width='100px'>No.Rawat/No.Nota</td>"+
                    "<td valign='middle' bgcolor='#f7fcf2' align='center' width='220px'>Nama Pasien</td>"+
                    "<td valign='middle' bgcolor='#f7fcf2' align='center' width='80px'>Pembayaran</td>"+
                    "<td valign='middle' bgcolor='#f7fcf2' align='center' width='130px'>Petugas</td>");
            kolom=0;
            ...
            try {
                ...
                while(rsakunbayar.next()){
                    ...
                    kolom++;
                    htmlContent.append("<td valign='middle' bgcolor='#f7fcf2' align='center' width='130px'>"+rsakunbayar.getString("nama_bayar")+"</td>");
                }
            } catch (Exception e) {
