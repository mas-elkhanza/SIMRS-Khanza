...
public final class DlgSensusHarianRalan extends javax.swing.JDialog {
    ...
    public DlgSensusHarianRalan(java.awt.Frame parent, boolean modal) {
        ...
        styleSheet.addRule(
                ".isi td{border-right: 1px solid #edf2e8;font: 8.5px tahoma;height:12px;border-bottom: 1px solid #edf2e8;background: #ffffff;color:#8c7878;}"+
                ".isi2 td{font: 8.5px tahoma;height:12px;background: #ffffff;color:#8c7878;}"+
                ".head td{border-right: 1px solid #777777;font: 8.5px tahoma;height:10px;border-bottom: 1px solid #edf2e8;background: #ffffff;color:#8c7878;}"+
                ".isi3 td{border-right: 1px solid #edf2e8;font: 8.5px tahoma;height:12px;border-top: 1px solid #edf2e8;background: #ffffff;color:#8c7878;}"+
                ".isi4 td{font: 11px tahoma;height:12px;background: #ffffff;color:#8c7878;}"
        );
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Sensus Harian Pasien Rawat Jalan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(140,120,120))); // NOI18N
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        try {            
            ...
            bg.write(
                    ".isi td{border-right: 1px solid #edf2e8;font: 11px tahoma;height:12px;border-bottom: 1px solid #edf2e8;background: #ffffff;color:#8c7878;}"+
                    ".head td{border-right: 1px solid #edf2e8;font: 11px tahoma;height:12px;border-bottom: 1px solid #edf2e8;background: #ffffff;color:#8c7878;}"+
                    ".isi2 td{font: 11px tahoma;height:12px;background: #ffffff;color:#8c7878;}"+                    
                    ".isi3 td{border-right: 1px solid #edf2e8;font: 11px tahoma;height:12px;border-top: 1px solid #edf2e8;background: #ffffff;color:#8c7878;}"+
                    ".isi4 td{font: 11px tahoma;height:12px;background: #ffffff;color:#8c7878;}"
            );
            bg.close();
    ...
    */
    ...
    public void tampil(){        
        ...
        try {
                ...
                while(rs.next()){
                    ...
                    htmlContent.append(                             
                        ...
                        pstindakan=koneksi.prepareStatement(
                                ...
                                "on icd9.kode=prosedur_pasien.kode where prosedur_pasien.no_rawat=? limit 2");
                        try {
                            pstindakan.setString(1,rs.getString("no_rawat"));
                            rstindakan=pstindakan.executeQuery();
                            while(rstindakan.next()){
                                htmlContent.append("<tr class='isi4'><td width='100%'>"+rstindakan.getString("kode")+" "+rstindakan.getString("deskripsi_panjang")+"</td></tr>");
                            }
                        } catch (Exception e) {
            ...
            htmlContent.append(                             
                "<tr class='isi'>"+
                    "<td valign='middle' colspan='3'>Laki-Laki : "+jkl+"</td>"+
                    "<td valign='middle' colspan='3'>Perempuan : "+jkp+"</td>"+
                    "<td valign='middle' colspan='3'>Pengunjung Baru : "+pengunjungbaru+"</td>"+
                    "<td valign='middle' colspan='3'>Pengunjung Lama : "+pengunjunglama+"</td>"+
                    "<td valign='middle' colspan='3'>Jenis Kunjungan Baru : "+statuspolibaru+"</td>"+
                    "<td valign='middle' colspan='3'>Jenis Kunjungan Lama : "+statuspolilama+"</td>"+
                    "<td valign='middle' colspan='4'>Rujukan : "+rujukan+"</td>"+
                "</tr>"
            );  
