...
public final class DlgSensusHarianRalan extends javax.swing.JDialog {
    ...
    public DlgSensusHarianRalan(java.awt.Frame parent, boolean modal) {
        ...
        styleSheet.addRule(
                ".isi td{border-right: 1px solid #edf2e8;font: 8.5px tahoma;height:12px;border-bottom: 1px solid #edf2e8;background: #ffffff;color:#a08282;}"+
                ".isi2 td{font: 8.5px tahoma;height:12px;background: #ffffff;color:#a08282;}"+
                ".head td{border-right: 1px solid #777777;font: 8.5px tahoma;height:10px;border-bottom: 1px solid #edf2e8;background: #ffffff;color:#a08282;}"+
                ".isi3 td{border-right: 1px solid #edf2e8;font: 8.5px tahoma;height:12px;border-top: 1px solid #edf2e8;background: #ffffff;color:#a08282;}"+
                ".isi4 td{font: 11px tahoma;height:12px;background: #ffffff;color:#a08282;}"
        );
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Sensus Harian Pasien Rawat Jalan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(160,130,130))); // NOI18N
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        try {            
            ...
            bg.write(
                    ".isi td{border-right: 1px solid #edf2e8;font: 11px tahoma;height:12px;border-bottom: 1px solid #edf2e8;background: #ffffff;color:#a08282;}"+
                    ".head td{border-right: 1px solid #edf2e8;font: 11px tahoma;height:12px;border-bottom: 1px solid #edf2e8;background: #ffffff;color:#a08282;}"+
                    ".isi2 td{font: 11px tahoma;height:12px;background: #ffffff;color:#a08282;}"+                    
                    ".isi3 td{border-right: 1px solid #edf2e8;font: 11px tahoma;height:12px;border-top: 1px solid #edf2e8;background: #ffffff;color:#a08282;}"+
                    ".isi4 td{font: 11px tahoma;height:12px;background: #ffffff;color:#a08282;}"
            );
            bg.close();
