            ...
            try {
                ...
                while(rs.next()){
                    if((!rs.getString("nm_bangsal").toLowerCase().contains("apotek"))&&(!rs.getString("nm_bangsal").toLowerCase().contains("gudang"))&&(!rs.getString("nm_bangsal").toLowerCase().contains("depo"))&&(!rs.getString("nm_bangsal").toLowerCase().contains("farmasi"))){
                        pasien=Sequel.cariInteger("select count(data_klasifikasi_pasien_ranap.no_rawat) from data_klasifikasi_pasien_ranap inner join kamar inner join bangsal on data_klasifikasi_pasien_ranap.kd_kamar=kamar.kd_kamar and kamar.kd_bangsal=bangsal.kd_bangsal where data_klasifikasi_pasien_ranap.tanggal between ? and ? and kamar.kd_bangsal=? group by data_klasifikasi_pasien_ranap.no_rawat",Valid.SetTgl(Tgl1.getSelectedItem()+""),Valid.SetTgl(Tgl2.getSelectedItem()+""),rs.getString("kd_bangsal"));
