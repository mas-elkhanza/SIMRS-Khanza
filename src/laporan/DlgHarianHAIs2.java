        ...
        try {
            ...
            htmlContent.append(                             
                "<tr class='isi'>"+
                    ...
                    "<td valign='middle' bgcolor='#fafff5' align='center' width='11%' rowspan='2'>Nama Pasien</td>"+
                    "<td valign='middle' bgcolor='#fafff5' align='center' width='5%' rowspan='2'>Tanggal</td>"+
                    "<td valign='middle' bgcolor='#fafff5' align='center' width='10%' colspan='4'>Hari Pemasangan</td>"+
                    "<td valign='middle' bgcolor='#fafff5' align='center' width='20%' colspan='8'>Infeksi</td>"+
                    "<td valign='middle' bgcolor='#fafff5' align='center' width='3%' rowspan='2'>Deku</td>"+
                    "<td valign='middle' bgcolor='#fafff5' align='center' width='24%' colspan='3'>Hasil Kultur</td>"+
                    "<td valign='middle' bgcolor='#fafff5' align='center' width='8%' rowspan='2'>Antibiotik</td>"+
                    "<td valign='middle' bgcolor='#fafff5' align='center' width='11%' rowspan='2'>Kamar/Bangsal</td>"+
                "</tr>"+
                "<tr class='isi'>"+
