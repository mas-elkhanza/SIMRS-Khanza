...
//                                + "and kamar.kd_bangsal=bangsal.kd_bangsal "
//                                + "where tgl_masuk between '" + Valid.SetTgl(Tgl1.getSelectedItem() + "") + "' "
//                                + "and '" + Valid.SetTgl(Tgl2.getSelectedItem() + "") + "' group by kamar_inap.no_rawat having count(kamar_inap.no_rawat)>1  ");
//                    } else {
//                        pasien = Sequel.cariInteger("select count(kamar_inap.no_rawat) "
//                                + "from kamar_inap "
//                                + "inner join kamar "
