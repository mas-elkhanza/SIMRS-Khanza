...
public final class DlgDkkPenyakitTidakMenularRanap extends javax.swing.JDialog {
    ...
    public DlgDkkPenyakitTidakMenularRanap(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{"No.","Jenis Penyakit","< 1(L)","< 1(P)","1-4(L)","1-4(P)","5-14(L)","5-14(P)","15-44(L)","15-44(P)",
        ...
        tabMode2=new DefaultTableModel(null,new Object[]{"No.","Jenis Penyakit","< 1(L)","< 1(P)","1-4(L)","1-4(P)","5-14(L)","5-14(P)","15-44(L)","15-44(P)",
                "45-64(L)","45-64(P)",">65(L)",">65(P)","Total(L)","Total(P)","Total(Jml)","Meninggal(L)","Meninggal(P)"}){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
            ...
            if(TabRawat.getSelectedIndex()==0){
                ...
                for(int r=0;r<tabMode2.getRowCount();r++){  
                    Sequel.menyimpan("temporary","'0','"+
                                    ...
                                    tabMode2.getValueAt(r,1).toString().replaceAll("RUMAH SAKIT","                                  RUMAH SAKIT")+"','"+
                                    ...
                                    tabMode2.getValueAt(r,18).toString().replaceAll("'","`")+"','','','','','','','','','','','','','','','','','',''","Rekap Nota Pembayaran");
                }
            }
    ...
    public void tampil2(){        
        try{   
            ...
            try {
                ...
                while(rs.next()){
                    kr1l=0;kr1p=0;th1s4l=0;th1s4p=0;th5s14l=0;th5s14p=0;th15s44l=0;th15S44p=0;th45s64l=0;th45s64p=0;th65plusl=0;th65plusp=0;totall=0;totalp=0;totaljml=0;matil=0;matip=0;
                    ps2=koneksi.prepareStatement("select pasien.umur,pasien.jk,pasien.no_rkm_medis from pasien inner join reg_periksa inner join diagnosa_pasien inner join kamar_inap "+
