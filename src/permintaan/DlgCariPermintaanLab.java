...
public class DlgCariPermintaanLab extends javax.swing.JDialog {
    ...
    private String pilihan = "", alarm = "", formalarm = "", nol_detik, detik, tglsampel = "", tglhasil = "", norm = "",
            ...
            JamSampel = "", Hasil = "", JamHasil = "", KodeDokter = "", DokterPerujuk = "", Ruang = "";
    ...
    private void initComponents() {
        ...
        internalFrame5.setBorder(javax.swing.BorderFactory.createTitledBorder(
                ...
                "::[ Update Waktu Pengambilan Sampel ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(
                javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)),
                "::[ Data Permintaan Laboratorium ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION,
                javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11),
                new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        tbLabRalan.setModel(new javax.swing.table.DefaultTableModel(new Object[][] { {}, {}, {}, {} }, new String[] {
        ...
        tbLabRalan2.setModel(new javax.swing.table.DefaultTableModel(new Object[][] { {}, {}, {}, {} }, new String[] {
        ...
        tbLabRanap.setModel(new javax.swing.table.DefaultTableModel(new Object[][] { {}, {}, {}, {} }, new String[] {
        ...
        tbLabRanap2.setModel(new javax.swing.table.DefaultTableModel(new Object[][] { {}, {}, {}, {} }, new String[] {
            ...
            if (TabRawatJalan.getSelectedIndex() == 0) {
                if (tabMode.getRowCount() == 0) {
                    ...
                    for (i = 0; i < row; i++) {
                        ...
                        Sequel.menyimpan("temporary_permintaan_lab", "'0','" + tabMode.getValueAt(i, 0).toString()
                                + "','" + tabMode.getValueAt(i, 1).toString() + "','"
                                + tabMode.getValueAt(i, 2).toString() + "','" + tabMode.getValueAt(i, 3).toString()
                                + "','" + tabMode.getValueAt(i, 4).toString() + "','" + tglsampel + "','"
                                + tabMode.getValueAt(i, 6).toString() + "','" + tglhasil + "','"
                                ...
                                + tabMode.getValueAt(i, 14).toString() + "','" + tabMode.getValueAt(i, 15).toString()
                                + "','','','','','','','','','','','','','','','','','','','','',''", "Periksa Lab");
                    }
                ...
                if (tabMode2.getRowCount() == 0) {
                    ...
                    for (i = 0; i < row; i++) {
                        ...
                        Sequel.menyimpan("temporary_permintaan_lab", "'0','" + tabMode2.getValueAt(i, 0).toString()
                                + "','" + tabMode2.getValueAt(i, 1).toString() + "','"
                                + tabMode2.getValueAt(i, 2).toString() + "','" + tabMode2.getValueAt(i, 3).toString()
                                + "','" + tabMode2.getValueAt(i, 4).toString() + "','"
                                + tabMode2.getValueAt(i, 5).toString() + "','" + tabMode2.getValueAt(i, 6).toString()
                                + "','" + tabMode2.getValueAt(i, 7).toString() + "','"
                                + tabMode2.getValueAt(i, 8).toString() + "','" + tglsampel + "','"
                                + tabMode2.getValueAt(i, 10).toString() + "','" + tglhasil + "','"
                                + tabMode2.getValueAt(i, 12).toString() + "','" + tabMode2.getValueAt(i, 13).toString()
                                + "','" + tabMode2.getValueAt(i, 14).toString() + "','"
                                + tabMode2.getValueAt(i, 15).toString() + "','" + tabMode2.getValueAt(i, 16).toString()
                                + "','" + tabMode2.getValueAt(i, 17).toString() + "','"
                                + tabMode2.getValueAt(i, 18).toString() + "','" + tabMode2.getValueAt(i, 19).toString()
                                + "','','','','','','','','','','','','','','','','',''", "Periksa Lab");
                    }
            ...
            if (TabRawatInap.getSelectedIndex() == 0) {
                if (tabMode3.getRowCount() == 0) {
                    ...
                    for (i = 0; i < row; i++) {
                        ...
                        Sequel.menyimpan("temporary_permintaan_lab", "'0','" + tabMode3.getValueAt(i, 0).toString()
                                + "','" + tabMode3.getValueAt(i, 1).toString() + "','"
                                + tabMode3.getValueAt(i, 2).toString() + "','" + tabMode3.getValueAt(i, 3).toString()
                                + "','" + tabMode3.getValueAt(i, 4).toString() + "','" + tglsampel + "','"
                                + tabMode3.getValueAt(i, 6).toString() + "','" + tglhasil + "','"
                                + tabMode3.getValueAt(i, 8).toString() + "','" + tabMode3.getValueAt(i, 9).toString()
                                + "','" + tabMode3.getValueAt(i, 10).toString() + "','"
                                + tabMode3.getValueAt(i, 11).toString() + "','" + tabMode3.getValueAt(i, 12).toString()
                                + "','" + tabMode3.getValueAt(i, 13).toString() + "','"
                                + tabMode3.getValueAt(i, 14).toString() + "','" + tabMode3.getValueAt(i, 15).toString()
                                + "','','','','','','','','','','','','','','','','','','','','',''", "Periksa Lab");
                    }
                    ...
                    param.put("emailrs", akses.getemailrs());
                    param.put("logo", Sequel.cariGambar("select logo from setting"));
                    Valid.MyReport("rptLapPermintaanLab3.jasper", "report", "::[ Data Permintaan Laboratorium ]::",
                            param);
                }
                ...
                if (tabMode4.getRowCount() == 0) {
                    ...
                    for (i = 0; i < row; i++) {
                        ...
                        Sequel.menyimpan("temporary_permintaan_lab", "'0','" + tabMode4.getValueAt(i, 0).toString()
                                + "','" + tabMode4.getValueAt(i, 1).toString() + "','"
                                + tabMode4.getValueAt(i, 2).toString() + "','" + tabMode4.getValueAt(i, 3).toString()
                                + "','" + tabMode4.getValueAt(i, 4).toString() + "','"
                                + tabMode4.getValueAt(i, 5).toString() + "','" + tabMode4.getValueAt(i, 6).toString()
                                + "','" + tabMode4.getValueAt(i, 7).toString() + "','"
                                + tabMode4.getValueAt(i, 8).toString() + "','" + tglsampel + "','"
                                + tabMode4.getValueAt(i, 10).toString() + "','" + tglhasil + "','"
                                + tabMode4.getValueAt(i, 12).toString() + "','" + tabMode4.getValueAt(i, 13).toString()
                                + "','" + tabMode4.getValueAt(i, 14).toString() + "','"
                                + tabMode4.getValueAt(i, 15).toString() + "','" + tabMode4.getValueAt(i, 16).toString()
                                + "','" + tabMode4.getValueAt(i, 17).toString() + "','"
                                + tabMode4.getValueAt(i, 18).toString() + "','" + tabMode4.getValueAt(i, 19).toString()
                                + "','','','','','','','','','','','','','','','','',''", "Periksa Lab");
                    }
            ...
            if (!NoRawat.equals("")) {
                ...
                if (NoPermintaan.trim().equals("")) {
                        ...
                        try {
                            ...
                            while (rs2.next()) {
                                Sequel.menyimpan("temporary_permintaan_lab",
                                        "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",
                                        38,
                                        new String[] { "0", rs2.getString("nm_perawatan"), "", "", "", "", "", "", "",
                                                "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "",
                                                "", "", "", "", "", "", "", "", "", "", "" });
                                ...
                                try {
                                    ...
                                    while (rs3.next()) {
                                        ...
                                        Sequel.menyimpan("temporary_permintaan_lab",
                                                "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?",
                                                38,
                                                new String[] { "0", "  " + rs3.getString("Pemeriksaan"),
                                                        rs3.getString("satuan"), ld + la + pd + pa, "", "", "", "", "",
                                                        "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "",
                                                        "", "", "", "", "", "", "", "", "", "", "", "", "" });
                                    }
                                } catch (Exception e) {
                    ...
                    param.put("lahir", Sequel.cariIsi(
                            "select DATE_FORMAT(tgl_lahir,'%d-%m-%Y') from pasien where no_rkm_medis=? ", norm));
        ...
        if (TabPilihRawat.getSelectedIndex() == 0) {
            if (!NoRawat.equals("")) {
                if (NoPermintaan.trim().equals("")) {
                    ...
                    if (Sequel.mengedittf("permintaan_lab", "noorder=?", "tgl_sampel=?,jam_sampel=?", 3,
                            new String[] { Valid.SetTgl(TanggalPulang.getSelectedItem() + ""),
                        ...
                        pilihan = (String) JOptionPane.showInputDialog(null,
                                ...
                                new Object[] { "Tidak Ada", "Barcode No.Permintaan 1", "Barcode No.Permintaan 2",
                                        "Lembar Permintaan Lab", "Lembar Permintaan Lab & Barcode No.Permintaan 1",
                    ...
                    try {
                        ...
                        try {
                            ...
                            if (rs.next()) {
                                ...
                                Permintaan = "";
                                ps2 = koneksi.prepareStatement(
                                        "select kd_jenis_prw from permintaan_pemeriksaan_lab where noorder=?");
                                try {
                                    ps2.setString(1, NoPermintaan);
                                    rs2 = ps2.executeQuery();
                                    while (rs2.next()) {
                                ...
                                koneksisysmex.prepareStatement("insert into LIS_ORDER values('0',now(),'NW','"
                                        + rs.getString("no_rkm_medis") + "','" + rs.getString("nm_pasien") + "'," + "'"
                                        + rs.getString("alamat") + "','" + rs.getString("nm_kel") + "','"
                                        + rs.getString("nm_kec") + "','" + rs.getString("nm_kab") + "'," + "'OP','"
                                        + rs.getString("tgl_lahir") + "','" + rs.getString("jk") + "','"
                                        + rs.getString("noorder") + "','" + rs.getString("tgl_permintaan") + " "
                                        + rs.getString("jam_permintaan") + "'," + "'" + rs.getString("kd_poli") + "^"
                                        + rs.getString("nm_poli") + "','" + rs.getString("dokter_perujuk") + "^"
                                        + rs.getString("nm_dokter") + "'," + "'" + rs.getString("kd_poli") + "','"
                                        + pilihan + "','" + rs.getString("diagnosa_klinis") + "','"
                                        + rs.getString("no_rawat") + "'," + "'" + Permintaan + "','0')")
                                        .executeUpdate();

                                Permintaan = "";
                                ps2 = koneksi.prepareStatement(
                                        "select id_template from permintaan_detail_permintaan_lab where noorder=?");
                                try {
                                    ps2.setString(1, NoPermintaan);
                                    rs2 = ps2.executeQuery();
                                    while (rs2.next()) {
                                ...
                                koneksisysmex.prepareStatement("insert into LIS_ORDER_DETAIL values('0',now(),'NW','"
                                        + rs.getString("no_rkm_medis") + "','" + rs.getString("nm_pasien") + "'," + "'"
                                        + rs.getString("alamat") + "','" + rs.getString("nm_kel") + "','"
                                        + rs.getString("nm_kec") + "','" + rs.getString("nm_kab") + "'," + "'OP','"
                                        + rs.getString("tgl_lahir") + "','" + rs.getString("jk") + "','"
                ...
                if (NoPermintaan.trim().equals("")) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            rs = ps.executeQuery();
                            if (rs.next()) {
                                koneksielims.prepareStatement("insert into permintaan_lab values('"
                                        + rs.getString("noorder") + "','" + rs.getString("no_rawat") + "','"
                                        + rs.getString("no_rkm_medis") + "'," + "'" + rs.getString("nm_pasien") + "','"
                                        + rs.getString("email") + "','" + rs.getString("jk") + "','"
                                        + rs.getString("tmp_lahir") + "','" + rs.getString("tgl_lahir") + "'," + "'"
                                        + rs.getString("alamat") + ", " + rs.getString("nm_kel") + ", "
                                        + rs.getString("nm_kec") + ", " + rs.getString("nm_kab") + ", "
                                        + rs.getString("nm_prop") + "'," + "'" + rs.getString("tgl_permintaan") + "','"
                                        + rs.getString("jam_permintaan") + "','" + rs.getString("dokter_perujuk")
                                        ...
                                        + rs.getString("informasi_tambahan") + "','" + rs.getString("diagnosa_klinis")
                                        + "')").executeUpdate();
                                ps2 = koneksi.prepareStatement(
                                ...
                                try {
                                    ...
                                    rs2 = ps2.executeQuery();
                                    while (rs2.next()) {
                                        koneksielims.prepareStatement("insert into detail_permintaan_lab values('"
                                                + rs2.getString("noorder") + "','" + rs2.getString("kd_jenis_prw")
                                                + "','" + rs2.getString("id_template") + "')").executeUpdate();
                                    }
                                } catch (Exception e) {
                                    System.out.println("Notif : " + e);
                                } finally {
