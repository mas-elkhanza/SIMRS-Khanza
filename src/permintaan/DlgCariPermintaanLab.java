    ...
    private void tampil2() {
        ...
        try {
            ...
            ps = koneksi.prepareStatement(
                    ...
                    + "left join permintaan_detail_permintaan_lab on permintaan_lab.noorder=permintaan_detail_permintaan_lab.noorder "
...
//                    }
                ...
                System.out.println("Notif : " + e);
                Logger.getLogger(DlgCariPermintaanLab.class.getName()).log(Level.SEVERE, null, e);
            } finally {
                if (rs != null) {
                    rs.close();
                }
    ...
    private void tampil4() {
        ...
        try {
            ...
            ps = koneksi.prepareStatement(
                    ...
                    + "inner join bangsal on kamar.kd_bangsal=bangsal.kd_bangsal "
                    + "inner join jns_perawatan_lab on jns_perawatan_lab.kd_jenis_prw=permintaan_pemeriksaan_lab.kd_jenis_prw "
                    + "LEFT join permintaan_detail_permintaan_lab on permintaan_lab.noorder=permintaan_detail_permintaan_lab.noorder and permintaan_detail_permintaan_lab.kd_jenis_prw=permintaan_pemeriksaan_lab.kd_jenis_prw  "
                    + "LEFT join template_laboratorium on template_laboratorium.id_template=permintaan_detail_permintaan_lab.id_template "
                    + "inner join dokter on permintaan_lab.dokter_perujuk=dokter.kd_dokter  "
                    + "inner join penjab on reg_periksa.kd_pj=penjab.kd_pj "
                    + "where permintaan_lab.status='ranap' and permintaan_lab.tgl_permintaan between ? and ? "
