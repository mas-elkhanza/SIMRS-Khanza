...
public class TokoCariReturJual extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Cari Retur Barang Toko / Minimarket / Koperasi Dari Pembeli ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
          ...
          try {
             ...
             try {
                ...
                if(rs.next()){
                    ...
                    jur.simpanJurnal(rs.getString("no_retur_jual"),Sequel.cariIsi("select current_date()"),"U","BATAL TRANSAKSI RETUR BELI TOKO"+", OLEH "+akses.getkode());
                    ...
                    try {
                        ...
                        while(rs2.next()){
                            ...
                            tabMode.addRow(new Object[]{
                                i+". "+rs2.getString("kode_brng"),rs2.getString("nama_brng"),"No. Faktur : "+rs2.getString("nota_jual"),rs2.getString("satuan"),rs2.getString("jml_retur"),Valid.SetAngka(rs2.getDouble("h_retur")),Valid.SetAngka(rs2.getDouble("total"))
                            });
                            i++;
                        }                        
                    } catch (Exception e) {
