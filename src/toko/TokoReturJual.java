...
public class TokoReturJual extends javax.swing.JDialog {
    ...
    private String Retur_Jual_Toko=Sequel.cariIsi("select Retur_Jual_Toko from set_akun"),Kontra_Retur_Jual_Toko=Sequel.cariIsi("select Kontra_Retur_Jual_Toko from set_akun");
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Transaksi Retur Barang Toko / Minimarket / Koperasi Dari Pembeli ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        if(NoRetur.getText().trim().equals("")){
            ...
            if (reply == JOptionPane.YES_OPTION) {
                ...
                if(sukses==true){
                    ...
                    sukses=jur.simpanJurnal(NoRetur.getText(),Valid.SetTgl(TglRetur.getSelectedItem()+""),"U","RETUR PENJUALAN TOKO"+", OLEH "+akses.getkode());
                }
