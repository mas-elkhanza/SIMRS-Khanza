...
public final class akses {
    ...
    private static boolean aktif=false,admin=false,user=false,vakum=false,aplikasi=false,penyakit=false,obat_penyakit=false,dokter=false,jadwal_praktek=false,petugas=false,pasien=false,registrasi=false,
            ...
            satu_sehat_mapping_radiologi=false,satu_sehat_kirim_service_request_radiologi=false;
        ...
        try {        
                ...
                try {
                    ...
                    if(rs.getRow()>=1){
                        ...
                        akses.satu_sehat_kirim_service_request_radiologi=true;
                        ...
                        akses.satu_sehat_kirim_service_request_radiologi=rs2.getBoolean("satu_sehat_kirim_service_request_radiologi");
                        ...
                        akses.satu_sehat_kirim_service_request_radiologi=false;
                    }
                } catch (Exception e) {
    ...
    public static boolean getsatu_sehat_kirim_service_request_radiologi(){return akses.satu_sehat_kirim_service_request_radiologi;}
}   
