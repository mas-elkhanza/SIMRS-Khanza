        ...
        try{
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    jmll=Sequel.cariIsiAngka("select count(jnj_jabatan.kode) from pegawai inner join jnj_jabatan "+
                    ...
                    jmlp=Sequel.cariIsiAngka("select count(jnj_jabatan.kode) from pegawai inner join jnj_jabatan "+
