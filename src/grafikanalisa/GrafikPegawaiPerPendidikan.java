        ...
        try{
            ...
            try {
                ...
                while(rs.next()){
                    ...
                    jmll=Sequel.cariIsiAngka("select count(pegawai.pendidikan) from pegawai where pegawai.jk='Pria' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') and pegawai.pendidikan=?",rs.getString(1));
                    jmlp=Sequel.cariIsiAngka("select count(pegawai.pendidikan) from pegawai where pegawai.jk='Wanita' and (pegawai.stts_aktif='AKTIF' or pegawai.stts_aktif='CUTI') and pegawai.pendidikan=?",rs.getString(1));
                    totall=totall+jmll;
                    totalp=totalp+jmlp;
