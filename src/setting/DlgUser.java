        ...
        if(TKd.getText().trim().equals("")||TNmUser.getText().trim().equals("")){
            ...
            if(i!= -1){
                if(Sequel.mengedittf("user","id_user=AES_ENCRYPT('"+tbUser.getValueAt(i,0).toString()+"','nur')",
                    ...
                    "rujuk_edukasi_berkelanjutan='"+tbUser.getValueAt(i,1157).toString()+","+
                    "permintaan_pengujian_sampel_lab_kesehatan_lingkungan='"+tbUser.getValueAt(i,1158).toString()+"'")==true){
                    emptTeks();
                }
            }         
        }
                            ...
                            try {
                                ...
                                if(i!= -1){
                                    Sequel.mengedit("user","id_user=AES_ENCRYPT('"+tbUser.getValueAt(i,0).toString()+"','nur')",
                                        ...
                                        "rujuk_edukasi_berkelanjutan='"+tbUser.getValueAt(barisdicopy,1157).toString()+","+        
                                        "permintaan_pengujian_sampel_lab_kesehatan_lingkungan='"+tbUser.getValueAt(barisdicopy,1158).toString()+"'");
                                }
                                userdicopy="";
                                copyhakakses="";
                                barisdicopy=-1;
                ...
                new SwingWorker<Void, Void>() {
                    ...
                    protected Void doInBackground() throws Exception {
                        ps=koneksi.prepareStatement(
                            ...
                            "user.rujuk_edukasi_berkelanjutan," +
                            "user.permintaan_pengujian_sampel_lab_kesehatan_lingkungan from user order by AES_DECRYPT(user.id_user,'nur')");
                        try {
                            rs=ps.executeQuery();
                            i=0;
                            while(rs.next()){
                                ...
                                try {
                                    if(rs.getString(1).toLowerCase().contains(TCari.getText().toLowerCase())||
                                        ...
                                        Object[] row = new Object[]{rs.getString(1),
                                           ...
                                           rs.getBoolean("rujuk_edukasi_berkelanjutan"),
