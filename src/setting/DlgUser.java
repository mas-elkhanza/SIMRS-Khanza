...
public class DlgUser extends javax.swing.JDialog {
    ...
    public DlgUser(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"ID User","Nama User","Jabatan","Password","[I]ICD 10","[I]Obat Penyakit","[C]Dokter","[A]Jadwal Praktek","[C]Petugas","[L]Pasien","[A]Registrasi","[A]Tindakan Ralan",
                    ...
                    "[L]Monitoring Asuhan Gizi","[N]Penerimaan Obat, Alkes & BHP Per Bulan","[I]Rekap Kunjungan","[O]Surat Keterangan Sakit"
        };
    ...
    private void initComponents() {
        ...
        tbUser.setToolTipText("Silakan klik untuk memilih data yang hendak diedit ataupun dihapus");
...
private void BtnPrintKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnPrintKeyPressed
    ...
    private void MnCopyHakAksesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCopyHakAksesActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            JOptionPane.showMessageDialog(null,"Maaf, Silakan anda pilih dulu data user yang hendak dicopy hak aksesnya...!!!");
            tbUser.requestFocus();
        }else{
            copyhakakses="copy";
            ...
            JOptionPane.showMessageDialog(null,"Silakan pilih user tujuan..!!");
        }
    ...
    private void tampil() {
        try{
            ...
            ps=koneksi.prepareStatement("select AES_DECRYPT(id_user,'nur'),AES_DECRYPT(password,'windi'),"+
                        ...
                        "penerimaan_obat_perbulan,rekap_kunjungan,surat_sakit from user order by AES_DECRYPT(id_user,'nur')");
            try {
                rs=ps.executeQuery();
                while(rs.next()){
                    user="";
