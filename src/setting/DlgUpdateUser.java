    ...
    */
    ...
    private void tampil(String user) {        
        try{    
            ...
            ps=koneksi.prepareStatement("select penyakit, obat_penyakit, dokter, jadwal_praktek, petugas, pasien, registrasi, tindakan_ralan,"+
                        ...
                        "konten_epasien from user where id_user=AES_ENCRYPT(?,'nur')");
            try {
                ps.setString(1,user);
                rs=ps.executeQuery();
                while(rs.next()){
                    ...
                    if("[L]Penilaian Awal Keperawatan Kebidanan".toLowerCase().contains(TCari.getText().toLowerCase())){
                        tabMode.addRow(new Object[]{false,"[L]Penilaian Awal Keperawatan Kebidanan",rs.getBoolean("penilaian_awal_keperawatan_kebidanan")});
                    }
                    ...
                    if("[O]Konten E-Pasien".toLowerCase().contains(TCari.getText().toLowerCase())){
                        tabMode.addRow(new Object[]{false,"[O]Konten E-Pasien",rs.getBoolean("konten_epasien")});
                    }
    ...
    private void Simpan2() {
        for(i=0;i<tbUser.getRowCount();i++){ 
            ...
            if("[L]Penilaian Awal Keperawatan Kebidanan".equals(tbUser.getValueAt(i,1).toString())){
            ...
            if("[O]Konten E-Pasien".equals(tbUser.getValueAt(i,1).toString())){
                Sequel.mengedit("user","id_user=AES_ENCRYPT('"+TKd.getText()+"','nur')","konten_epasien='"+tbUser.getValueAt(i,2).toString()+"'");
            }
