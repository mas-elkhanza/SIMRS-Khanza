...
*/
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            Valid.MyReportqry("rptRingkasanPenerimaanDapur.jasper","report","::[ Laporan Ringkasan Penerimaan Barang Dapur ]::",
                    "select dapurdetailpesan.kode_brng,dapurbarang.nama_brng,dapurjenisbarang.nm_jenis as namajenis, "+
                    "dapurdetailpesan.kode_sat,kodesatuan.satuan,sum(dapurdetailpesan.jumlah) as jumlah,sum(dapurdetailpesan.total) as total "+
                    " from dapurpemesanan inner join dapursuplier inner join petugas  "+
                    " inner join dapurdetailpesan inner join dapurbarang inner join kodesatuan "+
                    " inner join dapurjenisbarang "+
                    " on dapurdetailpesan.kode_brng=dapurbarang.kode_brng "+
                    " and dapurdetailpesan.kode_sat=kodesatuan.kode_sat "+
                    " and dapurpemesanan.no_faktur=dapurdetailpesan.no_faktur "+
                    " and dapurpemesanan.kode_suplier=dapursuplier.kode_suplier "+
                    " and dapurpemesanan.nip=petugas.nip and dapurbarang.jenis=dapurjenisbarang.kd_jenis "+
                    " where dapurpemesanan.tgl_pesan between '"+Valid.SetTgl(TglBeli1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(TglBeli2.getSelectedItem()+"")+"' and dapurpemesanan.no_faktur like '%"+NoFaktur.getText()+"%' and dapursuplier.nama_suplier like '%"+nmsup.getText()+"%' and petugas.nama like '%"+nmptg.getText()+"%'  and dapurbarang.jenis like '%"+Jenis.getSelectedItem().toString().replaceAll("Semua","")+"%' and dapurbarang.nama_brng like '%"+nmbar.getText()+"%' and dapurpemesanan.no_faktur like '%"+TCari.getText()+"%' or "+
                    ...
                    " dapurpemesanan.tgl_pesan between '"+Valid.SetTgl(TglBeli1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(TglBeli2.getSelectedItem()+"")+"' and dapurpemesanan.no_faktur like '%"+NoFaktur.getText()+"%' and dapursuplier.nama_suplier like '%"+nmsup.getText()+"%' and petugas.nama like '%"+nmptg.getText()+"%'  and dapurbarang.jenis like '%"+Jenis.getSelectedItem().toString().replaceAll("Semua","")+"%' and dapurbarang.nama_brng like '%"+nmbar.getText()+"%' and dapurjenisbarang.nm_jenis like '%"+TCari.getText()+"%' "+
    ...
    private void MnKategoriAscActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnKategoriAscActionPerformed
        order="order by dapurjenisbarang.nm_jenis desc";
        tampil();
    ...
    private void MnKategoriDescActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnKategoriDescActionPerformed
        order="order by dapurjenisbarang.nm_jenis asc";
        tampil();
       ...
       Valid.tabelKosong(tabMode);
        try{   
            ...
            ps=koneksi.prepareStatement(
                    ...
                    "dapurpemesanan.tgl_pesan between ? and ? and dapurpemesanan.no_faktur like ? and dapursuplier.nama_suplier like ? and petugas.nama like ?  and dapurjenisbarang.nm_jenis like ? and dapurbarang.nama_brng like ? "+
                    ...
                    "dapurpemesanan.no_order like ? or dapurjenisbarang.nm_jenis like ?) ")+"group by dapurdetailpesan.kode_brng "+order);
            try {
