        ...
        if(tabMode.getRowCount()==0){
            ...
            if(nmbar.getText().trim().equals("")&&TCari.getText().trim().equals("")){
                ...
                Valid.MyReportqry("rptRiwayatBarangDapur.jasper","report","::[ Riwayat Barang Dapur Kering & Basah ]::",
                    ...
                    "dapur_riwayat_barang.status from dapur_riwayat_barang "+
                    "inner join dapurbarang on dapur_riwayat_barang.kode_brng=dapurbarang.kode_brng where "+
                    "dapur_riwayat_barang.tanggal between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' and dapurbarang.nama_brng like '%"+nmbar.getText()+"%' and dapur_riwayat_barang.kode_brng like '%"+TCari.getText().trim()+"%' or "+
                    "dapur_riwayat_barang.tanggal between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' and dapurbarang.nama_brng like '%"+nmbar.getText()+"%' and dapurbarang.nama_brng like '%"+TCari.getText().trim()+"%' or "+
                    "dapur_riwayat_barang.tanggal between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' and dapurbarang.nama_brng like '%"+nmbar.getText()+"%' and dapur_riwayat_barang.petugas like '%"+TCari.getText().trim()+"%' or "+
                    "dapur_riwayat_barang.tanggal between '"+Valid.SetTgl(Tgl1.getSelectedItem()+"")+"' and '"+Valid.SetTgl(Tgl2.getSelectedItem()+"")+"' and dapurbarang.nama_brng like '%"+nmbar.getText()+"%' and dapur_riwayat_barang.status like '%"+TCari.getText().trim()+"%' "+
                    "order by dapur_riwayat_barang.tanggal,dapur_riwayat_barang.jam ",param);
            }
       ...
       try{   
            if(nmbar.getText().trim().equals("")&&TCari.getText().trim().equals("")){
                ...
                ps=koneksi.prepareStatement(
                    ...
                    "dapur_riwayat_barang.status from dapur_riwayat_barang "+
                    "inner join dapurbarang on dapur_riwayat_barang.kode_brng=dapurbarang.kode_brng where "+
                    "dapur_riwayat_barang.tanggal between ? and ? and dapurbarang.nama_brng like ? and dapur_riwayat_barang.kode_brng like ? or "+
                    "dapur_riwayat_barang.tanggal between ? and ? and dapurbarang.nama_brng like ? and dapurbarang.nama_brng like ? or "+
                    "dapur_riwayat_barang.tanggal between ? and ? and dapurbarang.nama_brng like ? and dapur_riwayat_barang.petugas like ? or "+
                    "dapur_riwayat_barang.tanggal between ? and ? and dapurbarang.nama_brng like ? and dapur_riwayat_barang.status like ? order by dapur_riwayat_barang.tanggal,dapur_riwayat_barang.jam ");
            }
