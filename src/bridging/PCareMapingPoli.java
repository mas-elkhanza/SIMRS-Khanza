...
public final class PCareMapingPoli extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Mapping Poli/Unit PCare ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(130, 100, 100))); // NOI18N
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        ...
        if(tabMode.getRowCount()==0){
            ...
            BtnBatal.requestFocus();
                ...
                Valid.MyReport("rptMapingPoliPCare.jrxml","report","::[ Mapping Poli RS & PCare ]::",
...
private void btnPoliBPJSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPoliBPJSActionPerformed
    ...
    */
    ...
    public void isCek(){
        BtnSimpan.setEnabled(var.getpcare_mapping_poli());
        BtnHapus.setEnabled(var.getpcare_mapping_poli());
        BtnEdit.setEnabled(var.getpcare_mapping_poli());
        BtnPrint.setEnabled(var.getpcare_mapping_poli());
    }
