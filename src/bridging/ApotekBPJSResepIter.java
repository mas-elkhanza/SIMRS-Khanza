 ...
 * @author dosen
 */
public final class ApotekBPJSResepIter extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public ApotekBPJSResepIter(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            ApotekBPJSResepIter dialog = new ApotekBPJSResepIter(new javax.swing.JFrame(), true);
