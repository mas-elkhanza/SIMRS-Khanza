...
public final class YaskiReferensiPropinsi extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 253, 247)), "::[ Pencarian Data Referensi Propinsi YASKI ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
    ...
    */
    ...
    public void tampil(String poli) {
        try {
            ...
            if(poli.trim().equals("")){
                root = mapper.readTree(rest.exchange("http://yaski.or.id:8888/provinsi", HttpMethod.GET, requestEntity, String.class).getBody());
            }else{
                root = mapper.readTree(rest.exchange("http://yaski.or.id:8888/provinsi/?search="+poli, HttpMethod.GET, requestEntity, String.class).getBody());
            }
                ...
                if(response.isArray()){
                    ...
                    for(JsonNode list:response){
                        tabMode.addRow(new Object[]{
                            i+".",list.path("id_prov").asText(),list.path("nama").asText()
                        });
                        i++;
                    }
                }
