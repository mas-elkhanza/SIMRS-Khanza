...
public class DlgSirkulasiBarang3 extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        ppGrafikJualBanyak.setForeground(new java.awt.Color(110,80,80));
        ...
        ppGrafikJualDikit.setForeground(new java.awt.Color(110,80,80));
        ...
        ppGrafikbeliBanyak.setForeground(new java.awt.Color(110,80,80));
        ...
        ppGrafikbelidikit.setForeground(new java.awt.Color(110,80,80));
        ...
        ppGrafikPiutangBanyak.setForeground(new java.awt.Color(110,80,80));
        ...
        ppGrafikPiutangDikit.setForeground(new java.awt.Color(110,80,80));
        ...
        ppGrafikResepPaliingBanyak.setForeground(new java.awt.Color(110,80,80));
        ...
        ppGrafikResepPaliingSedikit.setForeground(new java.awt.Color(110,80,80));
        ...
        ppLokasi.setForeground(new java.awt.Color(110,80,80));
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Sirkulasi Obat, Alkes & BHP Medis Keluar Masuk ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(110,80,80))); // NOI18N
        ...
        if(tabMode.getRowCount()==0){
            ...
            for(int i=0;i<row;i++){  
                Sequel.menyimpan("temporary","'0','"+
                                ...
                                tabMode.getValueAt(i,26).toString()+"','','','','','','','','','',''","Sirkulasi Barang Keluar Masuk"); 
            }
