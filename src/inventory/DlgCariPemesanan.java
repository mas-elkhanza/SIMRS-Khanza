...
public class DlgCariPemesanan extends javax.swing.JDialog {
    ...
    private PreparedStatement ps, ps2, pscaripesan, psdetailpesan, ps3;
    ...
    private void initComponents() {
        ...
        tabPane1.addTab("Penerimaan Obat", panelGlass1);
...
//                tgl = " mutasibarang.tanggal between '" + Valid.SetTgl(TglBeli1.getSelectedItem() + "") + " 00:00:00' and '" + Valid.SetTgl(TglBeli2.getSelectedItem() + "") + " 23:59:59' and concat(databarang.kdjns,jenis.nama) like '%" + kdjenis.getText() + nmjns.getText().trim() + "%' and concat(databarang.kode_kategori,kategori_barang.nama) like '%" + kdkategori.getText() + nmkategori.getText().trim() + "%' and concat(databarang.kode_golongan,golongan_barang.nama) like '%" + kdgolongan.getText() + nmgolongan.getText().trim() + "%' ";
                ps3 = koneksi.prepareStatement(
                        ...
                        + "FROM `pemesanan` join detailpesan on detailpesan.no_faktur=pemesanan.no_faktur join bangsal on bangsal.kd_bangsal = pemesanan.kd_bangsal join databarang on databarang.kode_brng = detailpesan.kode_brng inner join jenis on databarang.kdjns=jenis.kdjns inner join datasuplier on  pemesanan.kode_suplier=datasuplier.kode_suplier "
                        + "where "
                        + " bangsal.nm_bangsal  like '%" + nmBangsal1.getText() + "%' and pemesanan.tgl_faktur between '" + Valid.SetTgl(TglBeli1.getSelectedItem() + "") + " 00:00:00' and '" + Valid.SetTgl(TglBeli2.getSelectedItem() + "") + " 23:59:59' and jenis.kdjns like '%" + kdjenis.getText() + "%' and pemesanan.kode_suplier ='"+kdsup.getText()+"' and pemesanan.no_faktur like '%" + TCari.getText() + "%' or "
                        + " bangsal.nm_bangsal  like '%" + nmBangsal1.getText() + "%' and pemesanan.tgl_faktur between '" + Valid.SetTgl(TglBeli1.getSelectedItem() + "") + " 00:00:00' and '" + Valid.SetTgl(TglBeli2.getSelectedItem() + "") + " 23:59:59' and jenis.kdjns like '%" + kdjenis.getText() + "%' and pemesanan.kode_suplier ='"+kdsup.getText()+"' and detailpesan.kode_brng like '%" + TCari.getText() + "%' or "
                        + " bangsal.nm_bangsal  like '%" + nmBangsal1.getText() + "%' and pemesanan.tgl_faktur between '" + Valid.SetTgl(TglBeli1.getSelectedItem() + "") + " 00:00:00' and '" + Valid.SetTgl(TglBeli2.getSelectedItem() + "") + " 23:59:59' and jenis.kdjns like '%" + kdjenis.getText() + "%' and pemesanan.kode_suplier ='"+kdsup.getText()+"' and databarang.nama_brng like '%" + TCari.getText() + "%' or "
                        + " bangsal.nm_bangsal  like '%" + nmBangsal1.getText() + "%' and pemesanan.tgl_faktur between '" + Valid.SetTgl(TglBeli1.getSelectedItem() + "") + " 00:00:00' and '" + Valid.SetTgl(TglBeli2.getSelectedItem() + "") + " 23:59:59' and jenis.kdjns like '%" + kdjenis.getText() + "%' and pemesanan.kode_suplier ='"+kdsup.getText()+"' and detailpesan.kode_sat like '%" + TCari.getText() + "%' or "
                        + " bangsal.nm_bangsal  like '%" + nmBangsal1.getText() + "%' and pemesanan.tgl_faktur between '" + Valid.SetTgl(TglBeli1.getSelectedItem() + "") + " 00:00:00' and '" + Valid.SetTgl(TglBeli2.getSelectedItem() + "") + " 23:59:59' and jenis.kdjns like '%" + kdjenis.getText() + "%' and pemesanan.kode_suplier ='"+kdsup.getText()+"' and bangsal.nm_bangsal like '%" + TCari.getText() + "%' "
                        + "group by detailpesan.kode_brng"
                );
            }
