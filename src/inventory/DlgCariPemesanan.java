...
public class DlgCariPemesanan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Cari Penerimaan Obat, Alkes & BHP Medis ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(160,130,130))); // NOI18N
  ...
  if(!tbDokter.getValueAt(tbDokter.getSelectedRow(),10).toString().trim().equals("")){
    ...
    private void ppBayarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBayarActionPerformed
        if(!tbDokter.getValueAt(tbDokter.getSelectedRow(),10).toString().trim().equals("")){
            ...
            bayarpesan.tampil();
            bayarpesan.isCek();
            bayarpesan.setSize(internalFrame1.getWidth()-40,internalFrame1.getHeight()-40);
    ...
    private void ppUbahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppUbahActionPerformed
        if(!tbDokter.getValueAt(tbDokter.getSelectedRow(),10).toString().trim().equals("")){
            ...
            ubahpesan.setSize(internalFrame1.getWidth()-40,internalFrame1.getHeight()-40);
