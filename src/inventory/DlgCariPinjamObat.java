...
public class DlgCariPinjamObat extends javax.swing.JDialog {
    ...
    private PreparedStatement ps, ps2, pscaripesan, psdetailpinjamobat, ps3;
    ...
    private void initComponents() {
        ...
        ppUbah.setText("Ubah Peminjaman");
...
private void ppHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppHapusActionPerformed
    if (!tbDokter.getValueAt(tbDokter.getSelectedRow(), 10).toString().trim().equals("")) {
        ...
        if (reply == JOptionPane.YES_OPTION) {
            try {
                pscaripesan = koneksi.prepareStatement("select no_faktur, tagihan, kd_bangsal,tgl_faktur,status from pinjam_obat where no_faktur=?");
                try {
                    ...
                    if (rs.next()) {
                        ...
                        sukses = true;
                        psdetailpinjamobat = koneksi.prepareStatement("select kode_brng,jumlah2,no_batch,no_faktur from detailpinjamobat where no_faktur=? ");
                        try {
...
//                ps.setString(117, "%" + TCari.getText() + "%");
                ...
                while (rs.next()) {
                    ...
                    ps2 = koneksi.prepareStatement("select detailpinjamobat.kode_brng,databarang.nama_brng, "
                            + "detailpinjamobat.kode_sat,kodesatuan.satuan,detailpinjamobat.jumlah,detailpinjamobat.h_pesan, "
                            + "detailpinjamobat.subtotal,detailpinjamobat.dis,detailpinjamobat.besardis,detailpinjamobat.total,"
                            + "detailpinjamobat.no_batch,industrifarmasi.nama_industri,detailpinjamobat.kadaluarsa "
                            ...
                            + " detailpinjamobat.no_faktur=? and jenis.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and detailpinjamobat.kode_brng like ? or "
                            + " detailpinjamobat.no_faktur=? and jenis.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and databarang.nama_brng like ? or "
                            + " detailpinjamobat.no_faktur=? and jenis.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and detailpinjamobat.kode_sat like ? or "
                            + " detailpinjamobat.no_faktur=? and jenis.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and detailpinjamobat.no_batch like ? or "
                            + " detailpinjamobat.no_faktur=? and jenis.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and industrifarmasi.nama_industri like ? or "
                            + " detailpinjamobat.no_faktur=? and jenis.nama like ? and databarang.nama_brng like ? and industrifarmasi.nama_industri like ? and jenis.nama like ? order by detailpinjamobat.kode_brng  ");
