                    ...
                    for(i=0;i<jml;i++){
                        ...
                        try {
                            if(Valid.SetAngka(tbDokter.getValueAt(i,0).toString())>0){
                                if(Sequel.menyimpantf2("detailpinjamobat","?,?,?,?,?,?,?,?,?,?,?,?","Transaksi Pinjam Obat",12,new String[]{
                                       NoFaktur.getText(),
                                    ...
                                    if(aktifkanbatch.equals("yes")){
                                        Trackobat.catatRiwayat(tbDokter.getValueAt(i,2).toString(),Valid.SetAngka(tbDokter.getValueAt(i,12).toString()),0,"Pinjam Obat",akses.getkode(),kdgudang.getText(),"Simpan",tbDokter.getValueAt(i,13).toString(),NoFaktur.getText());
                                        ...
                                        Trackobat.catatRiwayat(tbDokter.getValueAt(i,2).toString(),Valid.SetAngka(tbDokter.getValueAt(i,12).toString()),0,"Pinjam Obat",akses.getkode(),kdgudang.getText(),"Simpan","","");
