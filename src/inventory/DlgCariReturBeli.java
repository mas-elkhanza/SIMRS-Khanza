         ...
         try {
             ...
             if(rs.next()){
                ...
                if(sukses==true){
                    ...
                    sukses=jur.simpanJurnal(rs.getString(1),"U","BATAL RETUR PEMBELIAN DI "+Sequel.cariIsi("select nm_bangsal from bangsal where kd_bangsal='"+rs.getString("kd_bangsal")+"'").toUpperCase()+", OLEH "+akses.getkode());
                }
