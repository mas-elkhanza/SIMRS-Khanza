...
public class DlgRingkasanPengajuanBarangMedis extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgRingkasanPengajuanBarangMedis(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRingkasanPengajuanBarangMedis dialog = new DlgRingkasanPengajuanBarangMedis(new javax.swing.JFrame(), true);
