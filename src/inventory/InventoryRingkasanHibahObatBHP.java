...
public class InventoryRingkasanHibahObatBHP extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public InventoryRingkasanHibahObatBHP(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            InventoryRingkasanHibahObatBHP dialog = new InventoryRingkasanHibahObatBHP(new javax.swing.JFrame(), true);
