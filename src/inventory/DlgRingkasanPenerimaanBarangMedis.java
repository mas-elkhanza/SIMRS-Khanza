...
public class DlgRingkasanPenerimaanBarangMedis extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgRingkasanPenerimaanBarangMedis(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRingkasanPenerimaanBarangMedis dialog = new DlgRingkasanPenerimaanBarangMedis(new javax.swing.JFrame(), true);
