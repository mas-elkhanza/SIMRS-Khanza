...
public class DlgRingkasanPembelianBarangMedis extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgRingkasanPembelianBarangMedis(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgRingkasanPembelianBarangMedis dialog = new DlgRingkasanPembelianBarangMedis(new javax.swing.JFrame(), true);
