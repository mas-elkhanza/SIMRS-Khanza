            ...
            if(rs.next()){        
                ...
                if(!(rs.getString(1).length()>16)){
                    if(sukses==true){
                        ...
                        sukses=jur.simpanJurnal(rs.getString(1),"U","BATAL RETUR PENJUALAN DI "+Sequel.cariIsi("select nm_bangsal from bangsal where kd_bangsal='"+rs.getString("kd_bangsal")+"'").toUpperCase()+", OLEH "+akses.getkode());
                    }
                }
