...
public final class DlgAuditPenempatanPasien extends javax.swing.JDialog {
    ...
    private double audit1=0,audit2=0,audit3=0,audit4=0,audit5=0,audit6=0,audit7=0,audit8=0,audit9=0,pembagi=0,
                   naaudit1=0,naaudit2=0,naaudit3=0,naaudit4=0,naaudit5=0,naaudit6=0,naaudit7=0,naaudit8=0,naaudit9=0,
                   ttlaudit1=0,ttlaudit2=0,ttlaudit3=0,ttlaudit4=0,ttlaudit5=0,ttlaudit6=0,ttlaudit7=0,ttlaudit8=0,ttlaudit9=0,ttlpenilaian=0;
    ...
    private void initComponents() {
        ...
        Audit9.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ya", "Tidak", "NA" }));
    ...
    private void tampil() {
        ...
        try{
            ...
            try {
                ...
                while(rs.next()){
                    pembagi=0;
                    audit1=0;audit2=0;audit3=0;audit4=0;audit5=0;audit6=0;audit7=0;audit8=0;audit9=0;
                    ...
                    if(!rs.getString("audit9").equals("NA")){
                    ...
                    ttlpenilaian=ttlpenilaian+(((audit1+audit2+audit3+audit4+audit5+audit6+audit7+audit8+audit9)/pembagi)*100);
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString("audit9"),Math.round(((audit1+audit2+audit3+audit4+audit5+audit6+audit7+audit8+audit9)/pembagi)*100)+" %"
                    });
                    i++;
                }
                i=i-1;
                if(i>0){
                    tabMode.addRow(new Object[]{
                        "","NA",":",""+naaudit1,""+naaudit2,""+naaudit3,""+naaudit4,""+naaudit5,""+naaudit6,""+naaudit7,""+naaudit8,""+naaudit9,""+(naaudit1+naaudit2+naaudit3+naaudit4+naaudit5+naaudit6+naaudit7+naaudit8+naaudit9)
                    });
                    tabMode.addRow(new Object[]{
                        "","Ya",":",""+ttlaudit1,""+ttlaudit2,""+ttlaudit3,""+ttlaudit4,""+ttlaudit5,""+ttlaudit6,""+ttlaudit7,""+ttlaudit8,""+ttlaudit9,""+(ttlaudit1+ttlaudit2+ttlaudit3+ttlaudit4+ttlaudit5+ttlaudit6+ttlaudit7+ttlaudit8+ttlaudit9)
                    });
                    tabMode.addRow(new Object[]{
                        "","Tidak",":",""+(i-ttlaudit1-naaudit1),""+(i-ttlaudit2-naaudit2),""+(i-ttlaudit3-naaudit3),""+(i-ttlaudit4-naaudit4),""+(i-ttlaudit5-naaudit5),""+(i-ttlaudit6-naaudit6),""+(i-ttlaudit7-naaudit7),""+(i-ttlaudit8-naaudit8),""+(i-ttlaudit9-naaudit9),
                        ""+((i-ttlaudit1-naaudit1)+(i-ttlaudit2-naaudit2)+(i-ttlaudit3-naaudit3)+(i-ttlaudit4-naaudit4)+(i-ttlaudit5-naaudit5)+(i-ttlaudit6-naaudit6)+(i-ttlaudit7-naaudit7)+(i-ttlaudit8-naaudit8)+(i-ttlaudit9-naaudit9))
                    });
                    tabMode.addRow(new Object[]{
                        ...
                        Math.round((ttlaudit7/(i-naaudit7))*100)+" %",Math.round((ttlaudit8/(i-naaudit8))*100)+" %",Math.round((ttlaudit9/(i-naaudit9))*100)+" %",
