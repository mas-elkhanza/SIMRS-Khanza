...
<body>
    <div class="container">
        <h5 class="text-danger"><center>Pengambilan photo teman NIK : <?=$_GET['nik'];?></center></h5>
        <form method="POST" action="storeImage.php" onsubmit="return validasiIsi();" enctype=multipart/form-data>
            <div class="row">
                <div class="col-md-6">
