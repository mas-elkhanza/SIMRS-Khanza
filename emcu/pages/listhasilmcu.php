                    ...
                    foreach($kesimpulan_list as $idx => $kesimpulan_item){
                        if(!array_key_exists($kesimpulan_item, $master_anjuran_cache)){
                            ...
                            $querymasterkesimpulananjuran = bukaquery(
                                "select master_kesimpulan_anjuran_mcu.anjuran from master_kesimpulan_anjuran_mcu where master_kesimpulan_anjuran_mcu.kesimpulan='".$kesimpulan_item_aman."'"
                            );
                            $opsi_anjuran = array();
