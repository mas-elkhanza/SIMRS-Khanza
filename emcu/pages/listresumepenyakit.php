                    ...
                    <table class="table table-bordered table-striped table-hover js-basic-example dataTable" width="1650px">
                        ...
                        <?php 
                            $querypasiencari = bukaquery(
                               "select pasien.no_rkm_medis,pasien.nm_pasien,pasien.jk,reg_periksa.umurdaftar,pasien.no_ktp,pasien.tgl_lahir,pasien.nip,penilaian_mcu.tanggal,penilaian_mcu.td,penilaian_mcu.bb,penilaian_mcu.tb,reg_periksa.no_rawat ".
                               "from pasien inner join reg_periksa on reg_periksa.no_rkm_medis=pasien.no_rkm_medis inner join penilaian_mcu on reg_periksa.no_rawat=penilaian_mcu.no_rawat where pasien.perusahaan_pasien='$perusahaan' ".
