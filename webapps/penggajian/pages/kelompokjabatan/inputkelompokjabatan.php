        ...
        <form name="frm_pelatihan" onsubmit="return validasiIsi();" method="post" action="" enctype=multipart/form-data>
            ...
            <table width="100%" align="center">
                <tr class="head">
                    ...
                    <td width="67%"><input name="kode_kelompok" class="text" onkeydown="setDefault(this, document.getElementById('MsgIsi1'));" type=text id="TxtIsi1" class="inputbox" value="<?php echo $kode_kelompok;?>" size="10" maxlength="3" pattern="[a-zA-Z0-9, ./@_]{1,3}" title=" a-zA-Z0-9, ./@_ (Maksimal 3 karakter)" autocomplete="off" autofocus>
                    <span id="MsgIsi1" style="color:#CC0000; font-size:10px;"></span>
                    </td>
                </tr>
                <tr class="head">
                    <td width="31%" >Kelompok Jabatan</td><td width="">:</td>
                    <td width="67%"><input name="nama_kelompok" class="text" onkeydown="setDefault(this, document.getElementById('MsgIsi2'));" type=text id="TxtIsi2" class="inputbox" value="<?php echo $nama_kelompok;?>" size="40" maxlength="100" pattern="[a-zA-Z0-9, ./@_]{1,100}" title=" a-zA-Z0-9, ./@_ (Maksimal 100 karakter)" autocomplete="off"/>
