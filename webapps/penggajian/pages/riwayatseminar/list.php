...
<div style="width: 100%; height: 99%; overflow: auto;">
    <?php
        $_sql   = "SELECT pegawai.id,pegawai.nik,pegawai.nama,pegawai.departemen,pegawai.bidang FROM pegawai where pegawai.stts_aktif<>'KELUAR' and (pegawai.nik like '%".$keyword."%' or pegawai.nama like '%".$keyword."%') order by pegawai.id ASC ";
