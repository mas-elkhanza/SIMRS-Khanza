...
<div class="y">
<div id="post">
    <h1 class="title">::[ Set Lembur Hari Raya ]::</h1>
    ...
    <div class="entry">
        <form name="frm_aturadmin" onsubmit="return validasiIsi();" method="post" action="" enctype=multipart/form-data>
                ...
                if(mysqli_num_rows($hasil)!=0) {
                    ...
                    while($baris = mysqli_fetch_array($hasil)) {
                      echo "<tr class='isi'>
                                <td>
                                   <center>";?>
                                    <a href="?act=InputSetLemburHR&action=HAPUS&tnj=<?php print $baris[0] ?>" onClick="if (!confirm('Anda yakin menghapus set lebur hari raya ?')) return false;">[hapus]</a>
                            <?php
                            echo "</center>
                                </td>
            ...
            } else {echo "<b>Data set lebur hari raya masih kosong !</b>";}
        ?>
        </div>
        </form>
        <?php
