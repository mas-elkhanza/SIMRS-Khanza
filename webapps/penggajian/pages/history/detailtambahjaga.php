...
?>
<div id="post">
    <h1 class="title">::[ Input Detail Tambahan Jaga Tahun <?php echo$tahun ;?> Bulan <?php echo$bulan ;?> ]::</h1>
    <div class="entry">
		...
		<tr class="head">
                ...
                if(mysqli_num_rows($hasil)!=0) {
                    ...
                    while($baris = mysqli_fetch_array($hasil)) {                        
                      echo "<tr class='isi'>
                                <td width='70'>
                                    <center>"; ?>
                                    <a href="?act=InputTambahJaga&action=HAPUS&tgl=<?php print $baris[0] ?>&id=<?php print $baris[1] ?>" onClick="if (!confirm('Anda yakin menghapus data tambahan jaga <?php print $baris[2]?>?')) return false;">[hapus]</a>
                            <?php
                            echo "</center>
                                </td>
                                <td>$baris[2]</td>
            ...
            } else {echo "<b>Data tambahan jaga masih kosong !</b>";}
        ?>
        </div>
        </form>
        <?php
