    ...
    <div class="entry">
        <form name="frm_pelatihan" onsubmit="return validasiIsi();" method="post" action="" enctype=multipart/form-data>
            <?php
                ...
                $pendapatan_tuslah = validangka(str_replace("_"," ",isset($_GET['pendapatan_tuslah']))?str_replace("_"," ",$_GET['pendapatan_tuslah']):NULL);
                if($action == "TAMBAH"){
                    $pendapatan_tuslah = validangka(str_replace("_"," ",isset($_GET['pendapatan_tuslah']))?str_replace("_"," ",$_GET['pendapatan_tuslah']):NULL);
                    $persen_rs         = "";
		    $bagian_rs         = "";
		    ...
		    $bagian_kry        = "";
                    ...
                    $_sql              = "SELECT set_tuslah.pendapatan_tuslah,set_tuslah.persen_rs,set_tuslah.bagian_rs,set_tuslah.persen_kry,set_tuslah.bagian_kry FROM set_tuslah WHERE set_tuslah.tahun='$tahun' and set_tuslah.bulan='$bulan'";
                    $hasil             = bukaquery($_sql);
                    $baris             = mysqli_fetch_row($hasil);
            ...
            <table width="100%" align="center">
                <tr class="head">
                    ...
                    <td width="67%">
                        Rp.<input name="pendapatan_tuslah" class="text" onkeydown="setDefault(this, document.getElementById('MsgIsi1'));" type=text id="TxtIsi1" class="inputbox" value="<?php echo $pendapatan_tuslah;?>" size="30" maxlength="15" autofocus>
                ...
                <tr class="head">
                    ...
                    <td width="67%">
                        <input name="persen_rs" class="text" onkeydown="setDefault(this, document.getElementById('MsgIsi2'));" type=text id="TxtIsi2" class="inputbox" value="<?php echo $persen_rs;?>" size="10" maxlength="6" />%
                ...
                <tr class="head">
                    ...
                    <td width="67%">
                        <input name="persen_kry" class="text" onkeydown="setDefault(this, document.getElementById('MsgIsi3'));" type=text id="TxtIsi3" class="inputbox" value="<?php echo $persen_kry;?>" size="10" maxlength="6" />%
