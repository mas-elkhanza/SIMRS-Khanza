<?php
 ...
 $_sql="Select a.status,d.nm_poli,c.nm_pasien,a.no_rawat,a.kd_dokter from antripoli_perawat a,reg_periksa b, pasien c,poliklinik d where a.kd_poli=d.kd_poli and a.no_rawat=b.no_rawat and b.no_rkm_medis=c.no_rkm_medis and a.status='1'  and a.kd_poli!='H' ";  
...
<?php
         ...
         bukaquery2("delete from antripoli_perawat where antripoli_perawat.kd_dokter='$data[kd_dokter]' and antripoli_perawat.status='2' ");
         bukaquery2("update antripoli_perawat set antripoli_perawat.status='2' where antripoli_perawat.no_rawat='$data[no_rawat]'");
...
<?=
  getOne("Select concat(c.nm_pasien,'(',b.no_reg,')' ) from antripoli_perawat a,reg_periksa b, pasien c where a.no_rawat=b.no_rawat and b.no_rkm_medis=c.no_rkm_medis AND a.kd_dokter='$data[kd_dokter]' and a.status='2' limit 1") ;  
?></h4></div>
