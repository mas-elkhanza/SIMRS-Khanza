...
<div id="post">
	...
	<form name="frm_aturadmin" onsubmit="return validasiIsi();" method="post" action="" enctype=multipart/form-data>
            ...
            <?php
                ...
                $_sql   = 	"select bridging_sep.no_sep,bridging_sep.no_kartu,reg_periksa.no_reg,reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.jam_reg,
                            ...
                            from reg_periksa inner join bridging_sep inner join dokter inner join pasien inner join poliklinik inner join penjab 
                            on reg_periksa.no_rawat=bridging_sep.no_rawat and bridging_sep.no_kartu=pasien.no_peserta and reg_periksa.kd_dokter=dokter.kd_dokter and reg_periksa.no_rkm_medis=pasien.no_rkm_medis 
                            and reg_periksa.kd_pj=penjab.kd_pj and reg_periksa.kd_poli=poliklinik.kd_poli  where 
                            reg_periksa.status_lanjut like '%".$status."%' and poliklinik.nm_poli like '%".$poli."%' and  penjab.png_jawab like '%".$carabayar."%' and tgl_registrasi between '".$tahunawal."-".$bulanawal."-".$tanggalawal."' and '".$tahunakhir."-".$bulanakhir."-".$tanggalakhir."' and  bridging_sep.no_sep like '%".$keyword."%' or
                            reg_periksa.status_lanjut like '%".$status."%' and poliklinik.nm_poli like '%".$poli."%' and  penjab.png_jawab like '%".$carabayar."%' and tgl_registrasi between '".$tahunawal."-".$bulanawal."-".$tanggalawal."' and '".$tahunakhir."-".$bulanakhir."-".$tanggalakhir."' and  bridging_sep.no_kartu like '%".$keyword."%' or
                            ...
                            while($baris = mysqli_fetch_array($hasil)) {                        
                                echo "<tr class='isi'>
                                       ...
                                       <td bgcolor='#FFFFFF' valign='top'>
                                          <table width='100%' border='0' align='center' cellpadding='0' cellspacing='0' class='tbl_form'>
                                            <tr class='isi8'>
                                              <td width='27%'>No.SEP</td><td width='73%'>: ".getOne("select no_sep from bridging_sep where no_rawat='".$baris["no_rawat"]."'")."</td>
                                            </tr>
                                            <tr class='isi8'>
