    ...
    <div class="entry">        
        ...
        <?php
            if ($action=="HAPUS") {
                ...
                Hapus(" berkas_digital_perawatan "," no_rawat ='".validTeks($_GET['no_rawat'])."' and kode ='".validTeks($_GET['kode'])."' and lokasi_file='".validTeks($_GET['lokasi_file'])."'","?act=Detail2NonHapus&action=TAMBAH&no_rawat=$no_rawat");
            }
