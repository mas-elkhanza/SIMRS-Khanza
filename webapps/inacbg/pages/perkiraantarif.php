<?php
    ...
    if((USERHYBRIDWEB==$usere)&&(PASHYBRIDWEB==$passwordte)){
        ...
        UpdateDataKlaim($norawat,$no_peserta,$tgl_registrasi,$tgl_registrasi,"1","Kelas $kelas","","","","","","","","","","0",$discharge_status,$penyakit,$prosedur,$penyakit,$prosedur,getOne("select biaya_reg from reg_periksa where no_rawat='".$norawat."'"),$nm_dokter,getKelasRS(),"","","#",getOne("select no_ik from inacbg_coder_nik"),$norawat,"120","90","other");
    }   
?>
