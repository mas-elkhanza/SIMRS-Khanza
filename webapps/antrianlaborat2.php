...
<html lang="en">
<head>
    <title>Antrian Laboratorium Patologi Anatomi</title>
...
<body class="bg">
        ...
        <nav class="deep-orange accent-3">
            <div class="nav-wrapper">
                <ul class="center hide-on-med-and-down" id="nv">
                    <li>
                        <a href="./" class="ams hide-on-med-and-down"><i class="material-icons md-36">local_hospital</i> Antrian Laboratorium Patologi Anatomi</a>
                    </li>
        ...
        <div class="footer-copyright deep-orange accent-3 white-text">
            <div class="container simple-marquee-container" id="footer">
                ...
                <marquee class="marquee" scrollamount="4">
                      <?php 
                        $sql ="select jns_perawatan_lab.kd_jenis_prw,jns_perawatan_lab.nm_perawatan,jns_perawatan_lab.total_byr,jns_perawatan_lab.kelas from jns_perawatan_lab inner join penjab on penjab.kd_pj=jns_perawatan_lab.kd_pj where jns_perawatan_lab.status='1' and jns_perawatan_lab.kategori='PA' and penjab.png_jawab like '%umum%'";
                        $hasil=bukaquery($sql);
    ...
    <script type="text/javascript"> 
        var auto_refresh = setInterval( 
            function() { 
                $('#data').load('data_antrianlaborat2.php').fadeIn("fast"); 
            }, 9000
        );
        var auto_refresh = setInterval( 
            function() { 
                $('#judul').load('data_antrianlaboratjudul2.php').fadeIn("fast"); 
            }, 9000
        ); 
    </script>
</body>
