 ...
 <div class="col s12 row">
    <div class="col s12">
        <table class="default">
            ...
            <tbody>
            <?php  
              $_sql="select permintaan_labmb.no_rawat,pasien.nm_pasien,
                    if(permintaan_labmb.jam_permintaan='00:00:00','',permintaan_labmb.jam_permintaan) as jam_permintaan,
                    if(permintaan_labmb.jam_sampel='00:00:00','',permintaan_labmb.jam_sampel) as jam_sampel,
                    if(permintaan_labmb.jam_hasil='00:00:00','',permintaan_labmb.jam_hasil) as jam_hasil,dokter.nm_dokter
                    ...
                    where permintaan_labmb.status='ralan' and permintaan_labmb.tgl_permintaan='".date("Y-m-d", $tanggal)."' order by permintaan_labmb.jam_permintaan desc" ;  
