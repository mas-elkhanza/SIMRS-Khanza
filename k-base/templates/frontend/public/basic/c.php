			    ...
			    <div class="col-sm-12 push-md-3 col-md-6">
			    	<div class="box">
			    		...
			    		<div class="box-body">
			    			<div class="row row-sm">
			    				<div class="col-sm-4">
			    					<a href>
			    						<img src="<?php echo base_url('assets/assets_flatkit/images/c6.jpg');?>" class="w-full"></img>
			    					</a>
			    				</div>
			    				<div class="col-sm-4">
			    					<a href>
			    						<img src="<?php echo base_url('assets/assets_flatkit/images/c4.jpg');?>" class="w-full"></img>
			    					</a>
			    				</div>
			    				<div class="col-sm-4">
			    					<a href>
			    						<img src="<?php echo base_url('assets/assets_flatkit/images/c5.jpg');?>" class="w-full"></img>
			    					</a>
			    				</div>
			    			</div>
			    		</div>
					...
					<div class="box">
						...
						<div class="box-body">
				              ...
				              <div class="sl-item">
				                <div class="sl-left">
				                  <img src="<?php echo base_url('assets/assets_flatkit/images/a0.jpg');?>" class="img-circle">
				                </div>
				              ...
				              <div class="sl-item">
				                <div class="sl-left">
				                  <img src="<?php echo base_url('assets/assets_flatkit/images/a2.jpg');?>" class="img-circle">
				                </div>
				                <div class="sl-content">
				                  ...
				                  <div>
				                    ...
				                    <p>
				                      <span class="inline p-a-xs b-a dark-white">
				                        <img src="<?php echo base_url('assets/assets_flatkit/images/b2.jpg');?>" class="img-responsive">
				                      </span>
				                    </p>
				                  </div>
				                </div>
				              ...
				              <div class="sl-item">
				                <div class="sl-left">
				                  <img src="<?php echo base_url('assets/assets_flatkit/images/a3.jpg');?>" class="img-circle">
				                </div>
				                <div class="sl-content">
					              ...
					              <div class="sl-item">
					                <div class="sl-left">
					                  <img src="<?php echo base_url('assets/assets_flatkit/images/a5.jpg');?>" class="img-circle">
					                </div>
					                <div class="sl-content">
				...
				<div class="col-sm-6 pull-md-6 col-md-3">
					<div class="box">
					    ...
					    <div class="p-a-md text-center">
					    	<p><img src="<?php echo base_url('assets/assets_flatkit/images/a1.jpg');?>" class="img-circle w-xs"></p>
					...
					<div class="box light lt">
			            <div class="box-body">
			              <a href class="pull-left m-r">
			                <img src="<?php echo base_url('assets/assets_flatkit/images/a0.jpg');?>" class="img-circle w-40">
			              </a>
			    	...
			    	<div class="box">
						...
						<div class="list-group no-radius no-borders">
				            <a data-toggle="modal" data-target="#chat" data-dismiss="modal"  class="list-group-item text-ellipsis">
				                ...
				                <img src="<?php echo base_url('assets/assets_flatkit/images/a2.jpg');?>" class="w-24 m-r-sm img-circle">
				                <span>Jonathan Morina</span>
				            </a>
				        </div>
			        </div>
			        <div class="box light lt p-a-lg text-center">
			        	AD
			        </div>
			    </div>
			</div>
